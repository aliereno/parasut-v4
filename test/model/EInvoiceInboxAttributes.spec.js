...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EInvoiceInboxAttributes', function() {
      beforeEach(function() {
        instance = new parasut.EInvoiceInboxAttributes();
      });

      it('should create an instance of EInvoiceInboxAttributes', function() {
        // TODO: update the code to test EInvoiceInboxAttributes
        expect(instance).to.be.a(parasut.EInvoiceInboxAttributes);
      });

      it('should have the property vkn (base name: "vkn")', function() {
        // TODO: update the code to test the property vkn
        expect(instance).to.have.property('vkn');
        // expect(instance.vkn).to.be(expectedValueLiteral);
      });

      it('should have the property eInvoiceAddress (base name: "e_invoice_address")', function() {
        // TODO: update the code to test the property eInvoiceAddress
        expect(instance).to.have.property('eInvoiceAddress');
        // expect(instance.eInvoiceAddress).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property inboxType (base name: "inbox_type")', function() {
        // TODO: update the code to test the property inboxType
        expect(instance).to.have.property('inboxType');
        // expect(instance.inboxType).to.be(expectedValueLiteral);
      });

      it('should have the property addressRegisteredAt (base name: "address_registered_at")', function() {
        // TODO: update the code to test the property addressRegisteredAt
        expect(instance).to.have.property('addressRegisteredAt');
        // expect(instance.addressRegisteredAt).to.be(expectedValueLiteral);
      });
