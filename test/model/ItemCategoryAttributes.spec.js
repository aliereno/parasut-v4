...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ItemCategoryAttributes', function() {
      beforeEach(function() {
        instance = new parasut.ItemCategoryAttributes();
      });

      it('should create an instance of ItemCategoryAttributes', function() {
        // TODO: update the code to test ItemCategoryAttributes
        expect(instance).to.be.a(parasut.ItemCategoryAttributes);
      });

      it('should have the property fullPath (base name: "full_path")', function() {
        // TODO: update the code to test the property fullPath
        expect(instance).to.have.property('fullPath');
        // expect(instance.fullPath).to.be(expectedValueLiteral);
      });
