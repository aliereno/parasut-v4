...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SalesInvoiceDetailAttributes', function() {
      beforeEach(function() {
        instance = new parasut.SalesInvoiceDetailAttributes();
      });

      it('should create an instance of SalesInvoiceDetailAttributes', function() {
        // TODO: update the code to test SalesInvoiceDetailAttributes
        expect(instance).to.be.a(parasut.SalesInvoiceDetailAttributes);
      });
      ...
      it('should have the property discountValue (base name: "discount_value")', function() {
        // TODO: update the code to test the property discountValue
        expect(instance).to.have.property('discountValue');
        // expect(instance.discountValue).to.be(expectedValueLiteral);
      });

      it('should have the property exciseDutyType (base name: "excise_duty_type")', function() {
        // TODO: update the code to test the property exciseDutyType
        expect(instance).to.have.property('exciseDutyType');
        // expect(instance.exciseDutyType).to.be(expectedValueLiteral);
      });

      it('should have the property exciseDutyValue (base name: "excise_duty_value")', function() {
        // TODO: update the code to test the property exciseDutyValue
        expect(instance).to.have.property('exciseDutyValue');
        // expect(instance.exciseDutyValue).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property deliveryMethod (base name: "delivery_method")', function() {
        // TODO: update the code to test the property deliveryMethod
        expect(instance).to.have.property('deliveryMethod');
        // expect(instance.deliveryMethod).to.be(expectedValueLiteral);
      });
