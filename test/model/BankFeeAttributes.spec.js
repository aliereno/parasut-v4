...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankFeeAttributes', function() {
      beforeEach(function() {
        instance = new parasut.BankFeeAttributes();
      });

      it('should create an instance of BankFeeAttributes', function() {
        // TODO: update the code to test BankFeeAttributes
        expect(instance).to.be.a(parasut.BankFeeAttributes);
      });
