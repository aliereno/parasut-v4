...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EmployeeAttributes', function() {
      beforeEach(function() {
        instance = new parasut.EmployeeAttributes();
      });

      it('should create an instance of EmployeeAttributes', function() {
        // TODO: update the code to test EmployeeAttributes
        expect(instance).to.be.a(parasut.EmployeeAttributes);
      });
