...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SalesInvoiceRelationships', function() {
      beforeEach(function() {
        instance = new parasut.SalesInvoiceRelationships();
      });

      it('should create an instance of SalesInvoiceRelationships', function() {
        // TODO: update the code to test SalesInvoiceRelationships
        expect(instance).to.be.a(parasut.SalesInvoiceRelationships);
      });
      ...
      it('should have the property salesOffer (base name: "sales_offer")', function() {
        // TODO: update the code to test the property salesOffer
        expect(instance).to.have.property('salesOffer');
        // expect(instance.salesOffer).to.be(expectedValueLiteral);
      });

      it('should have the property sharings (base name: "sharings")', function() {
        // TODO: update the code to test the property sharings
        expect(instance).to.have.property('sharings');
        // expect(instance.sharings).to.be(expectedValueLiteral);
      });
