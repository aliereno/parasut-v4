...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaxAttributes', function() {
      beforeEach(function() {
        instance = new parasut.TaxAttributes();
      });

      it('should create an instance of TaxAttributes', function() {
        // TODO: update the code to test TaxAttributes
        expect(instance).to.be.a(parasut.TaxAttributes);
      });
