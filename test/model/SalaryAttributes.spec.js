...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SalaryAttributes', function() {
      beforeEach(function() {
        instance = new parasut.SalaryAttributes();
      });

      it('should create an instance of SalaryAttributes', function() {
        // TODO: update the code to test SalaryAttributes
        expect(instance).to.be.a(parasut.SalaryAttributes);
      });
