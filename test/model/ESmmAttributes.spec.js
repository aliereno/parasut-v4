...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ESmmAttributes', function() {
      beforeEach(function() {
        instance = new parasut.ESmmAttributes();
      });

      it('should create an instance of ESmmAttributes', function() {
        // TODO: update the code to test ESmmAttributes
        expect(instance).to.be.a(parasut.ESmmAttributes);
      });
      ...
      it('should have the property pdfUrl (base name: "pdf_url")', function() {
        // TODO: update the code to test the property pdfUrl
        expect(instance).to.have.property('pdfUrl');
        // expect(instance.pdfUrl).to.be(expectedValueLiteral);
      });
