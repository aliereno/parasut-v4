...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseBillRelationships', function() {
      beforeEach(function() {
        instance = new parasut.PurchaseBillRelationships();
      });

      it('should create an instance of PurchaseBillRelationships', function() {
        // TODO: update the code to test PurchaseBillRelationships
        expect(instance).to.be.a(parasut.PurchaseBillRelationships);
      });
      ...
      it('should have the property spender (base name: "spender")', function() {
        // TODO: update the code to test the property spender
        expect(instance).to.have.property('spender');
        // expect(instance.spender).to.be(expectedValueLiteral);
      });

      it('should have the property supplier (base name: "supplier")', function() {
        // TODO: update the code to test the property supplier
        expect(instance).to.have.property('supplier');
        // expect(instance.supplier).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property recurrencePlan (base name: "recurrence_plan")', function() {
        // TODO: update the code to test the property recurrencePlan
        expect(instance).to.have.property('recurrencePlan');
        // expect(instance.recurrencePlan).to.be(expectedValueLiteral);
      });

      it('should have the property activeEDocument (base name: "active_e_document")', function() {
        // TODO: update the code to test the property activeEDocument
        expect(instance).to.have.property('activeEDocument');
        // expect(instance.activeEDocument).to.be(expectedValueLiteral);
      });

      it('should have the property payTo (base name: "pay_to")', function() {
        // TODO: update the code to test the property payTo
        expect(instance).to.have.property('payTo');
        // expect(instance.payTo).to.be(expectedValueLiteral);
      });
