...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ShipmentDocumentAttributes', function() {
      beforeEach(function() {
        instance = new parasut.ShipmentDocumentAttributes();
      });

      it('should create an instance of ShipmentDocumentAttributes', function() {
        // TODO: update the code to test ShipmentDocumentAttributes
        expect(instance).to.be.a(parasut.ShipmentDocumentAttributes);
      });
      ...
      it('should have the property printNote (base name: "print_note")', function() {
        // TODO: update the code to test the property printNote
        expect(instance).to.have.property('printNote');
        // expect(instance.printNote).to.be(expectedValueLiteral);
      });

      it('should have the property printedAt (base name: "printed_at")', function() {
      ...
      it('should have the property inflow (base name: "inflow")', function() {
        // TODO: update the code to test the property inflow
        expect(instance).to.have.property('inflow');
        // expect(instance.inflow).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property shipmentDate (base name: "shipment_date")', function() {
      ...
      it('should have the property procurementNumber (base name: "procurement_number")', function() {
        // TODO: update the code to test the property procurementNumber
        expect(instance).to.have.property('procurementNumber');
        // expect(instance.procurementNumber).to.be(expectedValueLiteral);
      });
