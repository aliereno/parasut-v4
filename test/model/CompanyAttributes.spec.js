...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CompanyAttributes', function() {
      beforeEach(function() {
        instance = new parasut.CompanyAttributes();
      });

      it('should create an instance of CompanyAttributes', function() {
        // TODO: update the code to test CompanyAttributes
        expect(instance).to.be.a(parasut.CompanyAttributes);
      });
      ...
      it('should have the property trialExpirationAt (base name: "trial_expiration_at")', function() {
        // TODO: update the code to test the property trialExpirationAt
        expect(instance).to.have.property('trialExpirationAt');
        // expect(instance.trialExpirationAt).to.be(expectedValueLiteral);
      });

      it('should have the property allowedInspectionAt (base name: "allowed_inspection_at")', function() {
        // TODO: update the code to test the property allowedInspectionAt
        expect(instance).to.have.property('allowedInspectionAt');
        // expect(instance.allowedInspectionAt).to.be(expectedValueLiteral);
      });

      it('should have the property appUrl (base name: "app_url")', function() {
        // TODO: update the code to test the property appUrl
        expect(instance).to.have.property('appUrl');
        // expect(instance.appUrl).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property occupationField (base name: "occupation_field")', function() {
        // TODO: update the code to test the property occupationField
        expect(instance).to.have.property('occupationField');
        // expect(instance.occupationField).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property taxOffice (base name: "tax_office")', function() {
        // TODO: update the code to test the property taxOffice
        expect(instance).to.have.property('taxOffice');
        // expect(instance.taxOffice).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property mersisNo (base name: "mersis_no")', function() {
        // TODO: update the code to test the property mersisNo
        expect(instance).to.have.property('mersisNo');
        // expect(instance.mersisNo).to.be(expectedValueLiteral);
      });

      it('should have the property totalUnusedBonusMonths (base name: "total_unused_bonus_months")', function() {
        // TODO: update the code to test the property totalUnusedBonusMonths
        expect(instance).to.have.property('totalUnusedBonusMonths');
        // expect(instance.totalUnusedBonusMonths).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionStartedAt (base name: "subscription_started_at")', function() {
        // TODO: update the code to test the property subscriptionStartedAt
        expect(instance).to.have.property('subscriptionStartedAt');
        // expect(instance.subscriptionStartedAt).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionRenewedAt (base name: "subscription_renewed_at")', function() {
        // TODO: update the code to test the property subscriptionRenewedAt
        expect(instance).to.have.property('subscriptionRenewedAt');
        // expect(instance.subscriptionRenewedAt).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionValue (base name: "subscription_value")', function() {
        // TODO: update the code to test the property subscriptionValue
        expect(instance).to.have.property('subscriptionValue');
        // expect(instance.subscriptionValue).to.be(expectedValueLiteral);
      });

      it('should have the property primaryJob (base name: "primary_job")', function() {
        // TODO: update the code to test the property primaryJob
        expect(instance).to.have.property('primaryJob');
        // expect(instance.primaryJob).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property inspectable (base name: "inspectable")', function() {
        // TODO: update the code to test the property inspectable
        expect(instance).to.have.property('inspectable');
        // expect(instance.inspectable).to.be(expectedValueLiteral);
      });

      it('should have the property isInGracePeriod (base name: "is_in_grace_period")', function() {
        // TODO: update the code to test the property isInGracePeriod
        expect(instance).to.have.property('isInGracePeriod');
        // expect(instance.isInGracePeriod).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionStatusForAnalytics (base name: "subscription_status_for_analytics")', function() {
        // TODO: update the code to test the property subscriptionStatusForAnalytics
        expect(instance).to.have.property('subscriptionStatusForAnalytics');
        // expect(instance.subscriptionStatusForAnalytics).to.be(expectedValueLiteral);
      });

      it('should have the property endOfGracePeriodAt (base name: "end_of_grace_period_at")', function() {
        // TODO: update the code to test the property endOfGracePeriodAt
        expect(instance).to.have.property('endOfGracePeriodAt');
        // expect(instance.endOfGracePeriodAt).to.be(expectedValueLiteral);
      });

      it('should have the property inventoryEnabled (base name: "inventory_enabled")', function() {
        // TODO: update the code to test the property inventoryEnabled
        expect(instance).to.have.property('inventoryEnabled');
        // expect(instance.inventoryEnabled).to.be(expectedValueLiteral);
      });

      it('should have the property isInTrialPeriod (base name: "is_in_trial_period")', function() {
        // TODO: update the code to test the property isInTrialPeriod
        expect(instance).to.have.property('isInTrialPeriod');
        // expect(instance.isInTrialPeriod).to.be(expectedValueLiteral);
      });

      it('should have the property hasIyzicoIntegration (base name: "has_iyzico_integration")', function() {
        // TODO: update the code to test the property hasIyzicoIntegration
        expect(instance).to.have.property('hasIyzicoIntegration');
        // expect(instance.hasIyzicoIntegration).to.be(expectedValueLiteral);
      });

      it('should have the property hasActiveSubscription (base name: "has_active_subscription")', function() {
        // TODO: update the code to test the property hasActiveSubscription
        expect(instance).to.have.property('hasActiveSubscription');
        // expect(instance.hasActiveSubscription).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property subscriptionInfoText (base name: "subscription_info_text")', function() {
        // TODO: update the code to test the property subscriptionInfoText
        expect(instance).to.have.property('subscriptionInfoText');
        // expect(instance.subscriptionInfoText).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionInfoTitle (base name: "subscription_info_title")', function() {
        // TODO: update the code to test the property subscriptionInfoTitle
        expect(instance).to.have.property('subscriptionInfoTitle');
        // expect(instance.subscriptionInfoTitle).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionUrl (base name: "subscription_url")', function() {
        // TODO: update the code to test the property subscriptionUrl
        expect(instance).to.have.property('subscriptionUrl');
        // expect(instance.subscriptionUrl).to.be(expectedValueLiteral);
      });

      it('should have the property referralUrl (base name: "referral_url")', function() {
        // TODO: update the code to test the property referralUrl
        expect(instance).to.have.property('referralUrl');
        // expect(instance.referralUrl).to.be(expectedValueLiteral);
      });

      it('should have the property subscriptionPlanDuration (base name: "subscription_plan_duration")', function() {
        // TODO: update the code to test the property subscriptionPlanDuration
        expect(instance).to.have.property('subscriptionPlanDuration');
        // expect(instance.subscriptionPlanDuration).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property eInvoicingActivatedAt (base name: "e_invoicing_activated_at")', function() {
        // TODO: update the code to test the property eInvoicingActivatedAt
        expect(instance).to.have.property('eInvoicingActivatedAt');
        // expect(instance.eInvoicingActivatedAt).to.be(expectedValueLiteral);
      });

      it('should have the property hasSelectedPlan (base name: "has_selected_plan")', function() {
        // TODO: update the code to test the property hasSelectedPlan
        expect(instance).to.have.property('hasSelectedPlan');
        // expect(instance.hasSelectedPlan).to.be(expectedValueLiteral);
      });
