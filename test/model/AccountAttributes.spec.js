...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountAttributes', function() {
      beforeEach(function() {
        instance = new parasut.AccountAttributes();
      });

      it('should create an instance of AccountAttributes', function() {
        // TODO: update the code to test AccountAttributes
        expect(instance).to.be.a(parasut.AccountAttributes);
      });

      it('should have the property usedFor (base name: "used_for")', function() {
        // TODO: update the code to test the property usedFor
        expect(instance).to.have.property('usedFor');
        // expect(instance.usedFor).to.be(expectedValueLiteral);
      });

      it('should have the property lastUsedAt (base name: "last_used_at")', function() {
        // TODO: update the code to test the property lastUsedAt
        expect(instance).to.have.property('lastUsedAt');
        // expect(instance.lastUsedAt).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property lastAdjustmentDate (base name: "last_adjustment_date")', function() {
        // TODO: update the code to test the property lastAdjustmentDate
        expect(instance).to.have.property('lastAdjustmentDate');
        // expect(instance.lastAdjustmentDate).to.be(expectedValueLiteral);
      });

      it('should have the property bankIntegrationType (base name: "bank_integration_type")', function() {
        // TODO: update the code to test the property bankIntegrationType
        expect(instance).to.have.property('bankIntegrationType');
        // expect(instance.bankIntegrationType).to.be(expectedValueLiteral);
      });

      it('should have the property associateEmail (base name: "associate_email")', function() {
        // TODO: update the code to test the property associateEmail
        expect(instance).to.have.property('associateEmail');
        // expect(instance.associateEmail).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property bankBranch (base name: "bank_branch")', function() {
        // TODO: update the code to test the property bankBranch
        expect(instance).to.have.property('bankBranch');
        // expect(instance.bankBranch).to.be(expectedValueLiteral);
      });

      it('should have the property bankAccountNo (base name: "bank_account_no")', function() {
        // TODO: update the code to test the property bankAccountNo
        expect(instance).to.have.property('bankAccountNo');
        // expect(instance.bankAccountNo).to.be(expectedValueLiteral);
      });
