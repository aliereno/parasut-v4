...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionAttributes', function() {
      beforeEach(function() {
        instance = new parasut.TransactionAttributes();
      });

      it('should create an instance of TransactionAttributes', function() {
        // TODO: update the code to test TransactionAttributes
        expect(instance).to.be.a(parasut.TransactionAttributes);
      });
      ...
      it('should have the property amountInTrl (base name: "amount_in_trl")', function() {
        // TODO: update the code to test the property amountInTrl
        expect(instance).to.have.property('amountInTrl');
        // expect(instance.amountInTrl).to.be(expectedValueLiteral);
      });

      it('should have the property debitAmount (base name: "debit_amount")', function() {
      ...
      it('should have the property debitCurrency (base name: "debit_currency")', function() {
      ...
      it('should have the property creditAmount (base name: "credit_amount")', function() {
      ...
      it('should have the property creditCurrency (base name: "credit_currency")', function() {
        // TODO: update the code to test the property creditCurrency
        expect(instance).to.have.property('creditCurrency');
        // expect(instance.creditCurrency).to.be(expectedValueLiteral);
      });
