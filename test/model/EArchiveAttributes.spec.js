...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EArchiveAttributes', function() {
      beforeEach(function() {
        instance = new parasut.EArchiveAttributes();
      });

      it('should create an instance of EArchiveAttributes', function() {
        // TODO: update the code to test EArchiveAttributes
        expect(instance).to.be.a(parasut.EArchiveAttributes);
      });
      ...
      it('should have the property isPrinted (base name: "is_printed")', function() {
        // TODO: update the code to test the property isPrinted
        expect(instance).to.have.property('isPrinted');
        // expect(instance.isPrinted).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property cancellableUntil (base name: "cancellable_until")', function() {
        // TODO: update the code to test the property cancellableUntil
        expect(instance).to.have.property('cancellableUntil');
        // expect(instance.cancellableUntil).to.be(expectedValueLiteral);
      });
