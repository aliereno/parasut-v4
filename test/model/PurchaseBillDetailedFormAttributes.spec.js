...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseBillDetailedFormAttributes', function() {
      beforeEach(function() {
        instance = new parasut.PurchaseBillDetailedFormAttributes();
      });

      it('should create an instance of PurchaseBillDetailedFormAttributes', function() {
        // TODO: update the code to test PurchaseBillDetailedFormAttributes
        expect(instance).to.be.a(parasut.PurchaseBillDetailedFormAttributes);
      });
