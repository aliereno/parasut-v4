...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EInvoiceAttributes', function() {
      beforeEach(function() {
        instance = new parasut.EInvoiceAttributes();
      });

      it('should create an instance of EInvoiceAttributes', function() {
        // TODO: update the code to test EInvoiceAttributes
        expect(instance).to.be.a(parasut.EInvoiceAttributes);
      });
      ...
      it('should have the property envUuid (base name: "env_uuid")', function() {
        // TODO: update the code to test the property envUuid
        expect(instance).to.have.property('envUuid');
        // expect(instance.envUuid).to.be(expectedValueLiteral);
      });

      it('should have the property fromAddress (base name: "from_address")', function() {
        // TODO: update the code to test the property fromAddress
        expect(instance).to.have.property('fromAddress');
        // expect(instance.fromAddress).to.be(expectedValueLiteral);
      });

      it('should have the property fromVkn (base name: "from_vkn")', function() {
        // TODO: update the code to test the property fromVkn
        expect(instance).to.have.property('fromVkn');
        // expect(instance.fromVkn).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property toVkn (base name: "to_vkn")', function() {
        // TODO: update the code to test the property toVkn
        expect(instance).to.have.property('toVkn');
        // expect(instance.toVkn).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property scenario (base name: "scenario")', function() {
        // TODO: update the code to test the property scenario
        expect(instance).to.have.property('scenario');
        // expect(instance.scenario).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property gtbRefNo (base name: "gtb_ref_no")', function() {
        // TODO: update the code to test the property gtbRefNo
        expect(instance).to.have.property('gtbRefNo');
        // expect(instance.gtbRefNo).to.be(expectedValueLiteral);
      });

      it('should have the property gtbRegistrationNo (base name: "gtb_registration_no")', function() {
        // TODO: update the code to test the property gtbRegistrationNo
        expect(instance).to.have.property('gtbRegistrationNo');
        // expect(instance.gtbRegistrationNo).to.be(expectedValueLiteral);
      });

      it('should have the property gtbExportDate (base name: "gtb_export_date")', function() {
        // TODO: update the code to test the property gtbExportDate
        expect(instance).to.have.property('gtbExportDate');
        // expect(instance.gtbExportDate).to.be(expectedValueLiteral);
      });

      it('should have the property responseNote (base name: "response_note")', function() {
        // TODO: update the code to test the property responseNote
        expect(instance).to.have.property('responseNote');
        // expect(instance.responseNote).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property isExpired (base name: "is_expired")', function() {
        // TODO: update the code to test the property isExpired
        expect(instance).to.have.property('isExpired');
        // expect(instance.isExpired).to.be(expectedValueLiteral);
      });

      it('should have the property isAnswerable (base name: "is_answerable")', function() {
        // TODO: update the code to test the property isAnswerable
        expect(instance).to.have.property('isAnswerable');
        // expect(instance.isAnswerable).to.be(expectedValueLiteral);
      });
