...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductAttributes', function() {
      beforeEach(function() {
        instance = new parasut.ProductAttributes();
      });

      it('should create an instance of ProductAttributes', function() {
        // TODO: update the code to test ProductAttributes
        expect(instance).to.be.a(parasut.ProductAttributes);
      });

      it('should have the property salesExciseDutyCode (base name: "sales_excise_duty_code")', function() {
        // TODO: update the code to test the property salesExciseDutyCode
        expect(instance).to.have.property('salesExciseDutyCode');
        // expect(instance.salesExciseDutyCode).to.be(expectedValueLiteral);
      });

      it('should have the property salesInvoiceDetailsCount (base name: "sales_invoice_details_count")', function() {
        // TODO: update the code to test the property salesInvoiceDetailsCount
        expect(instance).to.have.property('salesInvoiceDetailsCount');
        // expect(instance.salesInvoiceDetailsCount).to.be(expectedValueLiteral);
      });

      it('should have the property purchaseInvoiceDetailsCount (base name: "purchase_invoice_details_count")', function() {
        // TODO: update the code to test the property purchaseInvoiceDetailsCount
        expect(instance).to.have.property('purchaseInvoiceDetailsCount');
        // expect(instance.purchaseInvoiceDetailsCount).to.be(expectedValueLiteral);
      });

      it('should have the property listPriceInTrl (base name: "list_price_in_trl")', function() {
        // TODO: update the code to test the property listPriceInTrl
        expect(instance).to.have.property('listPriceInTrl');
        // expect(instance.listPriceInTrl).to.be(expectedValueLiteral);
      });

      it('should have the property buyingPriceInTrl (base name: "buying_price_in_trl")', function() {
        // TODO: update the code to test the property buyingPriceInTrl
        expect(instance).to.have.property('buyingPriceInTrl');
        // expect(instance.buyingPriceInTrl).to.be(expectedValueLiteral);
      });

      it('should have the property stockCount (base name: "stock_count")', function() {
        // TODO: update the code to test the property stockCount
        expect(instance).to.have.property('stockCount');
        // expect(instance.stockCount).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property salesExciseDuty (base name: "sales_excise_duty")', function() {
        // TODO: update the code to test the property salesExciseDuty
        expect(instance).to.have.property('salesExciseDuty');
        // expect(instance.salesExciseDuty).to.be(expectedValueLiteral);
      });

      it('should have the property salesExciseDutyType (base name: "sales_excise_duty_type")', function() {
        // TODO: update the code to test the property salesExciseDutyType
        expect(instance).to.have.property('salesExciseDutyType');
        // expect(instance.salesExciseDutyType).to.be(expectedValueLiteral);
      });

      it('should have the property purchaseExciseDuty (base name: "purchase_excise_duty")', function() {
        // TODO: update the code to test the property purchaseExciseDuty
        expect(instance).to.have.property('purchaseExciseDuty');
        // expect(instance.purchaseExciseDuty).to.be(expectedValueLiteral);
      });

      it('should have the property purchaseExciseDutyType (base name: "purchase_excise_duty_type")', function() {
        // TODO: update the code to test the property purchaseExciseDutyType
        expect(instance).to.have.property('purchaseExciseDutyType');
        // expect(instance.purchaseExciseDutyType).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property communicationsTaxRate (base name: "communications_tax_rate")', function() {
        // TODO: update the code to test the property communicationsTaxRate
        expect(instance).to.have.property('communicationsTaxRate');
        // expect(instance.communicationsTaxRate).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property buyingPrice (base name: "buying_price")', function() {
      ...
      it('should have the property buyingCurrency (base name: "buying_currency")', function() {
        // TODO: update the code to test the property buyingCurrency
        expect(instance).to.have.property('buyingCurrency');
        // expect(instance.buyingCurrency).to.be(expectedValueLiteral);
      });

      it('should have the property inventoryTracking (base name: "inventory_tracking")', function() {
        // TODO: update the code to test the property inventoryTracking
        expect(instance).to.have.property('inventoryTracking');
        // expect(instance.inventoryTracking).to.be(expectedValueLiteral);
      });

      it('should have the property initialStockCount (base name: "initial_stock_count")', function() {
        // TODO: update the code to test the property initialStockCount
        expect(instance).to.have.property('initialStockCount');
        // expect(instance.initialStockCount).to.be(expectedValueLiteral);
      });

      it('should have the property gtip (base name: "gtip")', function() {
        // TODO: update the code to test the property gtip
        expect(instance).to.have.property('gtip');
        // expect(instance.gtip).to.be(expectedValueLiteral);
      });
