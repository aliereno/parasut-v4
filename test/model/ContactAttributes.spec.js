...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContactAttributes', function() {
      beforeEach(function() {
        instance = new parasut.ContactAttributes();
      });

      it('should create an instance of ContactAttributes', function() {
        // TODO: update the code to test ContactAttributes
        expect(instance).to.be.a(parasut.ContactAttributes);
      });
      ...
      it('should have the property trlBalance (base name: "trl_balance")', function() {
        // TODO: update the code to test the property trlBalance
        expect(instance).to.have.property('trlBalance');
        // expect(instance.trlBalance).to.be(expectedValueLiteral);
      });

      it('should have the property usdBalance (base name: "usd_balance")', function() {
        // TODO: update the code to test the property usdBalance
        expect(instance).to.have.property('usdBalance');
        // expect(instance.usdBalance).to.be(expectedValueLiteral);
      });

      it('should have the property eurBalance (base name: "eur_balance")', function() {
        // TODO: update the code to test the property eurBalance
        expect(instance).to.have.property('eurBalance');
        // expect(instance.eurBalance).to.be(expectedValueLiteral);
      });

      it('should have the property gbpBalance (base name: "gbp_balance")', function() {
        // TODO: update the code to test the property gbpBalance
        expect(instance).to.have.property('gbpBalance');
        // expect(instance.gbpBalance).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property untrackable (base name: "untrackable")', function() {
        // TODO: update the code to test the property untrackable
        expect(instance).to.have.property('untrackable');
        // expect(instance.untrackable).to.be(expectedValueLiteral);
      });
