...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseBillDetailAttributes', function() {
      beforeEach(function() {
        instance = new parasut.PurchaseBillDetailAttributes();
      });

      it('should create an instance of PurchaseBillDetailAttributes', function() {
        // TODO: update the code to test PurchaseBillDetailAttributes
        expect(instance).to.be.a(parasut.PurchaseBillDetailAttributes);
      });
