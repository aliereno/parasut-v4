...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseBillBasicFormAttributes', function() {
      beforeEach(function() {
        instance = new parasut.PurchaseBillBasicFormAttributes();
      });

      it('should create an instance of PurchaseBillBasicFormAttributes', function() {
        // TODO: update the code to test PurchaseBillBasicFormAttributes
        expect(instance).to.be.a(parasut.PurchaseBillBasicFormAttributes);
      });
