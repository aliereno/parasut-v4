...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseBillAttributes', function() {
      beforeEach(function() {
        instance = new parasut.PurchaseBillAttributes();
      });

      it('should create an instance of PurchaseBillAttributes', function() {
        // TODO: update the code to test PurchaseBillAttributes
        expect(instance).to.be.a(parasut.PurchaseBillAttributes);
      });
      ...
      it('should have the property isDetailed (base name: "is_detailed")', function() {
        // TODO: update the code to test the property isDetailed
        expect(instance).to.have.property('isDetailed');
        // expect(instance.isDetailed).to.be(expectedValueLiteral);
      });

      it('should have the property sharingsCount (base name: "sharings_count")', function() {
        // TODO: update the code to test the property sharingsCount
        expect(instance).to.have.property('sharingsCount');
        // expect(instance.sharingsCount).to.be(expectedValueLiteral);
      });

      it('should have the property eInvoicesCount (base name: "e_invoices_count")', function() {
        // TODO: update the code to test the property eInvoicesCount
        expect(instance).to.have.property('eInvoicesCount');
        // expect(instance.eInvoicesCount).to.be(expectedValueLiteral);
      });

      it('should have the property remainingReimbursement (base name: "remaining_reimbursement")', function() {
        // TODO: update the code to test the property remainingReimbursement
        expect(instance).to.have.property('remainingReimbursement');
        // expect(instance.remainingReimbursement).to.be(expectedValueLiteral);
      });

      it('should have the property remainingReimbursementInTrl (base name: "remaining_reimbursement_in_trl")', function() {
        // TODO: update the code to test the property remainingReimbursementInTrl
        expect(instance).to.have.property('remainingReimbursementInTrl');
        // expect(instance.remainingReimbursementInTrl).to.be(expectedValueLiteral);
      });
