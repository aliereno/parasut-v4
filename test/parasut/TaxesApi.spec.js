...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.TaxesApi();
  });

  describe('(package)', function() {
    describe('TaxesApi', function() {
      describe('archiveTax', function() {
        it('should call archiveTax successfully', function(done) {
          // TODO: uncomment, update parameter values for archiveTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.archiveTax(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20115);
            expect(data.data).to.be.a(parasut.Tax);
              ...
              expect(data.data.attributes).to.be.a(parasut.TaxAttributes);
      ...
      describe('createTax', function() {
        it('should call createTax successfully', function(done) {
          // TODO: uncomment, update parameter values for createTax call and complete the assertions
          /*
          var companyId = 56;
          var taxForm = new parasut.TaxForm();
          taxForm.data = new parasut.CompanyIdtaxesData();
          taxForm.data.id = "";
          taxForm.data.type = "taxes";
          taxForm.data.attributes = new parasut.TaxAttributes();
          taxForm.data.attributes.description = "";
          taxForm.data.attributes.issueDate = new Date();
          taxForm.data.attributes.dueDate = new Date();
          taxForm.data.attributes.netTotal = ;
          taxForm.data.relationships = new parasut.CompanyIdbankFeesDataRelationships();
          taxForm.data.relationships.category = new parasut.CompanyIdbankFeesDataRelationshipsCategory();
          taxForm.data.relationships.category.data = new parasut.CompanyIdbankFeesDataRelationshipsCategoryData();
          taxForm.data.relationships.category.data.id = "";
          taxForm.data.relationships.category.data.type = "item_categories";
          taxForm.data.relationships.tags = new parasut.CompanyIdbankFeesDataRelationshipsTags();
          taxForm.data.relationships.tags.data = [new parasut.CompanyIdbankFeesDataRelationshipsTagsData()];
          taxForm.data.relationships.tags.data[0].id = "";
          taxForm.data.relationships.tags.data[0].type = "tags";
          var opts = {};
          opts.include = "include_example";

          instance.createTax(companyId, taxForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('deleteTax', function() {
        it('should call deleteTax successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.deleteTax(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listTaxes', function() {
        it('should call listTaxes successfully', function(done) {
          // TODO: uncomment, update parameter values for listTaxes call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          ...
          instance.listTaxes(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20018);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.Tax);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("bank_fees");
                expect(data.attributes).to.be.a(parasut.TaxAttributes);
                ...
                expect(data.relationships).to.be.a(parasut.CompanyIdbankFeesDataRelationships);
      ...
      describe('payTax', function() {
        it('should call payTax successfully', function(done) {
          // TODO: uncomment, update parameter values for payTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var paymentForm = new parasut.PaymentForm4();
          ...
          instance.payTax(companyId, id, paymentForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('showTax', function() {
        it('should call showTax successfully', function(done) {
          // TODO: uncomment, update parameter values for showTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showTax(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('unarchiveTax', function() {
        it('should call unarchiveTax successfully', function(done) {
          // TODO: uncomment, update parameter values for unarchiveTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.unarchiveTax(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateTax', function() {
        it('should call updateTax successfully', function(done) {
          // TODO: uncomment, update parameter values for updateTax call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var taxForm = new parasut.TaxForm1();
          taxForm.data = new parasut.CompanyIdtaxesData();
          taxForm.data.id = "";
          taxForm.data.type = "taxes";
          taxForm.data.attributes = new parasut.TaxAttributes();
          ...
          instance.updateTax(companyId, id, taxForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
