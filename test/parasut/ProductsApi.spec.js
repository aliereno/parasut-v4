...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.ProductsApi();
  });
    ...
    describe('ProductsApi', function() {
      describe('createProduct', function() {
        it('should call createProduct successfully', function(done) {
          ...
          /*
          var companyId = 56;
          var productForm = new parasut.ProductForm();
          productForm.data = new parasut.CompanyIdproductsData();
          productForm.data.id = "";
          productForm.data.type = "products";
          productForm.data.attributes = new parasut.ProductAttributes();
          productForm.data.attributes.code = "";
          productForm.data.attributes.name = "";
          productForm.data.attributes.vatRate = ;
          productForm.data.attributes.salesExciseDuty = ;
          productForm.data.attributes.salesExciseDutyType = "";
          productForm.data.attributes.purchaseExciseDuty = ;
          productForm.data.attributes.purchaseExciseDutyType = "";
          productForm.data.attributes.unit = "";
          productForm.data.attributes.communicationsTaxRate = ;
          productForm.data.attributes.archived = false;
          productForm.data.attributes.listPrice = ;
          productForm.data.attributes.currency = "";
          productForm.data.attributes.buyingPrice = ;
          ...
          productForm.data.relationships.category.data.id = "";
          productForm.data.relationships.category.data.type = "item_categories";
          var opts = {};
          opts.include = "include_example";

          instance.createProduct(companyId, productForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2019);
            expect(data.data).to.be.a(parasut.Product);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("products");
              expect(data.data.attributes).to.be.a(parasut.ProductAttributes);
                    expect(data.data.attributes.salesExciseDutyCode).to.be.a('string');
                expect(data.data.attributes.salesExciseDutyCode).to.be("");
                expect(data.data.attributes.salesInvoiceDetailsCount).to.be.a('number');
                expect(data.data.attributes.salesInvoiceDetailsCount).to.be(0);
                expect(data.data.attributes.purchaseInvoiceDetailsCount).to.be.a('number');
                expect(data.data.attributes.purchaseInvoiceDetailsCount).to.be(0);
                expect(data.data.attributes.listPriceInTrl).to.be.a('number');
                expect(data.data.attributes.listPriceInTrl).to.be();
                expect(data.data.attributes.buyingPriceInTrl).to.be.a('number');
                expect(data.data.attributes.buyingPriceInTrl).to.be();
                expect(data.data.attributes.stockCount).to.be.a('number');
                expect(data.data.attributes.stockCount).to.be();
                ...
                expect(data.data.attributes.code).to.be.a('string');
                expect(data.data.attributes.code).to.be("");
                expect(data.data.attributes.name).to.be.a('string');
                expect(data.data.attributes.name).to.be("");
                expect(data.data.attributes.vatRate).to.be.a('number');
                expect(data.data.attributes.vatRate).to.be();
                expect(data.data.attributes.salesExciseDuty).to.be.a('number');
                expect(data.data.attributes.salesExciseDuty).to.be();
                expect(data.data.attributes.salesExciseDutyType).to.be.a('string');
                expect(data.data.attributes.salesExciseDutyType).to.be("");
                expect(data.data.attributes.purchaseExciseDuty).to.be.a('number');
                expect(data.data.attributes.purchaseExciseDuty).to.be();
                expect(data.data.attributes.purchaseExciseDutyType).to.be.a('string');
                expect(data.data.attributes.purchaseExciseDutyType).to.be("");
                expect(data.data.attributes.unit).to.be.a('string');
                expect(data.data.attributes.unit).to.be("");
                expect(data.data.attributes.communicationsTaxRate).to.be.a('number');
                expect(data.data.attributes.communicationsTaxRate).to.be();
                expect(data.data.attributes.archived).to.be.a('boolean');
                expect(data.data.attributes.archived).to.be(false);
                expect(data.data.attributes.listPrice).to.be.a('number');
                expect(data.data.attributes.listPrice).to.be();
                expect(data.data.attributes.currency).to.be.a('string');
                expect(data.data.attributes.currency).to.be("");
                expect(data.data.attributes.buyingPrice).to.be.a('number');
                expect(data.data.attributes.buyingPrice).to.be();
                expect(data.data.attributes.buyingCurrency).to.be.a('string');
                expect(data.data.attributes.buyingCurrency).to.be("");
                expect(data.data.attributes.inventoryTracking).to.be.a('boolean');
                    ...
                    expect(data.data.relationships.category.data.type).to.be("item_categories");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse20010Included);
      ...
      describe('deleteProduct', function() {
        it('should call deleteProduct successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteProduct call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.deleteProduct(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listProducts', function() {
        it('should call listProducts successfully', function(done) {
          // TODO: uncomment, update parameter values for listProducts call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          opts.filterName = "filterName_example";
          opts.filterCode = "filterCode_example";
          opts.sort = "-id";
          opts.pageNumber = 1;
          opts.pageSize = 15;
          opts.include = "include_example";

          instance.listProducts(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20011);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.Product);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("products");
                expect(data.attributes).to.be.a(parasut.ProductAttributes);
                      expect(data.attributes.salesExciseDutyCode).to.be.a('string');
                  expect(data.attributes.salesExciseDutyCode).to.be("");
                  expect(data.attributes.salesInvoiceDetailsCount).to.be.a('number');
                  expect(data.attributes.salesInvoiceDetailsCount).to.be(0);
                  expect(data.attributes.purchaseInvoiceDetailsCount).to.be.a('number');
                  expect(data.attributes.purchaseInvoiceDetailsCount).to.be(0);
                  expect(data.attributes.listPriceInTrl).to.be.a('number');
                  expect(data.attributes.listPriceInTrl).to.be();
                  expect(data.attributes.buyingPriceInTrl).to.be.a('number');
                  expect(data.attributes.buyingPriceInTrl).to.be();
                  expect(data.attributes.stockCount).to.be.a('number');
                  expect(data.attributes.stockCount).to.be();
                  ...
                  expect(data.attributes.code).to.be.a('string');
                  expect(data.attributes.code).to.be("");
                  expect(data.attributes.name).to.be.a('string');
                  expect(data.attributes.name).to.be("");
                  expect(data.attributes.vatRate).to.be.a('number');
                  expect(data.attributes.vatRate).to.be();
                  expect(data.attributes.salesExciseDuty).to.be.a('number');
                  expect(data.attributes.salesExciseDuty).to.be();
                  expect(data.attributes.salesExciseDutyType).to.be.a('string');
                  expect(data.attributes.salesExciseDutyType).to.be("");
                  expect(data.attributes.purchaseExciseDuty).to.be.a('number');
                  expect(data.attributes.purchaseExciseDuty).to.be();
                  expect(data.attributes.purchaseExciseDutyType).to.be.a('string');
                  expect(data.attributes.purchaseExciseDutyType).to.be("");
                  expect(data.attributes.unit).to.be.a('string');
                  expect(data.attributes.unit).to.be("");
                  expect(data.attributes.communicationsTaxRate).to.be.a('number');
                  expect(data.attributes.communicationsTaxRate).to.be();
                  expect(data.attributes.archived).to.be.a('boolean');
                  expect(data.attributes.archived).to.be(false);
                  expect(data.attributes.listPrice).to.be.a('number');
                  expect(data.attributes.listPrice).to.be();
                  expect(data.attributes.currency).to.be.a('string');
                  expect(data.attributes.currency).to.be("");
                  expect(data.attributes.buyingPrice).to.be.a('number');
                  expect(data.attributes.buyingPrice).to.be();
                  expect(data.attributes.buyingCurrency).to.be.a('string');
                  expect(data.attributes.buyingCurrency).to.be("");
                  expect(data.attributes.inventoryTracking).to.be.a('boolean');
      ...
      describe('showProduct', function() {
        it('should call showProduct successfully', function(done) {
          // TODO: uncomment, update parameter values for showProduct call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showProduct(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateProduct', function() {
        it('should call updateProduct successfully', function(done) {
          ...
          var companyId = 56;
          var id = 56;
          var productForm = new parasut.ProductForm1();
          productForm.data = new parasut.CompanyIdproductsData();
          productForm.data.id = "";
          productForm.data.type = "products";
          productForm.data.attributes = new parasut.ProductAttributes();
          ...
          instance.updateProduct(companyId, id, productForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
