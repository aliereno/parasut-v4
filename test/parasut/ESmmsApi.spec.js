...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.ESmmsApi();
  });

  describe('(package)', function() {
    describe('ESmmsApi', function() {
      describe('createESmm', function() {
        it('should call createESmm successfully', function(done) {
          // TODO: uncomment, update parameter values for createESmm call and complete the assertions
          /*
          var companyId = 56;
          var eSmmForm = new parasut.ESmmForm();
          eSmmForm.data = new parasut.CompanyIdeSmmsData();
          eSmmForm.data.id = "";
          eSmmForm.data.type = "e_smms";
          eSmmForm.data.attributes = new parasut.ESmmCommonFormAttributes();
          eSmmForm.data.attributes.vatWithholdingCode = "";
          eSmmForm.data.attributes.note = "";
          eSmmForm.data.relationships = new parasut.CompanyIdeSmmsDataRelationships();
          eSmmForm.data.relationships.salesInvoices = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoice();
          eSmmForm.data.relationships.salesInvoices.data = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoiceData();
          eSmmForm.data.relationships.salesInvoices.data.id = "";
          eSmmForm.data.relationships.salesInvoices.data.type = "sales_invoices";

          instance.createESmm(companyId, eSmmForm, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2016);
            expect(data.data).to.be.a(parasut.ESmm);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("e_smms");
              expect(data.data.attributes).to.be.a(parasut.ESmmAttributes);
                ...
                expect(data.data.attributes.invoiceNumber).to.be.a('number');
                ...
                expect(data.data.attributes.pdfUrl).to.be.a('string');
                expect(data.data.attributes.pdfUrl).to.be("");
      ...
      describe('showESmm', function() {
        it('should call showESmm successfully', function(done) {
          // TODO: uncomment, update parameter values for showESmm call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showESmm(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2008);
            expect(data.data).to.be.a(parasut.ESmm);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
      ...
      describe('showESmmPdf', function() {
        it('should call showESmmPdf successfully', function(done) {
          // TODO: uncomment, update parameter values for showESmmPdf call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.showESmmPdf(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
