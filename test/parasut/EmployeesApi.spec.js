...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.EmployeesApi();
  });

  describe('(package)', function() {
    describe('EmployeesApi', function() {
      describe('archiveEmployee', function() {
        it('should call archiveEmployee successfully', function(done) {
          // TODO: uncomment, update parameter values for archiveEmployee call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.archiveEmployee(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2017);
            expect(data.data).to.be.a(parasut.Employee);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("employees");
              expect(data.data.attributes).to.be.a(parasut.EmployeeAttributes);
              ...
              expect(data.data.relationships).to.be.a(parasut.EmployeeRelationships);
                ...
                expect(data.data.relationships.managedByUser).to.be.a(parasut.CompanyRelationshipsOwner);
                      expect(data.data.relationships.managedByUser.data).to.be.a(parasut.CompanyRelationshipsOwnerData);
                        expect(data.data.relationships.managedByUser.data.id).to.be.a('string');
                    expect(data.data.relationships.managedByUser.data.id).to.be("");
                    expect(data.data.relationships.managedByUser.data.type).to.be.a('string');
                    expect(data.data.relationships.managedByUser.data.type).to.be("users");
                expect(data.data.relationships.managedByUserRole).to.be.a(parasut.EmployeeRelationshipsManagedByUserRole);
                      expect(data.data.relationships.managedByUserRole.data).to.be.a(parasut.EmployeeRelationshipsManagedByUserRoleData);
                        expect(data.data.relationships.managedByUserRole.data.id).to.be.a('string');
                    expect(data.data.relationships.managedByUserRole.data.id).to.be("");
                    expect(data.data.relationships.managedByUserRole.data.type).to.be.a('string');
                    expect(data.data.relationships.managedByUserRole.data.type).to.be("user_roles");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse2009Included);
      ...
      describe('createEmployee', function() {
        it('should call createEmployee successfully', function(done) {
          // TODO: uncomment, update parameter values for createEmployee call and complete the assertions
          /*
          var companyId = 56;
          var employeeForm = new parasut.EmployeeForm();
          employeeForm.data = new parasut.CompanyIdemployeesData();
          employeeForm.data.id = "";
          employeeForm.data.type = "employees";
          employeeForm.data.attributes = new parasut.EmployeeAttributes();
          employeeForm.data.attributes.name = "";
          employeeForm.data.attributes.email = "";
          employeeForm.data.attributes.archived = false;
          employeeForm.data.attributes.iban = "";
          employeeForm.data.relationships = new parasut.CompanyIdemployeesDataRelationships();
          employeeForm.data.relationships.category = new parasut.CompanyIdbankFeesDataRelationshipsCategory();
          employeeForm.data.relationships.category.data = new parasut.CompanyIdbankFeesDataRelationshipsCategoryData();
          employeeForm.data.relationships.category.data.id = "";
          employeeForm.data.relationships.category.data.type = "item_categories";
          var opts = {};
          opts.include = "include_example";

          instance.createEmployee(companyId, employeeForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('deleteEmployee', function() {
        it('should call deleteEmployee successfully', function(done) {
          ...
          instance.deleteEmployee(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listEmployees', function() {
        it('should call listEmployees successfully', function(done) {
          // TODO: uncomment, update parameter values for listEmployees call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          ...
          instance.listEmployees(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2009);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.Employee);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("employees");
                expect(data.attributes).to.be.a(parasut.EmployeeAttributes);
                ...
                expect(data.relationships).to.be.a(parasut.EmployeeRelationships);
                  ...
                  expect(data.relationships.managedByUser).to.be.a(parasut.CompanyRelationshipsOwner);
                        expect(data.relationships.managedByUser.data).to.be.a(parasut.CompanyRelationshipsOwnerData);
                          expect(data.relationships.managedByUser.data.id).to.be.a('string');
                      expect(data.relationships.managedByUser.data.id).to.be("");
                      expect(data.relationships.managedByUser.data.type).to.be.a('string');
                      expect(data.relationships.managedByUser.data.type).to.be("users");
                  expect(data.relationships.managedByUserRole).to.be.a(parasut.EmployeeRelationshipsManagedByUserRole);
                        expect(data.relationships.managedByUserRole.data).to.be.a(parasut.EmployeeRelationshipsManagedByUserRoleData);
                          expect(data.relationships.managedByUserRole.data.id).to.be.a('string');
                      expect(data.relationships.managedByUserRole.data.id).to.be("");
                      expect(data.relationships.managedByUserRole.data.type).to.be.a('string');
                      expect(data.relationships.managedByUserRole.data.type).to.be("user_roles");
      ...
      describe('showEmployee', function() {
        it('should call showEmployee successfully', function(done) {
          // TODO: uncomment, update parameter values for showEmployee call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showEmployee(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('unarchiveEmployee', function() {
        it('should call unarchiveEmployee successfully', function(done) {
          // TODO: uncomment, update parameter values for unarchiveEmployee call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.unarchiveEmployee(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateEmployee', function() {
        it('should call updateEmployee successfully', function(done) {
          // TODO: uncomment, update parameter values for updateEmployee call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var employeeForm = new parasut.EmployeeForm1();
          employeeForm.data = new parasut.CompanyIdemployeesData();
          employeeForm.data.id = "";
          employeeForm.data.type = "employees";
          employeeForm.data.attributes = new parasut.EmployeeAttributes();
          ...
          instance.updateEmployee(companyId, id, employeeForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
