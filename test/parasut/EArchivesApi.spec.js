...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.EArchivesApi();
  });

  describe('(package)', function() {
    describe('EArchivesApi', function() {
      describe('createEArchive', function() {
        it('should call createEArchive successfully', function(done) {
          // TODO: uncomment, update parameter values for createEArchive call and complete the assertions
          /*
          var companyId = 56;
          var eArchiveForm = new parasut.EArchiveForm();
          eArchiveForm.data = new parasut.CompanyIdeArchivesData();
          eArchiveForm.data.id = "";
          eArchiveForm.data.type = "e_archives";
          eArchiveForm.data.attributes = new parasut.EArchiveFormAttributes();
          eArchiveForm.data.attributes.vatWithholdingCode = "";
          eArchiveForm.data.attributes.vatExemptionReasonCode = "";
          eArchiveForm.data.attributes.vatExemptionReason = "";
          eArchiveForm.data.attributes.note = "";
          eArchiveForm.data.attributes.exciseDutyCodes = [new parasut.EDocumentCommonFormAttributesExciseDutyCodes()];
          eArchiveForm.data.attributes.exciseDutyCodes[0].product = 0;
          eArchiveForm.data.attributes.exciseDutyCodes[0].salesExciseDutyCode = "57";
          eArchiveForm.data.attributes.internetSale = new parasut.EArchiveFormAttributesInternetSale();
          eArchiveForm.data.attributes.internetSale.url = "";
          eArchiveForm.data.attributes.internetSale.paymentType = "KREDIKARTI/BANKAKARTI";
          eArchiveForm.data.attributes.internetSale.paymentPlatform = "";
          eArchiveForm.data.attributes.internetSale.paymentDate = new Date();
          eArchiveForm.data.attributes.shipment = new parasut.EArchiveFormAttributesShipment();
          eArchiveForm.data.attributes.shipment.title = "";
          eArchiveForm.data.attributes.shipment.vkn = "";
          eArchiveForm.data.attributes.shipment.name = "";
          eArchiveForm.data.attributes.shipment.tckn = "";
          eArchiveForm.data.attributes.shipment._date = "";
          eArchiveForm.data.relationships = new parasut.CompanyIdeArchivesDataRelationships();
          eArchiveForm.data.relationships.salesInvoice = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoice();
          eArchiveForm.data.relationships.salesInvoice.data = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoiceData();
          eArchiveForm.data.relationships.salesInvoice.data.id = "";
          eArchiveForm.data.relationships.salesInvoice.data.type = "sales_invoices";

          instance.createEArchive(companyId, eArchiveForm, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('showEArchive', function() {
        it('should call showEArchive successfully', function(done) {
          // TODO: uncomment, update parameter values for showEArchive call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showEArchive(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2004);
            expect(data.data).to.be.a(parasut.EArchive);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("e_archives");
              expect(data.data.attributes).to.be.a(parasut.EArchiveAttributes);
                    expect(data.data.attributes.uuid).to.be.a('string');
                expect(data.data.attributes.uuid).to.be("");
                expect(data.data.attributes.vkn).to.be.a('string');
                expect(data.data.attributes.vkn).to.be("");
                expect(data.data.attributes.invoiceNumber).to.be.a('string');
                expect(data.data.attributes.invoiceNumber).to.be("");
                expect(data.data.attributes.note).to.be.a('string');
                expect(data.data.attributes.note).to.be("");
                expect(data.data.attributes.isPrinted).to.be.a('boolean');
                expect(data.data.attributes.isPrinted).to.be(false);
                expect(data.data.attributes.status).to.be.a('string');
                expect(data.data.attributes.status).to.be("bounced");
                expect(data.data.attributes.printedAt).to.be.a(Date);
                expect(data.data.attributes.printedAt).to.be(new Date());
                expect(data.data.attributes.cancellableUntil).to.be.a(Date);
                expect(data.data.attributes.cancellableUntil).to.be(new Date());
                expect(data.data.attributes.isSigned).to.be.a('boolean');
                expect(data.data.attributes.isSigned).to.be(false);
              ...
              expect(data.data.relationships).to.be.a(parasut.CompanyIdeArchivesDataRelationships);
                    expect(data.data.relationships.salesInvoice).to.be.a(parasut.CompanyIdeArchivesDataRelationshipsSalesInvoice);
                      expect(data.data.relationships.salesInvoice.data).to.be.a(parasut.CompanyIdeArchivesDataRelationshipsSalesInvoiceData);
                        expect(data.data.relationships.salesInvoice.data.id).to.be.a('string');
                    expect(data.data.relationships.salesInvoice.data.id).to.be("");
                    expect(data.data.relationships.salesInvoice.data.type).to.be.a('string');
                    expect(data.data.relationships.salesInvoice.data.type).to.be("sales_invoices");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse2004Included);
      ...
      describe('showEArchivePdf', function() {
        it('should call showEArchivePdf successfully', function(done) {
          // TODO: uncomment, update parameter values for showEArchivePdf call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.showEArchivePdf(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
