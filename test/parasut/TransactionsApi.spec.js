...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.TransactionsApi();
  });
    ...
    describe('TransactionsApi', function() {
      describe('deleteTransaction', function() {
        it('should call deleteTransaction successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteTransaction call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.deleteTransaction(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('showTransaction', function() {
        it('should call showTransaction successfully', function(done) {
          // TODO: uncomment, update parameter values for showTransaction call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showTransaction(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
