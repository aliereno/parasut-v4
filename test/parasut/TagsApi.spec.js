    ...
    describe('TagsApi', function() {
      describe('createTag', function() {
        it('should call createTag successfully', function(done) {
          ...
          /*
          var companyId = 56;
          var tagForm = new parasut.TagForm();
          tagForm.data = new parasut.CompanyIdtagsData();
          tagForm.data.id = "";
          tagForm.data.type = "tags";
          tagForm.data.attributes = new parasut.TagAttributes();
          tagForm.data.attributes.name = "";

          instance.createTag(companyId, tagForm, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20114);
            expect(data.data).to.be.a(parasut.Tag);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("tags");
              expect(data.data.attributes).to.be.a(parasut.TagAttributes);
      ...
      describe('deleteTag', function() {
        it('should call deleteTag successfully', function(done) {
          ...
          instance.deleteTag(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listTags', function() {
        it('should call listTags successfully', function(done) {
          // TODO: uncomment, update parameter values for listTags call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          opts.sort = "id";
          ...
          instance.listTags(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20017);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.Tag);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("tags");
                expect(data.attributes).to.be.a(parasut.TagAttributes);
      ...
      describe('showTag', function() {
        it('should call showTag successfully', function(done) {
          // TODO: uncomment, update parameter values for showTag call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.showTag(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateTag', function() {
        it('should call updateTag successfully', function(done) {
          ...
          var companyId = 56;
          var id = 56;
          var tagForm = new parasut.TagForm1();
          tagForm.data = new parasut.CompanyIdtagsData();
          tagForm.data.id = "";
          tagForm.data.type = "tags";
          tagForm.data.attributes = new parasut.TagAttributes();
          ...
          instance.updateTag(companyId, id, tagForm, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
