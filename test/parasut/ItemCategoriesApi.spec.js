...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.ItemCategoriesApi();
  });

  describe('(package)', function() {
    describe('ItemCategoriesApi', function() {
      describe('createItemCategory', function() {
        it('should call createItemCategory successfully', function(done) {
          // TODO: uncomment, update parameter values for createItemCategory call and complete the assertions
          /*
          var companyId = 56;
          var itemCategoryForm = new parasut.ItemCategoryForm();
          itemCategoryForm.data = new parasut.CompanyIditemCategoriesData();
          itemCategoryForm.data.id = "";
          itemCategoryForm.data.type = "item_categories";
          itemCategoryForm.data.attributes = new parasut.ItemCategoryAttributes();
          itemCategoryForm.data.attributes.name = "";
          itemCategoryForm.data.attributes.bgColor = "";
          itemCategoryForm.data.attributes.textColor = "";
          itemCategoryForm.data.attributes.categoryType = "Product";
          itemCategoryForm.data.attributes.parentId = 0;
          var opts = {};
          opts.include = "include_example";

          instance.createItemCategory(companyId, itemCategoryForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2018);
            expect(data.data).to.be.a(parasut.ItemCategory);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("item_categories");
              expect(data.data.attributes).to.be.a(parasut.ItemCategoryAttributes);
                    expect(data.data.attributes.fullPath).to.be.a('string');
                expect(data.data.attributes.fullPath).to.be("");
                ...
                expect(data.data.attributes.bgColor).to.be.a('string');
                expect(data.data.attributes.bgColor).to.be("");
                expect(data.data.attributes.textColor).to.be.a('string');
                expect(data.data.attributes.textColor).to.be("");
                expect(data.data.attributes.categoryType).to.be.a('string');
                expect(data.data.attributes.categoryType).to.be("Product");
                expect(data.data.attributes.parentId).to.be.a('number');
                expect(data.data.attributes.parentId).to.be(0);
              expect(data.data.relationships).to.be.a(parasut.ItemCategoryRelationships);
                    expect(data.data.relationships.parentCategory).to.be.a(parasut.CompanyIdbankFeesDataRelationshipsCategory);
                      expect(data.data.relationships.parentCategory.data).to.be.a(parasut.CompanyIdbankFeesDataRelationshipsCategoryData);
                        expect(data.data.relationships.parentCategory.data.id).to.be.a('string');
                    expect(data.data.relationships.parentCategory.data.id).to.be("");
                    expect(data.data.relationships.parentCategory.data.type).to.be.a('string');
                    expect(data.data.relationships.parentCategory.data.type).to.be("item_categories");
                expect(data.data.relationships.subcategories).to.be.a(parasut.ItemCategoryRelationshipsSubcategories);
                      {
                    let dataCtr = data.data.relationships.subcategories.data;
                    expect(dataCtr).to.be.an(Array);
                    expect(dataCtr).to.not.be.empty();
                    for (let p in dataCtr) {
                      let data = dataCtr[p];
                      expect(data).to.be.a(parasut.CompanyIdbankFeesDataRelationshipsCategoryData);
      ...
      describe('deleteItemCategory', function() {
        it('should call deleteItemCategory successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteItemCategory call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.deleteItemCategory(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listItemCategories', function() {
        it('should call listItemCategories successfully', function(done) {
          // TODO: uncomment, update parameter values for listItemCategories call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          opts.filterName = "filterName_example";
          opts.filterCategoryType = "filterCategoryType_example";
          opts.sort = "id";
          opts.pageNumber = 1;
          opts.pageSize = 15;
          opts.include = "include_example";

          instance.listItemCategories(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20010);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.ItemCategory);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("item_categories");
                expect(data.attributes).to.be.a(parasut.ItemCategoryAttributes);
                      expect(data.attributes.fullPath).to.be.a('string');
                  expect(data.attributes.fullPath).to.be("");
                  ...
                  expect(data.attributes.bgColor).to.be.a('string');
                  expect(data.attributes.bgColor).to.be("");
                  expect(data.attributes.textColor).to.be.a('string');
                  expect(data.attributes.textColor).to.be("");
                  expect(data.attributes.categoryType).to.be.a('string');
                  expect(data.attributes.categoryType).to.be("Product");
                  expect(data.attributes.parentId).to.be.a('number');
                  expect(data.attributes.parentId).to.be(0);
                expect(data.relationships).to.be.a(parasut.ItemCategoryRelationships);
                      expect(data.relationships.parentCategory).to.be.a(parasut.CompanyIdbankFeesDataRelationshipsCategory);
                        expect(data.relationships.parentCategory.data).to.be.a(parasut.CompanyIdbankFeesDataRelationshipsCategoryData);
                          expect(data.relationships.parentCategory.data.id).to.be.a('string');
                      expect(data.relationships.parentCategory.data.id).to.be("");
                      expect(data.relationships.parentCategory.data.type).to.be.a('string');
                      expect(data.relationships.parentCategory.data.type).to.be("item_categories");
                  expect(data.relationships.subcategories).to.be.a(parasut.ItemCategoryRelationshipsSubcategories);
                        {
                      let dataCtr = data.relationships.subcategories.data;
                      expect(dataCtr).to.be.an(Array);
                      expect(dataCtr).to.not.be.empty();
                      for (let p in dataCtr) {
                        let data = dataCtr[p];
      ...
      describe('showItemCategory', function() {
        it('should call showItemCategory successfully', function(done) {
          // TODO: uncomment, update parameter values for showItemCategory call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showItemCategory(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateItemCategory', function() {
        it('should call updateItemCategory successfully', function(done) {
          // TODO: uncomment, update parameter values for updateItemCategory call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var itemCategoryForm = new parasut.ItemCategoryForm1();
          itemCategoryForm.data = new parasut.CompanyIditemCategoriesData();
          itemCategoryForm.data.id = "";
          itemCategoryForm.data.type = "item_categories";
          itemCategoryForm.data.attributes = new parasut.ItemCategoryAttributes();
          ...
          instance.updateItemCategory(companyId, id, itemCategoryForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
