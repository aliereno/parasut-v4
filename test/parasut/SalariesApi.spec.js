...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.SalariesApi();
  });

  describe('(package)', function() {
    describe('SalariesApi', function() {
      describe('archiveSalary', function() {
        it('should call archiveSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for archiveSalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.archiveSalary(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20111);
            expect(data.data).to.be.a(parasut.Salary);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("salaries");
              expect(data.data.attributes).to.be.a(parasut.SalaryAttributes);
              ...
              expect(data.data.relationships).to.be.a(parasut.CompanyIdsalariesDataRelationships);
                    expect(data.data.relationships.employee).to.be.a(parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee);
                      expect(data.data.relationships.employee.data).to.be.a(parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData);
                        expect(data.data.relationships.employee.data.id).to.be.a('string');
                    expect(data.data.relationships.employee.data.id).to.be("");
                    expect(data.data.relationships.employee.data.type).to.be.a('string');
                    expect(data.data.relationships.employee.data.type).to.be("employees");
                  ...
                  }
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse20013Included);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("employees");
      ...
      describe('createSalary', function() {
        it('should call createSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for createSalary call and complete the assertions
          /*
          var companyId = 56;
          var salaryForm = new parasut.SalaryForm();
          salaryForm.data = new parasut.CompanyIdsalariesData();
          salaryForm.data.id = "";
          salaryForm.data.type = "salaries";
          salaryForm.data.attributes = new parasut.SalaryAttributes();
          salaryForm.data.attributes.description = "";
          salaryForm.data.attributes.currency = "TRL";
          salaryForm.data.attributes.issueDate = new Date();
          salaryForm.data.attributes.dueDate = new Date();
          salaryForm.data.attributes.exchangeRate = ;
          salaryForm.data.attributes.netTotal = ;
          salaryForm.data.relationships = new parasut.CompanyIdsalariesDataRelationships();
          salaryForm.data.relationships.employee = new parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee();
          salaryForm.data.relationships.employee.data = new parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData();
          salaryForm.data.relationships.employee.data.id = "";
          salaryForm.data.relationships.employee.data.type = "employees";
          salaryForm.data.relationships.category = new parasut.CompanyIdbankFeesDataRelationshipsCategory();
          salaryForm.data.relationships.category.data = new parasut.CompanyIdbankFeesDataRelationshipsCategoryData();
          salaryForm.data.relationships.category.data.id = "";
          salaryForm.data.relationships.category.data.type = "item_categories";
          salaryForm.data.relationships.tags = new parasut.CompanyIdbankFeesDataRelationshipsTags();
          salaryForm.data.relationships.tags.data = [new parasut.CompanyIdbankFeesDataRelationshipsTagsData()];
          salaryForm.data.relationships.tags.data[0].id = "";
          salaryForm.data.relationships.tags.data[0].type = "tags";
          var opts = {};
          opts.include = "include_example";

          instance.createSalary(companyId, salaryForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('deleteSalary', function() {
        it('should call deleteSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteSalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.deleteSalary(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listSalaries', function() {
        it('should call listSalaries successfully', function(done) {
          // TODO: uncomment, update parameter values for listSalaries call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          ...
          opts.filterRemaining = 8.14;
          opts.sort = "id";
          opts.pageNumber = 1;
          opts.pageSize = 15;
          opts.include = "include_example";

          instance.listSalaries(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20013);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.Salary);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("salaries");
                expect(data.attributes).to.be.a(parasut.SalaryAttributes);
                ...
                expect(data.relationships).to.be.a(parasut.CompanyIdsalariesDataRelationships);
                      expect(data.relationships.employee).to.be.a(parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee);
                        expect(data.relationships.employee.data).to.be.a(parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData);
                          expect(data.relationships.employee.data.id).to.be.a('string');
                      expect(data.relationships.employee.data.id).to.be("");
                      expect(data.relationships.employee.data.type).to.be.a('string');
                      expect(data.relationships.employee.data.type).to.be("employees");
      ...
      describe('paySalary', function() {
        it('should call paySalary successfully', function(done) {
          // TODO: uncomment, update parameter values for paySalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var paymentForm = new parasut.PaymentForm2();
          ...
          instance.paySalary(companyId, id, paymentForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('showSalary', function() {
        it('should call showSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for showSalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showSalary(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('unarchiveSalary', function() {
        it('should call unarchiveSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for unarchiveSalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.unarchiveSalary(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateSalary', function() {
        it('should call updateSalary successfully', function(done) {
          // TODO: uncomment, update parameter values for updateSalary call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var salaryForm = new parasut.SalaryForm1();
          salaryForm.data = new parasut.CompanyIdsalariesData();
          salaryForm.data.id = "";
          salaryForm.data.type = "salaries";
          salaryForm.data.attributes = new parasut.SalaryAttributes();
          ...
          instance.updateSalary(companyId, id, salaryForm, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
