...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.EInvoicesApi();
  });

  describe('(package)', function() {
    describe('EInvoicesApi', function() {
      describe('createEInvoice', function() {
        it('should call createEInvoice successfully', function(done) {
          // TODO: uncomment, update parameter values for createEInvoice call and complete the assertions
          /*
          var companyId = 56;
          var eInvoiceForm = new parasut.EInvoiceForm();
          eInvoiceForm.data = new parasut.CompanyIdeInvoicesData();
          eInvoiceForm.data.id = "";
          eInvoiceForm.data.type = "e_invoices";
          eInvoiceForm.data.attributes = new parasut.EInvoiceFormAttributes();
          eInvoiceForm.data.attributes.vatWithholdingCode = "";
          eInvoiceForm.data.attributes.vatExemptionReasonCode = "";
          eInvoiceForm.data.attributes.vatExemptionReason = "";
          eInvoiceForm.data.attributes.note = "";
          eInvoiceForm.data.attributes.exciseDutyCodes = [new parasut.EDocumentCommonFormAttributesExciseDutyCodes()];
          eInvoiceForm.data.attributes.exciseDutyCodes[0].product = 0;
          eInvoiceForm.data.attributes.exciseDutyCodes[0].salesExciseDutyCode = "57";
          eInvoiceForm.data.attributes.scenario = "basic";
          eInvoiceForm.data.attributes.to = "";
          eInvoiceForm.data.relationships = new parasut.CompanyIdeInvoicesDataRelationships();
          eInvoiceForm.data.relationships.invoice = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoice();
          eInvoiceForm.data.relationships.invoice.data = new parasut.CompanyIdeArchivesDataRelationshipsSalesInvoiceData();
          eInvoiceForm.data.relationships.invoice.data.id = "";
          eInvoiceForm.data.relationships.invoice.data.type = "sales_invoices";

          instance.createEInvoice(companyId, eInvoiceForm, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2015);
            expect(data.data).to.be.a(parasut.TrackableJob);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("trackable_jobs");
              expect(data.data.attributes).to.be.a(parasut.TrackableJobAttributes);
                    expect(data.data.attributes.status).to.be.a('string');
                expect(data.data.attributes.status).to.be("running");
                {
                  let dataCtr = data.data.attributes.errors;
      ...
      describe('showEInvoice', function() {
        it('should call showEInvoice successfully', function(done) {
          // TODO: uncomment, update parameter values for showEInvoice call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;
          var opts = {};
          ...
          instance.showEInvoice(companyId, id, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2007);
            expect(data.data).to.be.a(parasut.EInvoice);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("e_invoices");
              expect(data.data.attributes).to.be.a(parasut.EInvoiceAttributes);
                    expect(data.data.attributes.externalId).to.be.a('string');
                expect(data.data.attributes.externalId).to.be("");
                expect(data.data.attributes.uuid).to.be.a('string');
                expect(data.data.attributes.uuid).to.be("");
                expect(data.data.attributes.envUuid).to.be.a('string');
                expect(data.data.attributes.envUuid).to.be("");
                expect(data.data.attributes.fromAddress).to.be.a('string');
                expect(data.data.attributes.fromAddress).to.be("");
                expect(data.data.attributes.fromVkn).to.be.a('string');
                expect(data.data.attributes.fromVkn).to.be("");
                expect(data.data.attributes.toAddress).to.be.a('string');
                expect(data.data.attributes.toAddress).to.be("");
                expect(data.data.attributes.toVkn).to.be.a('string');
                expect(data.data.attributes.toVkn).to.be("");
                expect(data.data.attributes.direction).to.be.a('string');
                expect(data.data.attributes.direction).to.be("inbound");
                expect(data.data.attributes.note).to.be.a('string');
                expect(data.data.attributes.note).to.be("");
                expect(data.data.attributes.responseType).to.be.a('string');
                expect(data.data.attributes.responseType).to.be("accepted");
                expect(data.data.attributes.contactName).to.be.a('string');
                expect(data.data.attributes.contactName).to.be("");
                expect(data.data.attributes.scenario).to.be.a('string');
                expect(data.data.attributes.scenario).to.be("basic");
                expect(data.data.attributes.status).to.be.a('string');
                expect(data.data.attributes.status).to.be("waiting");
                expect(data.data.attributes.gtbRefNo).to.be.a('string');
                expect(data.data.attributes.gtbRefNo).to.be("");
                expect(data.data.attributes.gtbRegistrationNo).to.be.a('string');
                expect(data.data.attributes.gtbRegistrationNo).to.be("");
                expect(data.data.attributes.gtbExportDate).to.be.a(Date);
                expect(data.data.attributes.gtbExportDate).to.be(new Date());
                expect(data.data.attributes.responseNote).to.be.a('string');
                expect(data.data.attributes.responseNote).to.be("");
                expect(data.data.attributes.issueDate).to.be.a(Date);
                expect(data.data.attributes.issueDate).to.be(new Date());
                expect(data.data.attributes.isExpired).to.be.a('boolean');
                expect(data.data.attributes.isExpired).to.be(false);
                expect(data.data.attributes.isAnswerable).to.be.a('boolean');
                expect(data.data.attributes.isAnswerable).to.be(false);
                ...
                expect(data.data.attributes.itemType).to.be("refund");
              ...
              expect(data.data.relationships).to.be.a(parasut.EInvoiceRelationships);
                    expect(data.data.relationships.invoice).to.be.a(parasut.EInvoiceRelationshipsInvoice);
                      expect(data.data.relationships.invoice.data).to.be.a(parasut.EInvoiceRelationshipsInvoiceData);
                        expect(data.data.relationships.invoice.data.id).to.be.a('string');
                    expect(data.data.relationships.invoice.data.id).to.be("");
                    expect(data.data.relationships.invoice.data.type).to.be.a('string');
                    expect(data.data.relationships.invoice.data.type).to.be("sales_invoices");
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse2007Included);
      ...
      describe('showEInvoicePdf', function() {
        it('should call showEInvoicePdf successfully', function(done) {
          // TODO: uncomment, update parameter values for showEInvoicePdf call and complete the assertions
          /*
          var companyId = 56;
          var id = 56;

          instance.showEInvoicePdf(companyId, id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse2005);
            expect(data.data).to.be.a(parasut.EDocumentPdf);
                  expect(data.data.id).to.be.a('string');
              expect(data.data.id).to.be("");
              expect(data.data.type).to.be.a('string');
              expect(data.data.type).to.be("e_document_pdfs");
              expect(data.data.attributes).to.be.a(parasut.EDocumentPdfAttributes);
                    expect(data.data.attributes.url).to.be.a('string');
                expect(data.data.attributes.url).to.be("");
                expect(data.data.attributes.expiresAt).to.be.a(Date);
                expect(data.data.attributes.expiresAt).to.be(new Date());
              expect(data.data.relationships).to.be.a(Object);
              expect(data.data.relationships).to.be();
