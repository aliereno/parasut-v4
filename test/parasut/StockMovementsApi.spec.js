...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new parasut.StockMovementsApi();
  });

  describe('(package)', function() {
    describe('StockMovementsApi', function() {
      describe('listStockMovements', function() {
        it('should call listStockMovements successfully', function(done) {
          // TODO: uncomment, update parameter values for listStockMovements call and complete the assertions
          /*
          var companyId = 56;
          var opts = {};
          opts.sort = "id";
          ...
          instance.listStockMovements(companyId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(parasut.InlineResponse20016);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.StockMovement);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
                expect(data.type).to.be("stock_movements");
                expect(data.attributes).to.be.a(parasut.StockMovementAttributes);
                      expect(data.attributes.detailNo).to.be.a('number');
                  expect(data.attributes.detailNo).to.be();
                  ...
                  expect(data.attributes.quantity).to.be.a('number');
                  expect(data.attributes.quantity).to.be();
                expect(data.relationships).to.be.a(parasut.StockMovementRelationships);
                      expect(data.relationships.product).to.be.a(parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProduct);
                        expect(data.relationships.product.data).to.be.a(parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData);
                          expect(data.relationships.product.data.id).to.be.a('string');
                      expect(data.relationships.product.data.id).to.be("");
                      expect(data.relationships.product.data.type).to.be.a('string');
                      expect(data.relationships.product.data.type).to.be("products");
                  expect(data.relationships.source).to.be.a(parasut.StockMovementRelationshipsSource);
                        expect(data.relationships.source.data).to.be.a(parasut.StockMovementRelationshipsSourceData);
                          expect(data.relationships.source.data.id).to.be.a('string');
                      expect(data.relationships.source.data.id).to.be("");
                      expect(data.relationships.source.data.type).to.be.a('string');
                      expect(data.relationships.source.data.type).to.be("shipment_documents");
            ...
            }
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(parasut.InlineResponse20016Included);
                expect(data.id).to.be.a('string');
                expect(data.id).to.be("");
                expect(data.type).to.be.a('string');
