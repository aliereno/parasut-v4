...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2011', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2011'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.TransactionsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse2011, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse2011, InlineResponse400) {
  'use strict';

  /**
   * Transactions service.
   * @module parasut/TransactionsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new TransactionsApi. 
   * @alias module:parasut/TransactionsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:parasut/TransactionsApi~deleteTransactionCallback
     ...
     * @param {module:parasut/TransactionsApi~deleteTransactionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteTransaction = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteTransaction");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/transactions/{id}', 'DELETE',
    ...
    /**
     * Callback function to receive the result of the showTransaction operation.
     * @callback module:parasut/TransactionsApi~showTransactionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:parasut/TransactionsApi~showTransactionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2011}
     */
    this.showTransaction = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showTransaction");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showTransaction");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/transactions/{id}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
