...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2015', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2015'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.TrackableJobsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse2015, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse2015, InlineResponse400) {
  'use strict';

  /**
   * TrackableJobs service.
   * @module parasut/TrackableJobsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new TrackableJobsApi. 
   * @alias module:parasut/TrackableJobsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the showTrackableJob operation.
     * @callback module:parasut/TrackableJobsApi~showTrackableJobCallback
     ...
     * @param {Number} id Trackable Job ID
     * @param {module:parasut/TrackableJobsApi~showTrackableJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2015}
     */
    this.showTrackableJob = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showTrackableJob");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showTrackableJob");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/trackable_jobs/{id}', 'GET',
