...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ESmmForm', 'model/InlineResponse2005', 'model/InlineResponse2008', 'model/InlineResponse2016', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ESmmForm'), require('../model/InlineResponse2005'), require('../model/InlineResponse2008'), require('../model/InlineResponse2016'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ESmmsApi = factory(root.parasut.ApiClient, root.parasut.ESmmForm, root.parasut.InlineResponse2005, root.parasut.InlineResponse2008, root.parasut.InlineResponse2016, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, ESmmForm, InlineResponse2005, InlineResponse2008, InlineResponse2016, InlineResponse400) {
  'use strict';

  /**
   * ESmms service.
   * @module parasut/ESmmsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ESmmsApi. 
   * @alias module:parasut/ESmmsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createESmm operation.
     * @callback module:parasut/ESmmsApi~createESmmCallback
     ...
     * @param {module:model/ESmmForm} eSmmForm 
     * @param {module:parasut/ESmmsApi~createESmmCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2016}
     */
    this.createESmm = function(companyId, eSmmForm, callback) {
      var postBody = eSmmForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createESmm");
      }

      // verify the required parameter 'eSmmForm' is set
      if (eSmmForm === undefined || eSmmForm === null) {
        throw new Error("Missing the required parameter 'eSmmForm' when calling createESmm");
      }
    ...
    /**
     * Callback function to receive the result of the showESmm operation.
     * @callback module:parasut/ESmmsApi~showESmmCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {Number} id ESmm ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: sales_invoice*
     * @param {module:parasut/ESmmsApi~showESmmCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2008}
     */
    this.showESmm = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showESmm");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showESmm");
      }
    ...
    /**
     * Callback function to receive the result of the showESmmPdf operation.
     * @callback module:parasut/ESmmsApi~showESmmPdfCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id ESmm ID
     * @param {module:parasut/ESmmsApi~showESmmPdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2005}
     */
    this.showESmmPdf = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showESmmPdf");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showESmmPdf");
      }
