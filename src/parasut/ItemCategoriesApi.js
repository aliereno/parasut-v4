...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20010', 'model/InlineResponse2018', 'model/InlineResponse400', 'model/ItemCategoryForm', 'model/ItemCategoryForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20010'), require('../model/InlineResponse2018'), require('../model/InlineResponse400'), require('../model/ItemCategoryForm'), require('../model/ItemCategoryForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ItemCategoriesApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20010, root.parasut.InlineResponse2018, root.parasut.InlineResponse400, root.parasut.ItemCategoryForm, root.parasut.ItemCategoryForm1);
  }
}(this, function(ApiClient, InlineResponse20010, InlineResponse2018, InlineResponse400, ItemCategoryForm, ItemCategoryForm1) {
  'use strict';

  /**
   * ItemCategories service.
   * @module parasut/ItemCategoriesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ItemCategoriesApi. 
   * @alias module:parasut/ItemCategoriesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createItemCategory operation.
     * @callback module:parasut/ItemCategoriesApi~createItemCategoryCallback
     ...
     * @param {module:model/ItemCategoryForm} itemCategoryForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: parent_category, subcategories*
     * @param {module:parasut/ItemCategoriesApi~createItemCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2018}
     */
    this.createItemCategory = function(companyId, itemCategoryForm, opts, callback) {
      opts = opts || {};
      var postBody = itemCategoryForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createItemCategory");
      }

      // verify the required parameter 'itemCategoryForm' is set
      if (itemCategoryForm === undefined || itemCategoryForm === null) {
        throw new Error("Missing the required parameter 'itemCategoryForm' when calling createItemCategory");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/item_categories', 'POST',
     ...
     * @callback module:parasut/ItemCategoriesApi~deleteItemCategoryCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:parasut/ItemCategoriesApi~deleteItemCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteItemCategory = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteItemCategory");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteItemCategory");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/item_categories/{id}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listItemCategories operation.
     * @callback module:parasut/ItemCategoriesApi~listItemCategoriesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.filterCategoryType 
     * @param {String} opts.sort Sortable parameters - *Available: id, name, category_type* (default to id)
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: parent_category, subcategories*
     * @param {module:parasut/ItemCategoriesApi~listItemCategoriesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20010}
     */
    this.listItemCategories = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listItemCategories");
      }
      ...
      var queryParams = {
        ...
        'filter[category_type]': opts['filterCategoryType'],
        'sort': opts['sort'],
      ...
      return this.apiClient.callApi(
        '/{company_id}/item_categories', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showItemCategory operation.
     * @callback module:parasut/ItemCategoriesApi~showItemCategoryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2018} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: parent_category, subcategories*
     * @param {module:parasut/ItemCategoriesApi~showItemCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2018}
     */
    this.showItemCategory = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showItemCategory");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showItemCategory");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/item_categories/{id}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:parasut/ItemCategoriesApi~updateItemCategoryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2018} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Kategori ID
     * @param {module:model/ItemCategoryForm1} itemCategoryForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: parent_category, subcategories*
     * @param {module:parasut/ItemCategoriesApi~updateItemCategoryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2018}
     */
    this.updateItemCategory = function(companyId, id, itemCategoryForm, opts, callback) {
      opts = opts || {};
      var postBody = itemCategoryForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateItemCategory");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateItemCategory");
      }

      // verify the required parameter 'itemCategoryForm' is set
      if (itemCategoryForm === undefined || itemCategoryForm === null) {
        throw new Error("Missing the required parameter 'itemCategoryForm' when calling updateItemCategory");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/item_categories/{id}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
