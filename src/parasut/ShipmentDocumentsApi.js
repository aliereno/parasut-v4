...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20015', 'model/InlineResponse20113', 'model/InlineResponse400', 'model/ShipmentDocumentForm', 'model/ShipmentDocumentForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20015'), require('../model/InlineResponse20113'), require('../model/InlineResponse400'), require('../model/ShipmentDocumentForm'), require('../model/ShipmentDocumentForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ShipmentDocumentsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20015, root.parasut.InlineResponse20113, root.parasut.InlineResponse400, root.parasut.ShipmentDocumentForm, root.parasut.ShipmentDocumentForm1);
  }
}(this, function(ApiClient, InlineResponse20015, InlineResponse20113, InlineResponse400, ShipmentDocumentForm, ShipmentDocumentForm1) {
  'use strict';

  /**
   * ShipmentDocuments service.
   * @module parasut/ShipmentDocumentsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ShipmentDocumentsApi. 
   * @alias module:parasut/ShipmentDocumentsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createShipmentDocument operation.
     * @callback module:parasut/ShipmentDocumentsApi~createShipmentDocumentCallback
     ...
     * @param {module:model/ShipmentDocumentForm} shipmentDocumentForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices*
     * @param {module:parasut/ShipmentDocumentsApi~createShipmentDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20113}
     */
    this.createShipmentDocument = function(companyId, shipmentDocumentForm, opts, callback) {
      opts = opts || {};
      var postBody = shipmentDocumentForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createShipmentDocument");
      }

      // verify the required parameter 'shipmentDocumentForm' is set
      if (shipmentDocumentForm === undefined || shipmentDocumentForm === null) {
        throw new Error("Missing the required parameter 'shipmentDocumentForm' when calling createShipmentDocument");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/shipment_documents', 'POST',
    ...
    /**
     * Callback function to receive the result of the deleteShipmentDocument operation.
     * @callback module:parasut/ShipmentDocumentsApi~deleteShipmentDocumentCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {Number} id İrsaliye ID
     * @param {module:parasut/ShipmentDocumentsApi~deleteShipmentDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteShipmentDocument = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteShipmentDocument");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteShipmentDocument");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/shipment_documents/{id}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listShipmentDocuments operation.
     * @callback module:parasut/ShipmentDocumentsApi~listShipmentDocumentsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.filterFlowType 
     * @param {String} opts.filterInvoiceStatus 
     * @param {Boolean} opts.filterArchived 
     * @param {String} opts.sort Sortable parameters - *Available: id, issue_date, description, inflow* (default to id)
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices*
     * @param {module:parasut/ShipmentDocumentsApi~listShipmentDocumentsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20015}
     */
    this.listShipmentDocuments = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listShipmentDocuments");
      }
      ...
      var queryParams = {
        'filter[flow_type]': opts['filterFlowType'],
        'filter[invoice_status]': opts['filterInvoiceStatus'],
      ...
      return this.apiClient.callApi(
        '/{company_id}/shipment_documents', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showShipmentDocument operation.
     * @callback module:parasut/ShipmentDocumentsApi~showShipmentDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20113} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices*
     * @param {module:parasut/ShipmentDocumentsApi~showShipmentDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20113}
     */
    this.showShipmentDocument = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showShipmentDocument");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showShipmentDocument");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/shipment_documents/{id}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateShipmentDocument operation.
     * @callback module:parasut/ShipmentDocumentsApi~updateShipmentDocumentCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20113} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id İrsaliye ID
     * @param {module:model/ShipmentDocumentForm1} shipmentDocumentForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: contact, stock_movements, stock_movements.product, tags, invoices*
     * @param {module:parasut/ShipmentDocumentsApi~updateShipmentDocumentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20113}
     */
    this.updateShipmentDocument = function(companyId, id, shipmentDocumentForm, opts, callback) {
      opts = opts || {};
      var postBody = shipmentDocumentForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateShipmentDocument");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateShipmentDocument");
      }

      // verify the required parameter 'shipmentDocumentForm' is set
      if (shipmentDocumentForm === undefined || shipmentDocumentForm === null) {
        throw new Error("Missing the required parameter 'shipmentDocumentForm' when calling updateShipmentDocument");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/shipment_documents/{id}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
