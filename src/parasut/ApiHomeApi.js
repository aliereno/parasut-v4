...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2002', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2002'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ApiHomeApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse2002, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse2002, InlineResponse400) {
  'use strict';

  /**
   * ApiHome service.
   * @module parasut/ApiHomeApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ApiHomeApi. 
   * @alias module:parasut/ApiHomeApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the showMe operation.
     * @callback module:parasut/ApiHomeApi~showMeCallback
     ...
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: user_roles, companies, profile*
     * @param {module:parasut/ApiHomeApi~showMeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2002}
     */
    this.showMe = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
