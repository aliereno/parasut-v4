...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse2006', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse2006'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EInvoiceInboxesApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse2006, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse2006, InlineResponse400) {
  'use strict';

  /**
   * EInvoiceInboxes service.
   * @module parasut/EInvoiceInboxesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new EInvoiceInboxesApi. 
   * @alias module:parasut/EInvoiceInboxesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the listEInvoiceInboxes operation.
     * @callback module:parasut/EInvoiceInboxesApi~listEInvoiceInboxesCallback
     ...
     * @param {Number} opts.filterVkn 
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {module:parasut/EInvoiceInboxesApi~listEInvoiceInboxesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2006}
     */
    this.listEInvoiceInboxes = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listEInvoiceInboxes");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/e_invoice_inboxes', 'GET',
