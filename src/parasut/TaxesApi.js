...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20018', 'model/InlineResponse20115', 'model/InlineResponse2013', 'model/InlineResponse400', 'model/PaymentForm4', 'model/TaxForm', 'model/TaxForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20018'), require('../model/InlineResponse20115'), require('../model/InlineResponse2013'), require('../model/InlineResponse400'), require('../model/PaymentForm4'), require('../model/TaxForm'), require('../model/TaxForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.TaxesApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20018, root.parasut.InlineResponse20115, root.parasut.InlineResponse2013, root.parasut.InlineResponse400, root.parasut.PaymentForm4, root.parasut.TaxForm, root.parasut.TaxForm1);
  }
}(this, function(ApiClient, InlineResponse20018, InlineResponse20115, InlineResponse2013, InlineResponse400, PaymentForm4, TaxForm, TaxForm1) {
  'use strict';

  /**
   * Taxes service.
   * @module parasut/TaxesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new TaxesApi. 
   * @alias module:parasut/TaxesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the archiveTax operation.
     * @callback module:parasut/TaxesApi~archiveTaxCallback
     ...
     * @param {Number} id Vergi ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/TaxesApi~archiveTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20115}
     */
    this.archiveTax = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling archiveTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling archiveTax");
      }
      ...
      var returnType = InlineResponse20115;

      return this.apiClient.callApi(
        '/{company_id}/taxes/{id}/archive', 'PATCH',
    ...
    /**
     * Callback function to receive the result of the createTax operation.
     * @callback module:parasut/TaxesApi~createTaxCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20115} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {module:model/TaxForm} taxForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/TaxesApi~createTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20115}
     */
    this.createTax = function(companyId, taxForm, opts, callback) {
      opts = opts || {};
      var postBody = taxForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createTax");
      }

      // verify the required parameter 'taxForm' is set
      if (taxForm === undefined || taxForm === null) {
        throw new Error("Missing the required parameter 'taxForm' when calling createTax");
      }
    ...
    /**
     * Callback function to receive the result of the deleteTax operation.
     * @callback module:parasut/TaxesApi~deleteTaxCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Vergi ID
     * @param {module:parasut/TaxesApi~deleteTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteTax = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteTax");
      }
    ...
    /**
     * Callback function to receive the result of the listTaxes operation.
     * @callback module:parasut/TaxesApi~listTaxesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags, payments*
     * @param {module:parasut/TaxesApi~listTaxesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20018}
     */
    this.listTaxes = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listTaxes");
      }
    ...
    /**
     * Callback function to receive the result of the payTax operation.
     * @callback module:parasut/TaxesApi~payTaxCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Vergi ID
     * @param {module:model/PaymentForm4} paymentForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: payable, transaction*
     * @param {module:parasut/TaxesApi~payTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    this.payTax = function(companyId, id, paymentForm, opts, callback) {
      opts = opts || {};
      var postBody = paymentForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling payTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling payTax");
      }

      // verify the required parameter 'paymentForm' is set
      if (paymentForm === undefined || paymentForm === null) {
        throw new Error("Missing the required parameter 'paymentForm' when calling payTax");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/taxes/{id}/payments', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showTax operation.
     * @callback module:parasut/TaxesApi~showTaxCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20115} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/TaxesApi~showTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20115}
     */
    this.showTax = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showTax");
      }
    ...
    /**
     * Callback function to receive the result of the unarchiveTax operation.
     * @callback module:parasut/TaxesApi~unarchiveTaxCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20115} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/TaxesApi~unarchiveTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20115}
     */
    this.unarchiveTax = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling unarchiveTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling unarchiveTax");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/taxes/{id}/unarchive', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateTax operation.
     * @callback module:parasut/TaxesApi~updateTaxCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20115} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Vergi ID
     * @param {module:model/TaxForm1} taxForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/TaxesApi~updateTaxCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20115}
     */
    this.updateTax = function(companyId, id, taxForm, opts, callback) {
      opts = opts || {};
      var postBody = taxForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateTax");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateTax");
      }

      // verify the required parameter 'taxForm' is set
      if (taxForm === undefined || taxForm === null) {
        throw new Error("Missing the required parameter 'taxForm' when calling updateTax");
      }
