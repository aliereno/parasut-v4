...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EArchiveForm', 'model/InlineResponse2004', 'model/InlineResponse2005', 'model/InlineResponse2015', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EArchiveForm'), require('../model/InlineResponse2004'), require('../model/InlineResponse2005'), require('../model/InlineResponse2015'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EArchivesApi = factory(root.parasut.ApiClient, root.parasut.EArchiveForm, root.parasut.InlineResponse2004, root.parasut.InlineResponse2005, root.parasut.InlineResponse2015, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, EArchiveForm, InlineResponse2004, InlineResponse2005, InlineResponse2015, InlineResponse400) {
  'use strict';

  /**
   * EArchives service.
   * @module parasut/EArchivesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new EArchivesApi. 
   * @alias module:parasut/EArchivesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createEArchive operation.
     * @callback module:parasut/EArchivesApi~createEArchiveCallback
     ...
     * @param {module:model/EArchiveForm} eArchiveForm 
     * @param {module:parasut/EArchivesApi~createEArchiveCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2015}
     */
    this.createEArchive = function(companyId, eArchiveForm, callback) {
      var postBody = eArchiveForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createEArchive");
      }

      // verify the required parameter 'eArchiveForm' is set
      if (eArchiveForm === undefined || eArchiveForm === null) {
        throw new Error("Missing the required parameter 'eArchiveForm' when calling createEArchive");
      }
    ...
    /**
     * Callback function to receive the result of the showEArchive operation.
     * @callback module:parasut/EArchivesApi~showEArchiveCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {Number} id EArchive ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: sales_invoice*
     * @param {module:parasut/EArchivesApi~showEArchiveCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2004}
     */
    this.showEArchive = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showEArchive");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showEArchive");
      }
    ...
    /**
     * Callback function to receive the result of the showEArchivePdf operation.
     * @callback module:parasut/EArchivesApi~showEArchivePdfCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id EArchive ID
     * @param {module:parasut/EArchivesApi~showEArchivePdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2005}
     */
    this.showEArchivePdf = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showEArchivePdf");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showEArchivePdf");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/e_archives/{id}/pdf', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
