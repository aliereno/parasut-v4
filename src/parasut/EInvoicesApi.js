...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EInvoiceForm', 'model/InlineResponse2005', 'model/InlineResponse2007', 'model/InlineResponse2015', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EInvoiceForm'), require('../model/InlineResponse2005'), require('../model/InlineResponse2007'), require('../model/InlineResponse2015'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EInvoicesApi = factory(root.parasut.ApiClient, root.parasut.EInvoiceForm, root.parasut.InlineResponse2005, root.parasut.InlineResponse2007, root.parasut.InlineResponse2015, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, EInvoiceForm, InlineResponse2005, InlineResponse2007, InlineResponse2015, InlineResponse400) {
  'use strict';

  /**
   * EInvoices service.
   * @module parasut/EInvoicesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new EInvoicesApi. 
   * @alias module:parasut/EInvoicesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createEInvoice operation.
     * @callback module:parasut/EInvoicesApi~createEInvoiceCallback
     ...
     * @param {module:model/EInvoiceForm} eInvoiceForm 
     * @param {module:parasut/EInvoicesApi~createEInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2015}
     */
    this.createEInvoice = function(companyId, eInvoiceForm, callback) {
      var postBody = eInvoiceForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createEInvoice");
      }

      // verify the required parameter 'eInvoiceForm' is set
      if (eInvoiceForm === undefined || eInvoiceForm === null) {
        throw new Error("Missing the required parameter 'eInvoiceForm' when calling createEInvoice");
      }
    ...
    /**
     * Callback function to receive the result of the showEInvoice operation.
     * @callback module:parasut/EInvoicesApi~showEInvoiceCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {Number} id EInvoice ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: invoice*
     * @param {module:parasut/EInvoicesApi~showEInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2007}
     */
    this.showEInvoice = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showEInvoice");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showEInvoice");
      }
    ...
    /**
     * Callback function to receive the result of the showEInvoicePdf operation.
     * @callback module:parasut/EInvoicesApi~showEInvoicePdfCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id EInvoice ID
     * @param {module:parasut/EInvoicesApi~showEInvoicePdfCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2005}
     */
    this.showEInvoicePdf = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showEInvoicePdf");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showEInvoicePdf");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/e_invoices/{id}/pdf', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
