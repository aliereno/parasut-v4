...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BankFeeForm', 'model/BankFeeForm1', 'model/InlineResponse2012', 'model/InlineResponse2013', 'model/InlineResponse400', 'model/PaymentForm'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BankFeeForm'), require('../model/BankFeeForm1'), require('../model/InlineResponse2012'), require('../model/InlineResponse2013'), require('../model/InlineResponse400'), require('../model/PaymentForm'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.BankFeesApi = factory(root.parasut.ApiClient, root.parasut.BankFeeForm, root.parasut.BankFeeForm1, root.parasut.InlineResponse2012, root.parasut.InlineResponse2013, root.parasut.InlineResponse400, root.parasut.PaymentForm);
  }
}(this, function(ApiClient, BankFeeForm, BankFeeForm1, InlineResponse2012, InlineResponse2013, InlineResponse400, PaymentForm) {
  'use strict';

  /**
   * BankFees service.
   * @module parasut/BankFeesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new BankFeesApi. 
   * @alias module:parasut/BankFeesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the archiveBankFee operation.
     * @callback module:parasut/BankFeesApi~archiveBankFeeCallback
     ...
     * @param {Number} id Banka Gideri ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/BankFeesApi~archiveBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    this.archiveBankFee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling archiveBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling archiveBankFee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/bank_fees/{id}/archive', 'PATCH',
    ...
    /**
     * Callback function to receive the result of the createBankFee operation.
     * @callback module:parasut/BankFeesApi~createBankFeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {module:model/BankFeeForm} bankFeeForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/BankFeesApi~createBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    this.createBankFee = function(companyId, bankFeeForm, opts, callback) {
      opts = opts || {};
      var postBody = bankFeeForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createBankFee");
      }

      // verify the required parameter 'bankFeeForm' is set
      if (bankFeeForm === undefined || bankFeeForm === null) {
        throw new Error("Missing the required parameter 'bankFeeForm' when calling createBankFee");
      }
    ...
    /**
     * Callback function to receive the result of the deleteBankFee operation.
     * @callback module:parasut/BankFeesApi~deleteBankFeeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Banka Gideri ID
     * @param {module:parasut/BankFeesApi~deleteBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteBankFee = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling deleteBankFee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/bank_fees/{id}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the payBankFee operation.
     * @callback module:parasut/BankFeesApi~payBankFeeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Banka Gideri ID
     * @param {module:model/PaymentForm} paymentForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: payable, transaction*
     * @param {module:parasut/BankFeesApi~payBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2013}
     */
    this.payBankFee = function(companyId, id, paymentForm, opts, callback) {
      opts = opts || {};
      var postBody = paymentForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling payBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling payBankFee");
      }

      // verify the required parameter 'paymentForm' is set
      if (paymentForm === undefined || paymentForm === null) {
        throw new Error("Missing the required parameter 'paymentForm' when calling payBankFee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/bank_fees/{id}/payments', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showBankFee operation.
     * @callback module:parasut/BankFeesApi~showBankFeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/BankFeesApi~showBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    this.showBankFee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showBankFee");
      }
    ...
    /**
     * Callback function to receive the result of the unarchiveBankFee operation.
     * @callback module:parasut/BankFeesApi~unarchiveBankFeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/BankFeesApi~unarchiveBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    this.unarchiveBankFee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling unarchiveBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling unarchiveBankFee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/bank_fees/{id}/unarchive', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateBankFee operation.
     * @callback module:parasut/BankFeesApi~updateBankFeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2012} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Banka Gideri ID
     * @param {module:model/BankFeeForm1} bankFeeForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, tags*
     * @param {module:parasut/BankFeesApi~updateBankFeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2012}
     */
    this.updateBankFee = function(companyId, id, bankFeeForm, opts, callback) {
      opts = opts || {};
      var postBody = bankFeeForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateBankFee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateBankFee");
      }

      // verify the required parameter 'bankFeeForm' is set
      if (bankFeeForm === undefined || bankFeeForm === null) {
        throw new Error("Missing the required parameter 'bankFeeForm' when calling updateBankFee");
      }
