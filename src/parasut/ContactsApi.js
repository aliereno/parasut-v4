...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactForm', 'model/ContactForm1', 'model/InlineResponse2003', 'model/InlineResponse2011', 'model/InlineResponse2014', 'model/InlineResponse400', 'model/TransactionForm2', 'model/TransactionForm3'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ContactForm'), require('../model/ContactForm1'), require('../model/InlineResponse2003'), require('../model/InlineResponse2011'), require('../model/InlineResponse2014'), require('../model/InlineResponse400'), require('../model/TransactionForm2'), require('../model/TransactionForm3'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ContactsApi = factory(root.parasut.ApiClient, root.parasut.ContactForm, root.parasut.ContactForm1, root.parasut.InlineResponse2003, root.parasut.InlineResponse2011, root.parasut.InlineResponse2014, root.parasut.InlineResponse400, root.parasut.TransactionForm2, root.parasut.TransactionForm3);
  }
}(this, function(ApiClient, ContactForm, ContactForm1, InlineResponse2003, InlineResponse2011, InlineResponse2014, InlineResponse400, TransactionForm2, TransactionForm3) {
  'use strict';

  /**
   * Contacts service.
   * @module parasut/ContactsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ContactsApi. 
   * @alias module:parasut/ContactsApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the collectFromContact operation.
     * @callback module:parasut/ContactsApi~collectFromContactCallback
     ...
     * @param {Number} id Müşteri/Tedarikçi ID
     * @param {module:model/TransactionForm2} transactionForm 
     ...
     * @param {module:parasut/ContactsApi~collectFromContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2011}
     */
    this.collectFromContact = function(companyId, id, transactionForm, opts, callback) {
      opts = opts || {};
      var postBody = transactionForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling collectFromContact");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling collectFromContact");
      }

      // verify the required parameter 'transactionForm' is set
      if (transactionForm === undefined || transactionForm === null) {
        throw new Error("Missing the required parameter 'transactionForm' when calling collectFromContact");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/contacts/{id}/contact_debit_transactions', 'POST',
     ...
     * @callback module:parasut/ContactsApi~createContactCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {module:model/ContactForm} contactForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, contact_portal, contact_people*
     * @param {module:parasut/ContactsApi~createContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2014}
     */
    this.createContact = function(companyId, contactForm, opts, callback) {
      opts = opts || {};
      var postBody = contactForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createContact");
      }

      // verify the required parameter 'contactForm' is set
      if (contactForm === undefined || contactForm === null) {
        throw new Error("Missing the required parameter 'contactForm' when calling createContact");
      }
     ...
     * @callback module:parasut/ContactsApi~deleteContactCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Müşteri/Tedarikçi ID
     * @param {module:parasut/ContactsApi~deleteContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteContact = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteContact");
      }
     ...
     * @callback module:parasut/ContactsApi~listContactsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.filterEmail 
     * @param {String} opts.filterTaxNumber 
     * @param {String} opts.filterTaxOffice 
     * @param {String} opts.filterCity 
     * @param {String} opts.sort Sortable parameters - *Available: id, balance, name, email* (default to -balance)
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, contact_portal, contact_people*
     * @param {module:parasut/ContactsApi~listContactsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2003}
     */
    this.listContacts = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listContacts");
      }
      ...
      var queryParams = {
        ...
        'filter[email]': opts['filterEmail'],
        'filter[tax_number]': opts['filterTaxNumber'],
        'filter[tax_office]': opts['filterTaxOffice'],
        'filter[city]': opts['filterCity'],
        'sort': opts['sort'],
    ...
    /**
     * Callback function to receive the result of the payToContact operation.
     * @callback module:parasut/ContactsApi~payToContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2011} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Müşteri/Tedarikçi ID
     * @param {module:model/TransactionForm3} transactionForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: debit_account, credit_account, payments*
     * @param {module:parasut/ContactsApi~payToContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2011}
     */
    this.payToContact = function(companyId, id, transactionForm, opts, callback) {
      opts = opts || {};
      var postBody = transactionForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling payToContact");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling payToContact");
      }

      // verify the required parameter 'transactionForm' is set
      if (transactionForm === undefined || transactionForm === null) {
        throw new Error("Missing the required parameter 'transactionForm' when calling payToContact");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/contacts/{id}/contact_credit_transactions', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the showContact operation.
     * @callback module:parasut/ContactsApi~showContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2014} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, contact_portal, contact_people*
     * @param {module:parasut/ContactsApi~showContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2014}
     */
    this.showContact = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showContact");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showContact");
      }
     ...
     * @callback module:parasut/ContactsApi~updateContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2014} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Müşteri/Tedarikçi ID
     * @param {module:model/ContactForm1} contactForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, contact_portal, contact_people*
     * @param {module:parasut/ContactsApi~updateContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2014}
     */
    this.updateContact = function(companyId, id, contactForm, opts, callback) {
      opts = opts || {};
      var postBody = contactForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateContact");
      }
      ...
      // verify the required parameter 'contactForm' is set
      if (contactForm === undefined || contactForm === null) {
        throw new Error("Missing the required parameter 'contactForm' when calling updateContact");
      }
