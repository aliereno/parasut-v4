...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20016', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20016'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.StockMovementsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20016, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, InlineResponse20016, InlineResponse400) {
  'use strict';

  /**
   * StockMovements service.
   * @module parasut/StockMovementsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new StockMovementsApi. 
   * @alias module:parasut/StockMovementsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:parasut/StockMovementsApi~listStockMovementsCallback
     ...
     * @param {String} opts.sort Sortable parameters - *Available: id, date* (default to id)
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: product, source, contact*
     * @param {module:parasut/StockMovementsApi~listStockMovementsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20016}
     */
    this.listStockMovements = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listStockMovements");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/stock_movements', 'GET',
