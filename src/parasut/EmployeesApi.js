...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EmployeeForm', 'model/EmployeeForm1', 'model/InlineResponse2009', 'model/InlineResponse2017', 'model/InlineResponse400'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/EmployeeForm'), require('../model/EmployeeForm1'), require('../model/InlineResponse2009'), require('../model/InlineResponse2017'), require('../model/InlineResponse400'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EmployeesApi = factory(root.parasut.ApiClient, root.parasut.EmployeeForm, root.parasut.EmployeeForm1, root.parasut.InlineResponse2009, root.parasut.InlineResponse2017, root.parasut.InlineResponse400);
  }
}(this, function(ApiClient, EmployeeForm, EmployeeForm1, InlineResponse2009, InlineResponse2017, InlineResponse400) {
  'use strict';

  /**
   * Employees service.
   * @module parasut/EmployeesApi
   * @version 4.0.0
   */

  /**
   * Constructs a new EmployeesApi. 
   * @alias module:parasut/EmployeesApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the archiveEmployee operation.
     * @callback module:parasut/EmployeesApi~archiveEmployeeCallback
     ...
     * @param {Number} id Çalışan ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~archiveEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2017}
     */
    this.archiveEmployee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling archiveEmployee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling archiveEmployee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/employees/{id}/archive', 'PATCH',
     ...
     * @callback module:parasut/EmployeesApi~createEmployeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2017} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {module:model/EmployeeForm} employeeForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~createEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2017}
     */
    this.createEmployee = function(companyId, employeeForm, opts, callback) {
      opts = opts || {};
      var postBody = employeeForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createEmployee");
      }

      // verify the required parameter 'employeeForm' is set
      if (employeeForm === undefined || employeeForm === null) {
        throw new Error("Missing the required parameter 'employeeForm' when calling createEmployee");
      }
     ...
     * @callback module:parasut/EmployeesApi~deleteEmployeeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Çalışan ID
     * @param {module:parasut/EmployeesApi~deleteEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteEmployee = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteEmployee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/employees/{id}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:parasut/EmployeesApi~listEmployeesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~listEmployeesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2009}
     */
    this.listEmployees = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listEmployees");
      }
    ...
    /**
     * Callback function to receive the result of the showEmployee operation.
     * @callback module:parasut/EmployeesApi~showEmployeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2017} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~showEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2017}
     */
    this.showEmployee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showEmployee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showEmployee");
      }
    ...
    /**
     * Callback function to receive the result of the unarchiveEmployee operation.
     * @callback module:parasut/EmployeesApi~unarchiveEmployeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2017} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~unarchiveEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2017}
     */
    this.unarchiveEmployee = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling unarchiveEmployee");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling unarchiveEmployee");
      }
      ...
      return this.apiClient.callApi(
        '/{company_id}/employees/{id}/unarchive', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
     ...
     * @callback module:parasut/EmployeesApi~updateEmployeeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2017} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Çalışan ID
     * @param {module:model/EmployeeForm1} employeeForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category, managed_by_user, managed_by_user_role*
     * @param {module:parasut/EmployeesApi~updateEmployeeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2017}
     */
    this.updateEmployee = function(companyId, id, employeeForm, opts, callback) {
      opts = opts || {};
      var postBody = employeeForm;
      ...
      // verify the required parameter 'employeeForm' is set
      if (employeeForm === undefined || employeeForm === null) {
        throw new Error("Missing the required parameter 'employeeForm' when calling updateEmployee");
      }
