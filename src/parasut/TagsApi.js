...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20017', 'model/InlineResponse20114', 'model/InlineResponse400', 'model/TagForm', 'model/TagForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20017'), require('../model/InlineResponse20114'), require('../model/InlineResponse400'), require('../model/TagForm'), require('../model/TagForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.TagsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20017, root.parasut.InlineResponse20114, root.parasut.InlineResponse400, root.parasut.TagForm, root.parasut.TagForm1);
  }
}(this, function(ApiClient, InlineResponse20017, InlineResponse20114, InlineResponse400, TagForm, TagForm1) {
  'use strict';

  /**
   * Tags service.
   * @module parasut/TagsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new TagsApi. 
   * @alias module:parasut/TagsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:parasut/TagsApi~createTagCallback
     ...
     * @param {module:model/TagForm} tagForm 
     * @param {module:parasut/TagsApi~createTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20114}
     */
    this.createTag = function(companyId, tagForm, callback) {
      var postBody = tagForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling createTag");
      }

      // verify the required parameter 'tagForm' is set
      if (tagForm === undefined || tagForm === null) {
        throw new Error("Missing the required parameter 'tagForm' when calling createTag");
      }
     ...
     * @callback module:parasut/TagsApi~deleteTagCallback
     * @param {String} error Error message, if any.
     ...
     * 
     * @param {Number} companyId Firma ID
     * @param {Number} id Etiket ID
     * @param {module:parasut/TagsApi~deleteTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteTag = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling deleteTag");
      }
     ...
     * @callback module:parasut/TagsApi~listTagsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:parasut/TagsApi~listTagsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20017}
     */
    this.listTags = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling listTags");
      }
    ...
    /**
     * Callback function to receive the result of the showTag operation.
     * @callback module:parasut/TagsApi~showTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20114} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Etiket ID
     * @param {module:parasut/TagsApi~showTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20114}
     */
    this.showTag = function(companyId, id, callback) {
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showTag");
      }
     ...
     * @callback module:parasut/TagsApi~updateTagCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse20114} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Etiket ID
     * @param {module:model/TagForm1} tagForm 
     * @param {module:parasut/TagsApi~updateTagCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20114}
     */
    this.updateTag = function(companyId, id, tagForm, callback) {
      var postBody = tagForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateTag");
      }
      ...
      // verify the required parameter 'tagForm' is set
      if (tagForm === undefined || tagForm === null) {
        throw new Error("Missing the required parameter 'tagForm' when calling updateTag");
      }
