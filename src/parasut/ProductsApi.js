...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InlineResponse20011', 'model/InlineResponse2019', 'model/InlineResponse400', 'model/ProductForm', 'model/ProductForm1'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/InlineResponse20011'), require('../model/InlineResponse2019'), require('../model/InlineResponse400'), require('../model/ProductForm'), require('../model/ProductForm1'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ProductsApi = factory(root.parasut.ApiClient, root.parasut.InlineResponse20011, root.parasut.InlineResponse2019, root.parasut.InlineResponse400, root.parasut.ProductForm, root.parasut.ProductForm1);
  }
}(this, function(ApiClient, InlineResponse20011, InlineResponse2019, InlineResponse400, ProductForm, ProductForm1) {
  'use strict';

  /**
   * Products service.
   * @module parasut/ProductsApi
   * @version 4.0.0
   */

  /**
   * Constructs a new ProductsApi. 
   * @alias module:parasut/ProductsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:parasut/ProductsApi~createProductCallback
     ...
     * @param {module:model/ProductForm} productForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category*
     * @param {module:parasut/ProductsApi~createProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2019}
     */
    this.createProduct = function(companyId, productForm, opts, callback) {
      opts = opts || {};
      var postBody = productForm;
      ...
      if (productForm === undefined || productForm === null) {
        throw new Error("Missing the required parameter 'productForm' when calling createProduct");
      }
     ...
     * @callback module:parasut/ProductsApi~deleteProductCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:parasut/ProductsApi~deleteProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    this.deleteProduct = function(companyId, id, callback) {
      var postBody = null;
     ...
     * @callback module:parasut/ProductsApi~listProductsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.filterCode 
     * @param {String} opts.sort Sortable parameters - *Available: id, name* (default to -id)
     * @param {Number} opts.pageNumber Page Number (default to 1)
     * @param {Number} opts.pageSize Page Size (default to 15)
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category*
     * @param {module:parasut/ProductsApi~listProductsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse20011}
     */
    this.listProducts = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the showProduct operation.
     * @callback module:parasut/ProductsApi~showProductCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2019} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category*
     * @param {module:parasut/ProductsApi~showProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2019}
     */
    this.showProduct = function(companyId, id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling showProduct");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling showProduct");
      }
     ...
     * @callback module:parasut/ProductsApi~updateProductCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2019} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} companyId Firma ID
     * @param {Number} id Ürün ID
     * @param {module:model/ProductForm1} productForm 
     * @param {Object} opts Optional parameters
     * @param {String} opts.include Response ile birlikte geri dönmesini istediğiniz ilişkiler - *Available: category*
     * @param {module:parasut/ProductsApi~updateProductCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2019}
     */
    this.updateProduct = function(companyId, id, productForm, opts, callback) {
      opts = opts || {};
      var postBody = productForm;

      // verify the required parameter 'companyId' is set
      if (companyId === undefined || companyId === null) {
        throw new Error("Missing the required parameter 'companyId' when calling updateProduct");
      }
      ...
      // verify the required parameter 'productForm' is set
      if (productForm === undefined || productForm === null) {
        throw new Error("Missing the required parameter 'productForm' when calling updateProduct");
      }
