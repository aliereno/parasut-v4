...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EInvoiceInboxAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EInvoiceInboxAttributes model module.
   * @module model/EInvoiceInboxAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoiceInboxAttributes</code>.
   * @alias module:model/EInvoiceInboxAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>EInvoiceInboxAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoiceInboxAttributes} obj Optional instance to populate.
   * @return {module:model/EInvoiceInboxAttributes} The populated <code>EInvoiceInboxAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('vkn'))
        obj.vkn = ApiClient.convertToType(data['vkn'], 'String');
      if (data.hasOwnProperty('e_invoice_address'))
        obj.eInvoiceAddress = ApiClient.convertToType(data['e_invoice_address'], 'String');
      if (data.hasOwnProperty('name'))
        obj.name = ApiClient.convertToType(data['name'], 'String');
      if (data.hasOwnProperty('inbox_type'))
        obj.inboxType = ApiClient.convertToType(data['inbox_type'], 'String');
      if (data.hasOwnProperty('address_registered_at'))
        obj.addressRegisteredAt = ApiClient.convertToType(data['address_registered_at'], 'Date');
      if (data.hasOwnProperty('registered_at'))
        obj.registeredAt = ApiClient.convertToType(data['registered_at'], 'Date');
   ...
   * @member {String} vkn
   */
  exports.prototype.vkn = undefined;

  /**
   * @member {String} eInvoiceAddress
   */
  exports.prototype.eInvoiceAddress = undefined;
  ...
  /**
   * @member {String} inboxType
   */
  exports.prototype.inboxType = undefined;

  /**
   * @member {Date} addressRegisteredAt
   */
  exports.prototype.addressRegisteredAt = undefined;
