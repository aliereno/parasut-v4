...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.Tax = factory(root.parasut.ApiClient, root.parasut.CompanyIdbankFeesDataRelationships, root.parasut.TaxAttributes);
  }
   ...
   * @class
   * @param attributes {module:model/TaxAttributes} 
   */
   ...
   * @member {module:model/Tax.TypeEnum} type
   */
