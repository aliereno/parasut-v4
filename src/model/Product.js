...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.Product = factory(root.parasut.ApiClient, root.parasut.CompanyIdemployeesDataRelationships, root.parasut.ProductAttributes);
  }
   ...
   * @class
   * @param attributes {module:model/ProductAttributes} 
   */
