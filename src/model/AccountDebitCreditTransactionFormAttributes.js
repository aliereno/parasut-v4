...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.AccountDebitCreditTransactionFormAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AccountDebitCreditTransactionFormAttributes model module.
   * @module model/AccountDebitCreditTransactionFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>AccountDebitCreditTransactionFormAttributes</code>.
   * @alias module:model/AccountDebitCreditTransactionFormAttributes
   * @class
   * @param _date {Date} İşlem Tarihi
   * @param amount {Number} İşlem Tutarı
   */
  var exports = function(_date, amount) {
    this._date = _date;
    this.amount = amount;
  };

  /**
   * Constructs a <code>AccountDebitCreditTransactionFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountDebitCreditTransactionFormAttributes} obj Optional instance to populate.
   * @return {module:model/AccountDebitCreditTransactionFormAttributes} The populated <code>AccountDebitCreditTransactionFormAttributes</code> instance.
   */
