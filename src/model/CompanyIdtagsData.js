...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TagAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TagAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdtagsData = factory(root.parasut.ApiClient, root.parasut.TagAttributes);
  }
}(this, function(ApiClient, TagAttributes) {
  'use strict';

  /**
   * The CompanyIdtagsData model module.
   * @module model/CompanyIdtagsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdtagsData</code>.
   * @alias module:model/CompanyIdtagsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdtagsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdtagsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdtagsData} The populated <code>CompanyIdtagsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = TagAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdtagsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/TagAttributes} attributes
   */
