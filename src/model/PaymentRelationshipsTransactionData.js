...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PaymentRelationshipsTransactionData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PaymentRelationshipsTransactionData model module.
   * @module model/PaymentRelationshipsTransactionData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PaymentRelationshipsTransactionData</code>.
   * @alias module:model/PaymentRelationshipsTransactionData
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentRelationshipsTransactionData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentRelationshipsTransactionData} obj Optional instance to populate.
   * @return {module:model/PaymentRelationshipsTransactionData} The populated <code>PaymentRelationshipsTransactionData</code> instance.
   */
   ...
   * @member {module:model/PaymentRelationshipsTransactionData.TypeEnum} type
   */
