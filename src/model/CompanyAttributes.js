...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyAttributes = factory(root.parasut.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('subscription_status'))
        obj.subscriptionStatus = ApiClient.convertToType(data['subscription_status'], 'String');
      if (data.hasOwnProperty('trial_expiration_at'))
        obj.trialExpirationAt = ApiClient.convertToType(data['trial_expiration_at'], 'Date');
      if (data.hasOwnProperty('allowed_inspection_at'))
        obj.allowedInspectionAt = ApiClient.convertToType(data['allowed_inspection_at'], 'Date');
      if (data.hasOwnProperty('app_url'))
        obj.appUrl = ApiClient.convertToType(data['app_url'], 'String');
      if (data.hasOwnProperty('legal_name'))
        obj.legalName = ApiClient.convertToType(data['legal_name'], 'String');
      if (data.hasOwnProperty('occupation_field'))
        obj.occupationField = ApiClient.convertToType(data['occupation_field'], 'String');
      ...
      if (data.hasOwnProperty('mersis_no'))
        obj.mersisNo = ApiClient.convertToType(data['mersis_no'], 'String');
      if (data.hasOwnProperty('total_unused_bonus_months'))
        obj.totalUnusedBonusMonths = ApiClient.convertToType(data['total_unused_bonus_months'], 'Number');
      if (data.hasOwnProperty('subscription_started_at'))
        obj.subscriptionStartedAt = ApiClient.convertToType(data['subscription_started_at'], 'Date');
      if (data.hasOwnProperty('subscription_renewed_at'))
        obj.subscriptionRenewedAt = ApiClient.convertToType(data['subscription_renewed_at'], 'Date');
      if (data.hasOwnProperty('subscription_value'))
        obj.subscriptionValue = ApiClient.convertToType(data['subscription_value'], 'Number');
      if (data.hasOwnProperty('primary_job'))
        obj.primaryJob = ApiClient.convertToType(data['primary_job'], 'String');
      ...
      if (data.hasOwnProperty('inspectable'))
        obj.inspectable = ApiClient.convertToType(data['inspectable'], 'Boolean');
      if (data.hasOwnProperty('is_in_grace_period'))
        obj.isInGracePeriod = ApiClient.convertToType(data['is_in_grace_period'], 'Boolean');
      if (data.hasOwnProperty('subscription_status_for_analytics'))
        obj.subscriptionStatusForAnalytics = ApiClient.convertToType(data['subscription_status_for_analytics'], 'String');
      if (data.hasOwnProperty('end_of_grace_period_at'))
        obj.endOfGracePeriodAt = ApiClient.convertToType(data['end_of_grace_period_at'], 'Date');
      if (data.hasOwnProperty('inventory_enabled'))
        obj.inventoryEnabled = ApiClient.convertToType(data['inventory_enabled'], 'Boolean');
      if (data.hasOwnProperty('is_in_trial_period'))
        obj.isInTrialPeriod = ApiClient.convertToType(data['is_in_trial_period'], 'Boolean');
      if (data.hasOwnProperty('has_iyzico_integration'))
        obj.hasIyzicoIntegration = ApiClient.convertToType(data['has_iyzico_integration'], 'Boolean');
      if (data.hasOwnProperty('has_active_subscription'))
        obj.hasActiveSubscription = ApiClient.convertToType(data['has_active_subscription'], 'Boolean');
      if (data.hasOwnProperty('logo'))
        obj.logo = ApiClient.convertToType(data['logo'], Object);
      if (data.hasOwnProperty('subscription_info_text'))
        obj.subscriptionInfoText = ApiClient.convertToType(data['subscription_info_text'], 'String');
      if (data.hasOwnProperty('subscription_info_title'))
        obj.subscriptionInfoTitle = ApiClient.convertToType(data['subscription_info_title'], 'String');
      if (data.hasOwnProperty('subscription_url'))
        obj.subscriptionUrl = ApiClient.convertToType(data['subscription_url'], 'String');
      if (data.hasOwnProperty('referral_url'))
        obj.referralUrl = ApiClient.convertToType(data['referral_url'], 'String');
      if (data.hasOwnProperty('subscription_plan_duration'))
        obj.subscriptionPlanDuration = ApiClient.convertToType(data['subscription_plan_duration'], 'Number');
      ...
      if (data.hasOwnProperty('e_invoicing_activated_at'))
        obj.eInvoicingActivatedAt = ApiClient.convertToType(data['e_invoicing_activated_at'], 'Date');
      if (data.hasOwnProperty('has_selected_plan'))
        obj.hasSelectedPlan = ApiClient.convertToType(data['has_selected_plan'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * @member {Date} trialExpirationAt
   */
  exports.prototype.trialExpirationAt = undefined;

  /**
   * @member {Date} allowedInspectionAt
   */
  exports.prototype.allowedInspectionAt = undefined;
  ...
  /**
   * @member {String} occupationField
   */
  exports.prototype.occupationField = undefined;
  ...
  /**
   * @member {String} mersisNo
   */
  exports.prototype.mersisNo = undefined;

  /**
   * @member {Number} totalUnusedBonusMonths
   */
  exports.prototype.totalUnusedBonusMonths = undefined;

  /**
   * @member {Date} subscriptionStartedAt
   */
  exports.prototype.subscriptionStartedAt = undefined;

  /**
   * @member {Date} subscriptionRenewedAt
   */
  exports.prototype.subscriptionRenewedAt = undefined;

  /**
   * @member {Number} subscriptionValue
   */
  exports.prototype.subscriptionValue = undefined;

  /**
   * @member {String} primaryJob
   */
  exports.prototype.primaryJob = undefined;
   ...
   */
  exports.prototype.accessible = undefined;

  /**
   * @member {Boolean} inspectable
   */
  exports.prototype.inspectable = undefined;

  /**
   * @member {Boolean} isInGracePeriod
   */
  exports.prototype.isInGracePeriod = undefined;

  /**
   * @member {String} subscriptionStatusForAnalytics
   */
  exports.prototype.subscriptionStatusForAnalytics = undefined;

  /**
   * @member {Date} endOfGracePeriodAt
   */
  exports.prototype.endOfGracePeriodAt = undefined;
  ...
  /**
   * @member {Boolean} isInTrialPeriod
   */
  exports.prototype.isInTrialPeriod = undefined;

  /**
   * @member {Boolean} hasIyzicoIntegration
   */
  exports.prototype.hasIyzicoIntegration = undefined;
  ...
  /**
   * @member {String} subscriptionInfoText
   */
  exports.prototype.subscriptionInfoText = undefined;

  /**
   * @member {String} subscriptionInfoTitle
   */
  exports.prototype.subscriptionInfoTitle = undefined;

  /**
   * @member {String} subscriptionUrl
   */
  exports.prototype.subscriptionUrl = undefined;

  /**
   * @member {String} referralUrl
   */
  exports.prototype.referralUrl = undefined;

  /**
   * @member {Number} subscriptionPlanDuration
   */
  exports.prototype.subscriptionPlanDuration = undefined;
  ...
  /**
   * @member {Date} eInvoicingActivatedAt
   */
  exports.prototype.eInvoicingActivatedAt = undefined;

  /**
   * @member {Boolean} hasSelectedPlan
   */
  exports.prototype.hasSelectedPlan = undefined;
