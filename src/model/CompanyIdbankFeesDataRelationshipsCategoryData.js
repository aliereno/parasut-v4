...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdbankFeesDataRelationshipsCategoryData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdbankFeesDataRelationshipsCategoryData model module.
   * @module model/CompanyIdbankFeesDataRelationshipsCategoryData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdbankFeesDataRelationshipsCategoryData</code>.
   * @alias module:model/CompanyIdbankFeesDataRelationshipsCategoryData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdbankFeesDataRelationshipsCategoryData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdbankFeesDataRelationshipsCategoryData} obj Optional instance to populate.
   * @return {module:model/CompanyIdbankFeesDataRelationshipsCategoryData} The populated <code>CompanyIdbankFeesDataRelationshipsCategoryData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdbankFeesDataRelationshipsCategoryData.TypeEnum} type
   */
