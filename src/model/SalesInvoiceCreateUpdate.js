...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SalesInvoiceCreateUpdateAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SalesInvoiceCreateUpdateAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.SalesInvoiceCreateUpdate = factory(root.parasut.ApiClient, root.parasut.SalesInvoiceCreateUpdateAttributes);
  }
}(this, function(ApiClient, SalesInvoiceCreateUpdateAttributes) {
  'use strict';

  /**
   * The SalesInvoiceCreateUpdate model module.
   * @module model/SalesInvoiceCreateUpdate
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceCreateUpdate</code>.
   * @alias module:model/SalesInvoiceCreateUpdate
   * @class
   * @param attributes {module:model/SalesInvoiceCreateUpdateAttributes} 
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceCreateUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceCreateUpdate} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceCreateUpdate} The populated <code>SalesInvoiceCreateUpdate</code> instance.
   */
   ...
   * @member {module:model/SalesInvoiceCreateUpdate.TypeEnum} type
   */
