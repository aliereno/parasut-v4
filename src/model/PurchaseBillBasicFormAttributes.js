...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillBasicFormAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillBasicFormAttributes model module.
   * @module model/PurchaseBillBasicFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillBasicFormAttributes</code>.
   * @alias module:model/PurchaseBillBasicFormAttributes
   * @class
   * @param itemType {module:model/PurchaseBillBasicFormAttributes.ItemTypeEnum} 
   * @param issueDate {Date} 
   * @param dueDate {Date} 
   * @param currency {module:model/PurchaseBillBasicFormAttributes.CurrencyEnum} 
   * @param netTotal {Number} 
   * @param totalVat {Number} 
   */
  var exports = function(itemType, issueDate, dueDate, currency, netTotal, totalVat) {
  ...
  /**
   * Constructs a <code>PurchaseBillBasicFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillBasicFormAttributes} obj Optional instance to populate.
   * @return {module:model/PurchaseBillBasicFormAttributes} The populated <code>PurchaseBillBasicFormAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/PurchaseBillBasicFormAttributes.ItemTypeEnum} itemType
   */
  ...
  /**
   * @member {module:model/PurchaseBillBasicFormAttributes.CurrencyEnum} currency
   */
