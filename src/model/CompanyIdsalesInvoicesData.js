...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdsalesInvoicesDataRelationships', 'model/SalesInvoiceCreateUpdateAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdsalesInvoicesDataRelationships'), require('./SalesInvoiceCreateUpdateAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdsalesInvoicesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdsalesInvoicesDataRelationships, root.parasut.SalesInvoiceCreateUpdateAttributes);
  }
}(this, function(ApiClient, CompanyIdsalesInvoicesDataRelationships, SalesInvoiceCreateUpdateAttributes) {
  'use strict';

  /**
   * The CompanyIdsalesInvoicesData model module.
   * @module model/CompanyIdsalesInvoicesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalesInvoicesData</code>.
   * @alias module:model/CompanyIdsalesInvoicesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalesInvoicesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalesInvoicesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalesInvoicesData} The populated <code>CompanyIdsalesInvoicesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SalesInvoiceCreateUpdateAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/CompanyIdsalesInvoicesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/SalesInvoiceCreateUpdateAttributes} attributes
   */
