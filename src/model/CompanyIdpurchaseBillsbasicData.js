...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdpurchaseBillsbasicDataRelationships', 'model/PurchaseBillBasicFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdpurchaseBillsbasicDataRelationships'), require('./PurchaseBillBasicFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdpurchaseBillsbasicData = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsbasicDataRelationships, root.parasut.PurchaseBillBasicFormAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsbasicDataRelationships, PurchaseBillBasicFormAttributes) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsbasicData model module.
   * @module model/CompanyIdpurchaseBillsbasicData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsbasicData</code>.
   * @alias module:model/CompanyIdpurchaseBillsbasicData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsbasicData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsbasicData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsbasicData} The populated <code>CompanyIdpurchaseBillsbasicData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PurchaseBillBasicFormAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdpurchaseBillsbasicDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdpurchaseBillsbasicData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/PurchaseBillBasicFormAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationships} relationships
   */
