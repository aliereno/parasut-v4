...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalesInvoiceAttributes model module.
   * @module model/SalesInvoiceAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceAttributes</code>.
   * @alias module:model/SalesInvoiceAttributes
   * @class
   * @param itemType {module:model/SalesInvoiceAttributes.ItemTypeEnum} Fatura türü
   * @param issueDate {Date} Düzenleme tarihi
   */
  var exports = function(itemType, issueDate) {
    this.itemType = itemType;
    this.issueDate = issueDate;
  };

  /**
   * Constructs a <code>SalesInvoiceAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceAttributes} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceAttributes} The populated <code>SalesInvoiceAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('withholding'))
        obj.withholding = ApiClient.convertToType(data['withholding'], 'Number');
      ...
      if (data.hasOwnProperty('vat_withholding'))
        obj.vatWithholding = ApiClient.convertToType(data['vat_withholding'], 'Number');
      ...
      if (data.hasOwnProperty('before_taxes_total'))
        obj.beforeTaxesTotal = ApiClient.convertToType(data['before_taxes_total'], 'Number');
      ...
      if (data.hasOwnProperty('invoice_series'))
        obj.invoiceSeries = ApiClient.convertToType(data['invoice_series'], 'String');
      if (data.hasOwnProperty('invoice_id'))
        obj.invoiceId = ApiClient.convertToType(data['invoice_id'], 'Number');
      ...
      if (data.hasOwnProperty('billing_address'))
        obj.billingAddress = ApiClient.convertToType(data['billing_address'], 'String');
      if (data.hasOwnProperty('billing_phone'))
        obj.billingPhone = ApiClient.convertToType(data['billing_phone'], 'String');
      if (data.hasOwnProperty('billing_fax'))
        obj.billingFax = ApiClient.convertToType(data['billing_fax'], 'String');
      if (data.hasOwnProperty('tax_office'))
        obj.taxOffice = ApiClient.convertToType(data['tax_office'], 'String');
      ...
      if (data.hasOwnProperty('is_abroad'))
        obj.isAbroad = ApiClient.convertToType(data['is_abroad'], 'Boolean');
      if (data.hasOwnProperty('order_no'))
        obj.orderNo = ApiClient.convertToType(data['order_no'], 'String');
      if (data.hasOwnProperty('order_date'))
        obj.orderDate = ApiClient.convertToType(data['order_date'], 'Date');
      if (data.hasOwnProperty('shipment_addres'))
        obj.shipmentAddres = ApiClient.convertToType(data['shipment_addres'], 'String');
      if (data.hasOwnProperty('shipment_included'))
        obj.shipmentIncluded = ApiClient.convertToType(data['shipment_included'], 'Boolean');
      if (data.hasOwnProperty('cash_sale'))
        obj.cashSale = ApiClient.convertToType(data['cash_sale'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * Tevkifat
   * @member {Number} vatWithholding
   */
  exports.prototype.vatWithholding = undefined;
   ...
   * @member {Number} beforeTaxesTotal
   */
  exports.prototype.beforeTaxesTotal = undefined;
  ...
  /**
   * Tahsilat durumu
   * @member {module:model/SalesInvoiceAttributes.PaymentStatusEnum} paymentStatus
   */
  ...
  /**
   * Fatura türü
   * @member {module:model/SalesInvoiceAttributes.ItemTypeEnum} itemType
   */
  ...
  /**
   * Fatura seri
   * @member {String} invoiceSeries
   */
  exports.prototype.invoiceSeries = undefined;
  ...
  /**
   * Döviz tipi
   * @member {module:model/SalesInvoiceAttributes.CurrencyEnum} currency
   */
  ...
  /**
   * @member {module:model/SalesInvoiceAttributes.InvoiceDiscountTypeEnum} invoiceDiscountType
   */
   ...
   */
  exports.prototype.taxOffice = undefined;
   ...
   * @member {Boolean} isAbroad
   */
  exports.prototype.isAbroad = undefined;
  ...
  /**
   * @member {String} shipmentAddres
   */
  exports.prototype.shipmentAddres = undefined;

  /**
   * İrsaliyeli fatura
   * @member {Boolean} shipmentIncluded
   */
  exports.prototype.shipmentIncluded = undefined;

  /**
   * Peşin satış
   * @member {Boolean} cashSale
   */
  exports.prototype.cashSale = undefined;
  ...
  exports.ItemTypeEnum = {
    ...
    /**
     * value: "recurring_estimate"
     * @const
     */
    recurringEstimate: "recurring_estimate",

    /**
     * value: "recurring_export"
     * @const
     */
