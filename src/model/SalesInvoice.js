...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SalesInvoiceAttributes', 'model/SalesInvoiceRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SalesInvoiceAttributes'), require('./SalesInvoiceRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.SalesInvoice = factory(root.parasut.ApiClient, root.parasut.SalesInvoiceAttributes, root.parasut.SalesInvoiceRelationships);
  }
}(this, function(ApiClient, SalesInvoiceAttributes, SalesInvoiceRelationships) {
  'use strict';

  /**
   * The SalesInvoice model module.
   * @module model/SalesInvoice
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoice</code>.
   * @alias module:model/SalesInvoice
   * @class
   * @param attributes {module:model/SalesInvoiceAttributes} 
   */
  ...
  /**
   * Constructs a <code>SalesInvoice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoice} obj Optional instance to populate.
   * @return {module:model/SalesInvoice} The populated <code>SalesInvoice</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('relationships'))
        obj.relationships = SalesInvoiceRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/SalesInvoice.TypeEnum} type
   */
  ...
  /**
   * @member {module:model/SalesInvoiceRelationships} relationships
   */
