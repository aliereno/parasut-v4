...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StockMovementAttributes', 'model/StockMovementRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StockMovementAttributes'), require('./StockMovementRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.StockMovement = factory(root.parasut.ApiClient, root.parasut.StockMovementAttributes, root.parasut.StockMovementRelationships);
  }
}(this, function(ApiClient, StockMovementAttributes, StockMovementRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/StockMovementAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('relationships'))
        obj.relationships = StockMovementRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/StockMovement.TypeEnum} type
   */
  ...
  /**
   * @member {module:model/StockMovementRelationships} relationships
   */
