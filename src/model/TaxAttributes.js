...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.TaxAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TaxAttributes model module.
   * @module model/TaxAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TaxAttributes</code>.
   * @alias module:model/TaxAttributes
   * @class
   ...
   */
  var exports = function(description, issueDate, dueDate, netTotal) {
  ...
  /**
   * Constructs a <code>TaxAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaxAttributes} obj Optional instance to populate.
   * @return {module:model/TaxAttributes} The populated <code>TaxAttributes</code> instance.
   */
