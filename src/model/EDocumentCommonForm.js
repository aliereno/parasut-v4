...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EDocumentCommonFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EDocumentCommonFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EDocumentCommonForm = factory(root.parasut.ApiClient, root.parasut.EDocumentCommonFormAttributes);
  }
}(this, function(ApiClient, EDocumentCommonFormAttributes) {
  'use strict';

  /**
   * The EDocumentCommonForm model module.
   * @module model/EDocumentCommonForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EDocumentCommonForm</code>.
   * @alias module:model/EDocumentCommonForm
   * @class
   * @param attributes {module:model/EDocumentCommonFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>EDocumentCommonForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EDocumentCommonForm} obj Optional instance to populate.
   * @return {module:model/EDocumentCommonForm} The populated <code>EDocumentCommonForm</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EDocumentCommonFormAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/EDocumentCommonForm.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EDocumentCommonFormAttributes} attributes
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "e_document_commons"
     * @const
     */
    eDocumentCommons: "e_document_commons"
  };
