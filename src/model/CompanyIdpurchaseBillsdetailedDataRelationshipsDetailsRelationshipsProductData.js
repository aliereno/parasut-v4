...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData model module.
   * @module model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData</code>.
   * @alias module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData} The populated <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationshipsProductData.TypeEnum} type
   */
