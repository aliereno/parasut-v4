...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.AddressAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddressAttributes model module.
   * @module model/AddressAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>AddressAttributes</code>.
   * @alias module:model/AddressAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>AddressAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressAttributes} obj Optional instance to populate.
   * @return {module:model/AddressAttributes} The populated <code>AddressAttributes</code> instance.
   */
