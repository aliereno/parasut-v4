...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeArchivesDataRelationships', 'model/ESmmAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeArchivesDataRelationships'), require('./ESmmAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ESmm = factory(root.parasut.ApiClient, root.parasut.CompanyIdeArchivesDataRelationships, root.parasut.ESmmAttributes);
  }
}(this, function(ApiClient, CompanyIdeArchivesDataRelationships, ESmmAttributes) {
  'use strict';

  /**
   * The ESmm model module.
   * @module model/ESmm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ESmm</code>.
   * @alias module:model/ESmm
   * @class
   * @param attributes {module:model/ESmmAttributes} 
   */
  ...
  /**
   * Constructs a <code>ESmm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ESmm} obj Optional instance to populate.
   * @return {module:model/ESmm} The populated <code>ESmm</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ESmmAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/ESmm.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ESmmAttributes} attributes
   */
