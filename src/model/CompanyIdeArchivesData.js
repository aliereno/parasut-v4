...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeArchivesDataRelationships', 'model/EArchiveFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeArchivesDataRelationships'), require('./EArchiveFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdeArchivesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdeArchivesDataRelationships, root.parasut.EArchiveFormAttributes);
  }
}(this, function(ApiClient, CompanyIdeArchivesDataRelationships, EArchiveFormAttributes) {
  'use strict';

  /**
   * The CompanyIdeArchivesData model module.
   * @module model/CompanyIdeArchivesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdeArchivesData</code>.
   * @alias module:model/CompanyIdeArchivesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdeArchivesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdeArchivesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdeArchivesData} The populated <code>CompanyIdeArchivesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EArchiveFormAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdeArchivesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdeArchivesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EArchiveFormAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdeArchivesDataRelationships} relationships
   */
