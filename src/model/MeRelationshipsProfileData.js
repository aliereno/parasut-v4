...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.MeRelationshipsProfileData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The MeRelationshipsProfileData model module.
   * @module model/MeRelationshipsProfileData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>MeRelationshipsProfileData</code>.
   * @alias module:model/MeRelationshipsProfileData
   * @class
   */
  ...
  /**
   * Constructs a <code>MeRelationshipsProfileData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MeRelationshipsProfileData} obj Optional instance to populate.
   * @return {module:model/MeRelationshipsProfileData} The populated <code>MeRelationshipsProfileData</code> instance.
   */
   ...
   * @member {module:model/MeRelationshipsProfileData.TypeEnum} type
   */
