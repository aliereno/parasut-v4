...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeArchivesDataRelationships', 'model/SalesOfferAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeArchivesDataRelationships'), require('./SalesOfferAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.SalesOffer = factory(root.parasut.ApiClient, root.parasut.CompanyIdeArchivesDataRelationships, root.parasut.SalesOfferAttributes);
  }
}(this, function(ApiClient, CompanyIdeArchivesDataRelationships, SalesOfferAttributes) {
  'use strict';

  /**
   * The SalesOffer model module.
   * @module model/SalesOffer
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesOffer</code>.
   * @alias module:model/SalesOffer
   * @class
   * @param attributes {module:model/SalesOfferAttributes} 
   */
  ...
  /**
   * Constructs a <code>SalesOffer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesOffer} obj Optional instance to populate.
   * @return {module:model/SalesOffer} The populated <code>SalesOffer</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SalesOfferAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/SalesOffer.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/SalesOfferAttributes} attributes
   */
