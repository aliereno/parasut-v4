...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyAttributes', 'model/CompanyRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyAttributes'), require('./CompanyRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Company = factory(root.parasut.ApiClient, root.parasut.CompanyAttributes, root.parasut.CompanyRelationships);
  }
}(this, function(ApiClient, CompanyAttributes, CompanyRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/CompanyAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = CompanyAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/Company.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/CompanyAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyRelationships} relationships
   */
