...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillDetailAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillDetailAttributes model module.
   * @module model/PurchaseBillDetailAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillDetailAttributes</code>.
   * @alias module:model/PurchaseBillDetailAttributes
   * @class
  ...
  /**
   * Constructs a <code>PurchaseBillDetailAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillDetailAttributes} obj Optional instance to populate.
   * @return {module:model/PurchaseBillDetailAttributes} The populated <code>PurchaseBillDetailAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/PurchaseBillDetailAttributes.DiscountTypeEnum} discountType
   */
  ...
  /**
   * @member {module:model/PurchaseBillDetailAttributes.ExciseDutyTypeEnum} exciseDutyType
   */
