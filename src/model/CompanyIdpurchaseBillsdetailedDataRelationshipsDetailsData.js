...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships', 'model/PurchaseBillDetailAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships'), require('./PurchaseBillDetailAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, root.parasut.PurchaseBillDetailAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, PurchaseBillDetailAttributes) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData model module.
   * @module model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData</code>.
   * @alias module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData} The populated <code>CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PurchaseBillDetailAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/PurchaseBillDetailAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships} relationships
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "purchase_bill_details"
     * @const
     */
    purchaseBillDetails: "purchase_bill_details"
  };
