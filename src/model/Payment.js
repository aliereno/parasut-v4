...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentAttributes', 'model/PaymentRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentAttributes'), require('./PaymentRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Payment = factory(root.parasut.ApiClient, root.parasut.PaymentAttributes, root.parasut.PaymentRelationships);
  }
}(this, function(ApiClient, PaymentAttributes, PaymentRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/PaymentAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PaymentAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = PaymentRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PaymentAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/PaymentRelationships} relationships
   */
