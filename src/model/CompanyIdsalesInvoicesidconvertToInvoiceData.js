...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdsalesInvoicesDataRelationships', 'model/SalesInvoiceAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdsalesInvoicesDataRelationships'), require('./SalesInvoiceAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdsalesInvoicesidconvertToInvoiceData = factory(root.parasut.ApiClient, root.parasut.CompanyIdsalesInvoicesDataRelationships, root.parasut.SalesInvoiceAttributes);
  }
}(this, function(ApiClient, CompanyIdsalesInvoicesDataRelationships, SalesInvoiceAttributes) {
  'use strict';

  /**
   * The CompanyIdsalesInvoicesidconvertToInvoiceData model module.
   * @module model/CompanyIdsalesInvoicesidconvertToInvoiceData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalesInvoicesidconvertToInvoiceData</code>.
   * @alias module:model/CompanyIdsalesInvoicesidconvertToInvoiceData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalesInvoicesidconvertToInvoiceData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalesInvoicesidconvertToInvoiceData} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalesInvoicesidconvertToInvoiceData} The populated <code>CompanyIdsalesInvoicesidconvertToInvoiceData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SalesInvoiceAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdsalesInvoicesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdsalesInvoicesidconvertToInvoiceData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/SalesInvoiceAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdsalesInvoicesDataRelationships} relationships
   */
