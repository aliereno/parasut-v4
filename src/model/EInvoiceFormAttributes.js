...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EDocumentCommonFormAttributes', 'model/EDocumentCommonFormAttributesExciseDutyCodes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EDocumentCommonFormAttributes'), require('./EDocumentCommonFormAttributesExciseDutyCodes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EInvoiceFormAttributes = factory(root.parasut.ApiClient, root.parasut.EDocumentCommonFormAttributes, root.parasut.EDocumentCommonFormAttributesExciseDutyCodes);
  }
}(this, function(ApiClient, EDocumentCommonFormAttributes, EDocumentCommonFormAttributesExciseDutyCodes) {
  'use strict';

  /**
   * The EInvoiceFormAttributes model module.
   * @module model/EInvoiceFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoiceFormAttributes</code>.
   * @alias module:model/EInvoiceFormAttributes
   * @class
   * @extends module:model/EDocumentCommonFormAttributes
   */
  var exports = function() {
    EDocumentCommonFormAttributes.call(this);
  };

  /**
   * Constructs a <code>EInvoiceFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoiceFormAttributes} obj Optional instance to populate.
   * @return {module:model/EInvoiceFormAttributes} The populated <code>EInvoiceFormAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      EDocumentCommonFormAttributes.constructFromObject(data, obj);
  ...
  exports.prototype = Object.create(EDocumentCommonFormAttributes.prototype);
  exports.prototype.constructor = exports;
  /**
   * Gönderim senaryosu
   * @member {module:model/EInvoiceFormAttributes.ScenarioEnum} scenario
   */
