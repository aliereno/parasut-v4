...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.InlineResponse2013Included = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2013Included model module.
   * @module model/InlineResponse2013Included
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2013Included</code>.
   * @alias module:model/InlineResponse2013Included
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2013Included</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2013Included} obj Optional instance to populate.
   * @return {module:model/InlineResponse2013Included} The populated <code>InlineResponse2013Included</code> instance.
   */
   ...
   * @member {module:model/InlineResponse2013Included.TypeEnum} type
   */
