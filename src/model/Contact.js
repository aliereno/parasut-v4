...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactAttributes', 'model/ContactRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContactAttributes'), require('./ContactRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Contact = factory(root.parasut.ApiClient, root.parasut.ContactAttributes, root.parasut.ContactRelationships);
  }
}(this, function(ApiClient, ContactAttributes, ContactRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/ContactAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('relationships'))
        obj.relationships = ContactRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ContactRelationships} relationships
   */
