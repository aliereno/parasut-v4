...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PaymentAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PaymentAttributes model module.
   * @module model/PaymentAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PaymentAttributes</code>.
   * @alias module:model/PaymentAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentAttributes} obj Optional instance to populate.
   * @return {module:model/PaymentAttributes} The populated <code>PaymentAttributes</code> instance.
   */
