...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.BankFeeAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BankFeeAttributes model module.
   * @module model/BankFeeAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>BankFeeAttributes</code>.
   * @alias module:model/BankFeeAttributes
   * @class
   * @param description {String} 
   * @param currency {module:model/BankFeeAttributes.CurrencyEnum} 
   * @param issueDate {Date} 
   * @param dueDate {Date} 
   * @param netTotal {Number} 
   */
  var exports = function(description, currency, issueDate, dueDate, netTotal) {
  ...
  /**
   * Constructs a <code>BankFeeAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BankFeeAttributes} obj Optional instance to populate.
   * @return {module:model/BankFeeAttributes} The populated <code>BankFeeAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/BankFeeAttributes.CurrencyEnum} currency
   */
