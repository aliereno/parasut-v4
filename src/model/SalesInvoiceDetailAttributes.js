...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceDetailAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalesInvoiceDetailAttributes model module.
   * @module model/SalesInvoiceDetailAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceDetailAttributes</code>.
   * @alias module:model/SalesInvoiceDetailAttributes
   * @class
   * @param quantity {Number} Miktar
   * @param unitPrice {Number} Birim fiyatı
   * @param vatRate {Number} KDV oranı
   */
  var exports = function(quantity, unitPrice, vatRate) {
  ...
  /**
   * Constructs a <code>SalesInvoiceDetailAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceDetailAttributes} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceDetailAttributes} The populated <code>SalesInvoiceDetailAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('discount_type'))
        obj.discountType = ApiClient.convertToType(data['discount_type'], 'String');
      if (data.hasOwnProperty('discount_value'))
        obj.discountValue = ApiClient.convertToType(data['discount_value'], 'Number');
      if (data.hasOwnProperty('excise_duty_type'))
        obj.exciseDutyType = ApiClient.convertToType(data['excise_duty_type'], 'String');
      if (data.hasOwnProperty('excise_duty_value'))
        obj.exciseDutyValue = ApiClient.convertToType(data['excise_duty_value'], 'Number');
      ...
      if (data.hasOwnProperty('delivery_method'))
        obj.deliveryMethod = ApiClient.convertToType(data['delivery_method'], 'String');
  ...
  /**
   * İndirim türü
   * @member {module:model/SalesInvoiceDetailAttributes.DiscountTypeEnum} discountType
   */
  ...
  /**
   * ÖTV tipi
   * @member {module:model/SalesInvoiceDetailAttributes.ExciseDutyTypeEnum} exciseDutyType
   */
  exports.prototype.exciseDutyType = undefined;

  /**
   * @member {Number} exciseDutyValue
   */
  exports.prototype.exciseDutyValue = undefined;
  ...
  /**
   * Teslim Şartı
   * @member {module:model/SalesInvoiceDetailAttributes.DeliveryMethodEnum} deliveryMethod
   */
  exports.prototype.deliveryMethod = undefined;

  /**
   * Gönderim Şekli
   * @member {module:model/SalesInvoiceDetailAttributes.ShippingMethodEnum} shippingMethod
   */
  ...
  /**
   * Allowed values for the <code>exciseDutyType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.ExciseDutyTypeEnum = {
    /**
     * value: "percentage"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>shippingMethod</code> property.
   * @enum {String}
   * @readonly
   */
  exports.ShippingMethodEnum = {
    ...
    /**
     * value: "Sabit taşıma tesisleri"
     * @const
     */
    sabitTamaTesisleri: "Sabit taşıma tesisleri",

    /**
     * value: "İç su taşımacılığı"
     * @const
     */
    suTamacl: "İç su taşımacılığı"
  };
