...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillDetail = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, root.parasut.PurchaseBillDetailAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, PurchaseBillDetailAttributes) {
  'use strict';

  /**
   * The PurchaseBillDetail model module.
   * @module model/PurchaseBillDetail
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillDetail</code>.
   * @alias module:model/PurchaseBillDetail
   * @class
   * @param attributes {module:model/PurchaseBillDetailAttributes} 
   */
  ...
  /**
   * Constructs a <code>PurchaseBillDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillDetail} obj Optional instance to populate.
   * @return {module:model/PurchaseBillDetail} The populated <code>PurchaseBillDetail</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillDetail.TypeEnum} type
   */
