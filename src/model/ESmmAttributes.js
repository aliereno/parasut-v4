...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ESmmAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ESmmAttributes model module.
   * @module model/ESmmAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ESmmAttributes</code>.
   * @alias module:model/ESmmAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>ESmmAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ESmmAttributes} obj Optional instance to populate.
   * @return {module:model/ESmmAttributes} The populated <code>ESmmAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('invoice_number'))
        obj.invoiceNumber = ApiClient.convertToType(data['invoice_number'], 'Number');
      ...
      if (data.hasOwnProperty('pdf_url'))
        obj.pdfUrl = ApiClient.convertToType(data['pdf_url'], 'String');
    }
    return obj;
  }
