...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactCollectionForm = factory(root.parasut.ApiClient, root.parasut.ContactCollectionFormAttributes);
  }
}(this, function(ApiClient, ContactCollectionFormAttributes) {
  'use strict';

  /**
   * The ContactCollectionForm model module.
   * @module model/ContactCollectionForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactCollectionForm</code>.
   * @alias module:model/ContactCollectionForm
   * @class
   * @param attributes {module:model/ContactCollectionFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>ContactCollectionForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactCollectionForm} obj Optional instance to populate.
   * @return {module:model/ContactCollectionForm} The populated <code>ContactCollectionForm</code> instance.
   */
   ...
   * @member {module:model/ContactCollectionForm.TypeEnum} type
   */
