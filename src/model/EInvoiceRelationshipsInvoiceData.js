...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EInvoiceRelationshipsInvoiceData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EInvoiceRelationshipsInvoiceData model module.
   * @module model/EInvoiceRelationshipsInvoiceData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoiceRelationshipsInvoiceData</code>.
   * @alias module:model/EInvoiceRelationshipsInvoiceData
   * @class
   */
  ...
  /**
   * Constructs a <code>EInvoiceRelationshipsInvoiceData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoiceRelationshipsInvoiceData} obj Optional instance to populate.
   * @return {module:model/EInvoiceRelationshipsInvoiceData} The populated <code>EInvoiceRelationshipsInvoiceData</code> instance.
   */
   ...
   * @member {module:model/EInvoiceRelationshipsInvoiceData.TypeEnum} type
   */
