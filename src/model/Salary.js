...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.Salary = factory(root.parasut.ApiClient, root.parasut.CompanyIdsalariesDataRelationships, root.parasut.SalaryAttributes);
  }
}(this, function(ApiClient, CompanyIdsalariesDataRelationships, SalaryAttributes) {
  'use strict';

  /**
   * The Salary model module.
   * @module model/Salary
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>Salary</code>.
   * @alias module:model/Salary
   * @class
   * @param attributes {module:model/SalaryAttributes} 
   */
  ...
  /**
   * Constructs a <code>Salary</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Salary} obj Optional instance to populate.
   * @return {module:model/Salary} The populated <code>Salary</code> instance.
   */
   ...
   * @member {module:model/Salary.TypeEnum} type
   */
