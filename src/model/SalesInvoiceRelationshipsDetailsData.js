...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceRelationshipsDetailsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalesInvoiceRelationshipsDetailsData model module.
   * @module model/SalesInvoiceRelationshipsDetailsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceRelationshipsDetailsData</code>.
   * @alias module:model/SalesInvoiceRelationshipsDetailsData
   * @class
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceRelationshipsDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceRelationshipsDetailsData} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceRelationshipsDetailsData} The populated <code>SalesInvoiceRelationshipsDetailsData</code> instance.
   */
   ...
   * @member {module:model/SalesInvoiceRelationshipsDetailsData.TypeEnum} type
   */
