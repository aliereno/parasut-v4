...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BankFeeAttributes', 'model/CompanyIdbankFeesDataRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BankFeeAttributes'), require('./CompanyIdbankFeesDataRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdbankFeesData = factory(root.parasut.ApiClient, root.parasut.BankFeeAttributes, root.parasut.CompanyIdbankFeesDataRelationships);
  }
}(this, function(ApiClient, BankFeeAttributes, CompanyIdbankFeesDataRelationships) {
  'use strict';

  /**
   * The CompanyIdbankFeesData model module.
   * @module model/CompanyIdbankFeesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdbankFeesData</code>.
   * @alias module:model/CompanyIdbankFeesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdbankFeesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdbankFeesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdbankFeesData} The populated <code>CompanyIdbankFeesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = BankFeeAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdbankFeesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdbankFeesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/BankFeeAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdbankFeesDataRelationships} relationships
   */
