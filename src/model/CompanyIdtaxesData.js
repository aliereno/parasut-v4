...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdbankFeesDataRelationships', 'model/TaxAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdbankFeesDataRelationships'), require('./TaxAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdtaxesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdbankFeesDataRelationships, root.parasut.TaxAttributes);
  }
}(this, function(ApiClient, CompanyIdbankFeesDataRelationships, TaxAttributes) {
  'use strict';

  /**
   * The CompanyIdtaxesData model module.
   * @module model/CompanyIdtaxesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdtaxesData</code>.
   * @alias module:model/CompanyIdtaxesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdtaxesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdtaxesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdtaxesData} The populated <code>CompanyIdtaxesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = TaxAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/CompanyIdtaxesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/TaxAttributes} attributes
   */
