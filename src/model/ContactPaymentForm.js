...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactPaymentForm = factory(root.parasut.ApiClient, root.parasut.ContactPaymentFormAttributes);
  }
}(this, function(ApiClient, ContactPaymentFormAttributes) {
  'use strict';

  /**
   * The ContactPaymentForm model module.
   * @module model/ContactPaymentForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactPaymentForm</code>.
   * @alias module:model/ContactPaymentForm
   * @class
   * @param attributes {module:model/ContactPaymentFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>ContactPaymentForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactPaymentForm} obj Optional instance to populate.
   * @return {module:model/ContactPaymentForm} The populated <code>ContactPaymentForm</code> instance.
   */
   ...
   * @member {module:model/ContactPaymentForm.TypeEnum} type
   */
