...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdshipmentDocumentsDataRelationshipsContactData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdshipmentDocumentsDataRelationshipsContactData model module.
   * @module model/CompanyIdshipmentDocumentsDataRelationshipsContactData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdshipmentDocumentsDataRelationshipsContactData</code>.
   * @alias module:model/CompanyIdshipmentDocumentsDataRelationshipsContactData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdshipmentDocumentsDataRelationshipsContactData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdshipmentDocumentsDataRelationshipsContactData} obj Optional instance to populate.
   * @return {module:model/CompanyIdshipmentDocumentsDataRelationshipsContactData} The populated <code>CompanyIdshipmentDocumentsDataRelationshipsContactData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdshipmentDocumentsDataRelationshipsContactData.TypeEnum} type
   */
