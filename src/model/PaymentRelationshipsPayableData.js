...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PaymentRelationshipsPayableData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PaymentRelationshipsPayableData model module.
   * @module model/PaymentRelationshipsPayableData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PaymentRelationshipsPayableData</code>.
   * @alias module:model/PaymentRelationshipsPayableData
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentRelationshipsPayableData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentRelationshipsPayableData} obj Optional instance to populate.
   * @return {module:model/PaymentRelationshipsPayableData} The populated <code>PaymentRelationshipsPayableData</code> instance.
   */
   ...
   * @member {module:model/PaymentRelationshipsPayableData.TypeEnum} type
   */
