...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships', 'model/StockMovementAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships'), require('./StockMovementAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, root.parasut.StockMovementAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, StockMovementAttributes) {
  'use strict';

  /**
   * The CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData model module.
   * @module model/CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData</code>.
   * @alias module:model/CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData} The populated <code>CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = StockMovementAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/CompanyIdshipmentDocumentsDataRelationshipsStockMovementsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/StockMovementAttributes} attributes
   */
