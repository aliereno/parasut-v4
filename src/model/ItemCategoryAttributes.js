...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ItemCategoryAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ItemCategoryAttributes model module.
   * @module model/ItemCategoryAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ItemCategoryAttributes</code>.
   * @alias module:model/ItemCategoryAttributes
   * @class
   * @param name {String} Kategori adı
   * @param categoryType {module:model/ItemCategoryAttributes.CategoryTypeEnum} Kategori tipi
   */
  var exports = function(name, categoryType) {
    this.name = name;
    this.categoryType = categoryType;
  };

  /**
   * Constructs a <code>ItemCategoryAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ItemCategoryAttributes} obj Optional instance to populate.
   * @return {module:model/ItemCategoryAttributes} The populated <code>ItemCategoryAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('full_path'))
        obj.fullPath = ApiClient.convertToType(data['full_path'], 'String');
      ...
      if (data.hasOwnProperty('bg_color'))
        obj.bgColor = ApiClient.convertToType(data['bg_color'], 'String');
      ...
      if (data.hasOwnProperty('category_type'))
        obj.categoryType = ApiClient.convertToType(data['category_type'], 'String');
  ...
  /**
   * Kategori tipi
   * @member {module:model/ItemCategoryAttributes.CategoryTypeEnum} categoryType
   */
  exports.prototype.categoryType = undefined;
