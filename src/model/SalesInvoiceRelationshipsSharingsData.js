...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceRelationshipsSharingsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalesInvoiceRelationshipsSharingsData model module.
   * @module model/SalesInvoiceRelationshipsSharingsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceRelationshipsSharingsData</code>.
   * @alias module:model/SalesInvoiceRelationshipsSharingsData
   * @class
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceRelationshipsSharingsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceRelationshipsSharingsData} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceRelationshipsSharingsData} The populated <code>SalesInvoiceRelationshipsSharingsData</code> instance.
   */
   ...
   * @member {module:model/SalesInvoiceRelationshipsSharingsData.TypeEnum} type
   */
