...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PaymentFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PaymentFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdbankFeesidpaymentsData = factory(root.parasut.ApiClient, root.parasut.PaymentFormAttributes);
  }
}(this, function(ApiClient, PaymentFormAttributes) {
  'use strict';

  /**
   * The CompanyIdbankFeesidpaymentsData model module.
   * @module model/CompanyIdbankFeesidpaymentsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdbankFeesidpaymentsData</code>.
   * @alias module:model/CompanyIdbankFeesidpaymentsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdbankFeesidpaymentsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdbankFeesidpaymentsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdbankFeesidpaymentsData} The populated <code>CompanyIdbankFeesidpaymentsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PaymentFormAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdbankFeesidpaymentsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/PaymentFormAttributes} attributes
   */
