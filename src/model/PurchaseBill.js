...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PurchaseBillAttributes', 'model/PurchaseBillRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PurchaseBillAttributes'), require('./PurchaseBillRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.PurchaseBill = factory(root.parasut.ApiClient, root.parasut.PurchaseBillAttributes, root.parasut.PurchaseBillRelationships);
  }
}(this, function(ApiClient, PurchaseBillAttributes, PurchaseBillRelationships) {
  'use strict';

  /**
   * The PurchaseBill model module.
   * @module model/PurchaseBill
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBill</code>.
   * @alias module:model/PurchaseBill
   * @class
   * @param attributes {module:model/PurchaseBillAttributes} 
   */
  ...
  /**
   * Constructs a <code>PurchaseBill</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBill} obj Optional instance to populate.
   * @return {module:model/PurchaseBill} The populated <code>PurchaseBill</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PurchaseBillAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = PurchaseBillRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/PurchaseBill.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/PurchaseBillAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/PurchaseBillRelationships} relationships
   */
