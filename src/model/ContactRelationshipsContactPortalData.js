...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactRelationshipsContactPortalData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContactRelationshipsContactPortalData model module.
   * @module model/ContactRelationshipsContactPortalData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactRelationshipsContactPortalData</code>.
   * @alias module:model/ContactRelationshipsContactPortalData
   * @class
   */
  ...
  /**
   * Constructs a <code>ContactRelationshipsContactPortalData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactRelationshipsContactPortalData} obj Optional instance to populate.
   * @return {module:model/ContactRelationshipsContactPortalData} The populated <code>ContactRelationshipsContactPortalData</code> instance.
   */
   ...
   * @member {module:model/ContactRelationshipsContactPortalData.TypeEnum} type
   */
