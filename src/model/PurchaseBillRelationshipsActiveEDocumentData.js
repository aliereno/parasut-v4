...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillRelationshipsActiveEDocumentData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillRelationshipsActiveEDocumentData model module.
   * @module model/PurchaseBillRelationshipsActiveEDocumentData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationshipsActiveEDocumentData</code>.
   * @alias module:model/PurchaseBillRelationshipsActiveEDocumentData
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationshipsActiveEDocumentData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationshipsActiveEDocumentData} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationshipsActiveEDocumentData} The populated <code>PurchaseBillRelationshipsActiveEDocumentData</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillRelationshipsActiveEDocumentData.TypeEnum} type
   */
