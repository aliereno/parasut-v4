...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillRelationshipsRecurrencePlanData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillRelationshipsRecurrencePlanData model module.
   * @module model/PurchaseBillRelationshipsRecurrencePlanData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationshipsRecurrencePlanData</code>.
   * @alias module:model/PurchaseBillRelationshipsRecurrencePlanData
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationshipsRecurrencePlanData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationshipsRecurrencePlanData} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationshipsRecurrencePlanData} The populated <code>PurchaseBillRelationshipsRecurrencePlanData</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillRelationshipsRecurrencePlanData.TypeEnum} type
   */
