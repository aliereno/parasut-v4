...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EInvoiceInboxAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EInvoiceInboxAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EInvoiceInbox = factory(root.parasut.ApiClient, root.parasut.EInvoiceInboxAttributes);
  }
}(this, function(ApiClient, EInvoiceInboxAttributes) {
  'use strict';

  /**
   * The EInvoiceInbox model module.
   * @module model/EInvoiceInbox
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoiceInbox</code>.
   * @alias module:model/EInvoiceInbox
   * @class
   * @param attributes {module:model/EInvoiceInboxAttributes} 
   */
  ...
  /**
   * Constructs a <code>EInvoiceInbox</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoiceInbox} obj Optional instance to populate.
   * @return {module:model/EInvoiceInbox} The populated <code>EInvoiceInbox</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EInvoiceInboxAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/EInvoiceInbox.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EInvoiceInboxAttributes} attributes
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "e_invoice_inboxes"
     * @const
     */
    eInvoiceInboxes: "e_invoice_inboxes"
  };
