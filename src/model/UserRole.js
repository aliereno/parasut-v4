...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserRoleAttributes', 'model/UserRoleRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserRoleAttributes'), require('./UserRoleRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.UserRole = factory(root.parasut.ApiClient, root.parasut.UserRoleAttributes, root.parasut.UserRoleRelationships);
  }
}(this, function(ApiClient, UserRoleAttributes, UserRoleRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/UserRoleAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = UserRoleAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = UserRoleRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/UserRole.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/UserRoleAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/UserRoleRelationships} relationships
   */
