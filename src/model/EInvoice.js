...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EInvoiceAttributes', 'model/EInvoiceRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EInvoiceAttributes'), require('./EInvoiceRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EInvoice = factory(root.parasut.ApiClient, root.parasut.EInvoiceAttributes, root.parasut.EInvoiceRelationships);
  }
}(this, function(ApiClient, EInvoiceAttributes, EInvoiceRelationships) {
  'use strict';

  /**
   * The EInvoice model module.
   * @module model/EInvoice
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoice</code>.
   * @alias module:model/EInvoice
   * @class
   * @param attributes {module:model/EInvoiceAttributes} 
   */
  ...
  /**
   * Constructs a <code>EInvoice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoice} obj Optional instance to populate.
   * @return {module:model/EInvoice} The populated <code>EInvoice</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EInvoiceAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = EInvoiceRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/EInvoice.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EInvoiceAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/EInvoiceRelationships} relationships
   */
