...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactCollectionFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContactCollectionFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdcontactsidcontactDebitTransactionsData = factory(root.parasut.ApiClient, root.parasut.ContactCollectionFormAttributes);
  }
}(this, function(ApiClient, ContactCollectionFormAttributes) {
  'use strict';

  /**
   * The CompanyIdcontactsidcontactDebitTransactionsData model module.
   * @module model/CompanyIdcontactsidcontactDebitTransactionsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdcontactsidcontactDebitTransactionsData</code>.
   * @alias module:model/CompanyIdcontactsidcontactDebitTransactionsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdcontactsidcontactDebitTransactionsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdcontactsidcontactDebitTransactionsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdcontactsidcontactDebitTransactionsData} The populated <code>CompanyIdcontactsidcontactDebitTransactionsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ContactCollectionFormAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdcontactsidcontactDebitTransactionsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ContactCollectionFormAttributes} attributes
   */
