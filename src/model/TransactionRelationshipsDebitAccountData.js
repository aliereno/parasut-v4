...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.TransactionRelationshipsDebitAccountData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TransactionRelationshipsDebitAccountData model module.
   * @module model/TransactionRelationshipsDebitAccountData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TransactionRelationshipsDebitAccountData</code>.
   * @alias module:model/TransactionRelationshipsDebitAccountData
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionRelationshipsDebitAccountData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionRelationshipsDebitAccountData} obj Optional instance to populate.
   * @return {module:model/TransactionRelationshipsDebitAccountData} The populated <code>TransactionRelationshipsDebitAccountData</code> instance.
   */
   ...
   * @member {module:model/TransactionRelationshipsDebitAccountData.TypeEnum} type
   */
