...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdpurchaseBillsdetailedDataRelationships', 'model/PurchaseBillDetailedFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdpurchaseBillsdetailedDataRelationships'), require('./PurchaseBillDetailedFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdpurchaseBillsdetailedData = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationships, root.parasut.PurchaseBillDetailedFormAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationships, PurchaseBillDetailedFormAttributes) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsdetailedData model module.
   * @module model/CompanyIdpurchaseBillsdetailedData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsdetailedData</code>.
   * @alias module:model/CompanyIdpurchaseBillsdetailedData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsdetailedData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsdetailedData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsdetailedData} The populated <code>CompanyIdpurchaseBillsdetailedData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = PurchaseBillDetailedFormAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdpurchaseBillsdetailedDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdpurchaseBillsdetailedData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/PurchaseBillDetailedFormAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdpurchaseBillsdetailedDataRelationships} relationships
   */
