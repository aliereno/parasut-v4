...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillRelationshipsPaymentsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillRelationshipsPaymentsData model module.
   * @module model/PurchaseBillRelationshipsPaymentsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationshipsPaymentsData</code>.
   * @alias module:model/PurchaseBillRelationshipsPaymentsData
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationshipsPaymentsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationshipsPaymentsData} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationshipsPaymentsData} The populated <code>PurchaseBillRelationshipsPaymentsData</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillRelationshipsPaymentsData.TypeEnum} type
   */
