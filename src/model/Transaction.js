...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TransactionAttributes', 'model/TransactionRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransactionAttributes'), require('./TransactionRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Transaction = factory(root.parasut.ApiClient, root.parasut.TransactionAttributes, root.parasut.TransactionRelationships);
  }
}(this, function(ApiClient, TransactionAttributes, TransactionRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/TransactionAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = TransactionAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = TransactionRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/TransactionAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/TransactionRelationships} relationships
   */
