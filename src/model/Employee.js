...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EmployeeAttributes', 'model/EmployeeRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EmployeeAttributes'), require('./EmployeeRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Employee = factory(root.parasut.ApiClient, root.parasut.EmployeeAttributes, root.parasut.EmployeeRelationships);
  }
}(this, function(ApiClient, EmployeeAttributes, EmployeeRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/EmployeeAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('relationships'))
        obj.relationships = EmployeeRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/Employee.TypeEnum} type
   */
  ...
  /**
   * @member {module:model/EmployeeRelationships} relationships
   */
