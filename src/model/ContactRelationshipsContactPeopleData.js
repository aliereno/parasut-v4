...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactRelationshipsContactPeopleData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContactRelationshipsContactPeopleData model module.
   * @module model/ContactRelationshipsContactPeopleData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactRelationshipsContactPeopleData</code>.
   * @alias module:model/ContactRelationshipsContactPeopleData
   * @class
   */
  ...
  /**
   * Constructs a <code>ContactRelationshipsContactPeopleData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactRelationshipsContactPeopleData} obj Optional instance to populate.
   * @return {module:model/ContactRelationshipsContactPeopleData} The populated <code>ContactRelationshipsContactPeopleData</code> instance.
   */
   ...
   * @member {module:model/ContactRelationshipsContactPeopleData.TypeEnum} type
   */
