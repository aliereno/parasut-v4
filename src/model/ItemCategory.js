...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ItemCategoryAttributes', 'model/ItemCategoryRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ItemCategoryAttributes'), require('./ItemCategoryRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ItemCategory = factory(root.parasut.ApiClient, root.parasut.ItemCategoryAttributes, root.parasut.ItemCategoryRelationships);
  }
}(this, function(ApiClient, ItemCategoryAttributes, ItemCategoryRelationships) {
  'use strict';
  ...
  /**
   * Constructs a new <code>ItemCategory</code>.
   * @alias module:model/ItemCategory
   * @class
   * @param attributes {module:model/ItemCategoryAttributes} 
   */
  ...
  /**
   * Constructs a <code>ItemCategory</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ItemCategory} obj Optional instance to populate.
   * @return {module:model/ItemCategory} The populated <code>ItemCategory</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ItemCategoryAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = ItemCategoryRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/ItemCategory.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ItemCategoryAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/ItemCategoryRelationships} relationships
   */
