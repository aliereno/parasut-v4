...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyRelationshipsOwnerData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyRelationshipsOwnerData model module.
   * @module model/CompanyRelationshipsOwnerData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyRelationshipsOwnerData</code>.
   * @alias module:model/CompanyRelationshipsOwnerData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyRelationshipsOwnerData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyRelationshipsOwnerData} obj Optional instance to populate.
   * @return {module:model/CompanyRelationshipsOwnerData} The populated <code>CompanyRelationshipsOwnerData</code> instance.
   */
   ...
   * @member {module:model/CompanyRelationshipsOwnerData.TypeEnum} type
   */
