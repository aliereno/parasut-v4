...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdeArchivesDataRelationshipsSalesInvoiceData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdeArchivesDataRelationshipsSalesInvoiceData model module.
   * @module model/CompanyIdeArchivesDataRelationshipsSalesInvoiceData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdeArchivesDataRelationshipsSalesInvoiceData</code>.
   * @alias module:model/CompanyIdeArchivesDataRelationshipsSalesInvoiceData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdeArchivesDataRelationshipsSalesInvoiceData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdeArchivesDataRelationshipsSalesInvoiceData} obj Optional instance to populate.
   * @return {module:model/CompanyIdeArchivesDataRelationshipsSalesInvoiceData} The populated <code>CompanyIdeArchivesDataRelationshipsSalesInvoiceData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdeArchivesDataRelationshipsSalesInvoiceData.TypeEnum} type
   */
