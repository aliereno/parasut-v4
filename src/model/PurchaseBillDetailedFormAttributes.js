...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillDetailedFormAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillDetailedFormAttributes model module.
   * @module model/PurchaseBillDetailedFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillDetailedFormAttributes</code>.
   * @alias module:model/PurchaseBillDetailedFormAttributes
   * @class
   * @param itemType {module:model/PurchaseBillDetailedFormAttributes.ItemTypeEnum} 
   * @param issueDate {Date} 
   * @param dueDate {Date} 
   * @param currency {module:model/PurchaseBillDetailedFormAttributes.CurrencyEnum} 
   */
  var exports = function(itemType, issueDate, dueDate, currency) {
  ...
  /**
   * Constructs a <code>PurchaseBillDetailedFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillDetailedFormAttributes} obj Optional instance to populate.
   * @return {module:model/PurchaseBillDetailedFormAttributes} The populated <code>PurchaseBillDetailedFormAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/PurchaseBillDetailedFormAttributes.ItemTypeEnum} itemType
   */
  ...
  /**
   * @member {module:model/PurchaseBillDetailedFormAttributes.CurrencyEnum} currency
   */
  ...
  /**
   * @member {module:model/PurchaseBillDetailedFormAttributes.InvoiceDiscountTypeEnum} invoiceDiscountType
   */
