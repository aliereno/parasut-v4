...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactPaymentFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContactPaymentFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdcontactsidcontactCreditTransactionsData = factory(root.parasut.ApiClient, root.parasut.ContactPaymentFormAttributes);
  }
}(this, function(ApiClient, ContactPaymentFormAttributes) {
  'use strict';

  /**
   * The CompanyIdcontactsidcontactCreditTransactionsData model module.
   * @module model/CompanyIdcontactsidcontactCreditTransactionsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdcontactsidcontactCreditTransactionsData</code>.
   * @alias module:model/CompanyIdcontactsidcontactCreditTransactionsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdcontactsidcontactCreditTransactionsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdcontactsidcontactCreditTransactionsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdcontactsidcontactCreditTransactionsData} The populated <code>CompanyIdcontactsidcontactCreditTransactionsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ContactPaymentFormAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdcontactsidcontactCreditTransactionsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ContactPaymentFormAttributes} attributes
   */
