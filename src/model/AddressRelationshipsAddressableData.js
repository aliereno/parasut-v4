...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.AddressRelationshipsAddressableData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddressRelationshipsAddressableData model module.
   * @module model/AddressRelationshipsAddressableData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>AddressRelationshipsAddressableData</code>.
   * @alias module:model/AddressRelationshipsAddressableData
   * @class
   */
  ...
  /**
   * Constructs a <code>AddressRelationshipsAddressableData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddressRelationshipsAddressableData} obj Optional instance to populate.
   * @return {module:model/AddressRelationshipsAddressableData} The populated <code>AddressRelationshipsAddressableData</code> instance.
   */
   ...
   * @member {module:model/AddressRelationshipsAddressableData.TypeEnum} type
   */
