...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.TrackableJobAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TrackableJobAttributes model module.
   * @module model/TrackableJobAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TrackableJobAttributes</code>.
   * @alias module:model/TrackableJobAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>TrackableJobAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TrackableJobAttributes} obj Optional instance to populate.
   * @return {module:model/TrackableJobAttributes} The populated <code>TrackableJobAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/TrackableJobAttributes.StatusEnum} status
   */
