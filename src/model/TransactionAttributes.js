...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.TransactionAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TransactionAttributes model module.
   * @module model/TransactionAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TransactionAttributes</code>.
   * @alias module:model/TransactionAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionAttributes} obj Optional instance to populate.
   * @return {module:model/TransactionAttributes} The populated <code>TransactionAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amount_in_trl'))
        obj.amountInTrl = ApiClient.convertToType(data['amount_in_trl'], 'Number');
      if (data.hasOwnProperty('debit_amount'))
        obj.debitAmount = ApiClient.convertToType(data['debit_amount'], 'Number');
      if (data.hasOwnProperty('debit_currency'))
        obj.debitCurrency = ApiClient.convertToType(data['debit_currency'], 'String');
      if (data.hasOwnProperty('credit_amount'))
        obj.creditAmount = ApiClient.convertToType(data['credit_amount'], 'Number');
      if (data.hasOwnProperty('credit_currency'))
        obj.creditCurrency = ApiClient.convertToType(data['credit_currency'], 'String');
    }
    return obj;
  }
   ...
   * @member {Number} amountInTrl
   */
  exports.prototype.amountInTrl = undefined;

  /**
   * Borç meblağ
   * @member {Number} debitAmount
   */
  exports.prototype.debitAmount = undefined;

  /**
   * Borç döviz cinsi
   * @member {module:model/TransactionAttributes.DebitCurrencyEnum} debitCurrency
   */
  exports.prototype.debitCurrency = undefined;
  ...
  /**
   * Alacak döviz cinsi
   * @member {module:model/TransactionAttributes.CreditCurrencyEnum} creditCurrency
   */
  exports.prototype.creditCurrency = undefined;



  /**
   * Allowed values for the <code>debitCurrency</code> property.
   * @enum {String}
   * @readonly
   */
  exports.DebitCurrencyEnum = {
    /**
     * value: "TRL"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>creditCurrency</code> property.
   * @enum {String}
   * @readonly
   */
  exports.CreditCurrencyEnum = {
    /**
     * value: "TRL"
     * @const
     */
