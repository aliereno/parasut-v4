...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ItemCategoryAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ItemCategoryAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIditemCategoriesData = factory(root.parasut.ApiClient, root.parasut.ItemCategoryAttributes);
  }
}(this, function(ApiClient, ItemCategoryAttributes) {
  'use strict';

  /**
   * The CompanyIditemCategoriesData model module.
   * @module model/CompanyIditemCategoriesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIditemCategoriesData</code>.
   * @alias module:model/CompanyIditemCategoriesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIditemCategoriesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIditemCategoriesData} obj Optional instance to populate.
   * @return {module:model/CompanyIditemCategoriesData} The populated <code>CompanyIditemCategoriesData</code> instance.
   */
   ...
   * @member {module:model/CompanyIditemCategoriesData.TypeEnum} type
   */
