...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EArchiveFormAttributesInternetSale = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EArchiveFormAttributesInternetSale model module.
   * @module model/EArchiveFormAttributesInternetSale
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EArchiveFormAttributesInternetSale</code>.
   * İnternet satışı bilgileri. İnternet üzerinden bir satış yapıyorsanız doldurmak zorunlu.
   * @alias module:model/EArchiveFormAttributesInternetSale
   * @class
   */
  ...
  /**
   * Constructs a <code>EArchiveFormAttributesInternetSale</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EArchiveFormAttributesInternetSale} obj Optional instance to populate.
   * @return {module:model/EArchiveFormAttributesInternetSale} The populated <code>EArchiveFormAttributesInternetSale</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payment_platform'))
        obj.paymentPlatform = ApiClient.convertToType(data['payment_platform'], 'String');
  ...
  /**
   * Ödeme tipi
   * @member {module:model/EArchiveFormAttributesInternetSale.PaymentTypeEnum} paymentType
   */
  exports.prototype.paymentType = undefined;

  /**
   * Ödeme platformu - *(iyzico, payu gibi)*
   * @member {String} paymentPlatform
   */
  exports.prototype.paymentPlatform = undefined;
  ...
  exports.PaymentTypeEnum = {
     ...
     * @const
     */
    KREDIKARTIBANKAKARTI: "KREDIKARTI/BANKAKARTI",
