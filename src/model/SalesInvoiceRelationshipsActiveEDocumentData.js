...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceRelationshipsActiveEDocumentData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalesInvoiceRelationshipsActiveEDocumentData model module.
   * @module model/SalesInvoiceRelationshipsActiveEDocumentData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceRelationshipsActiveEDocumentData</code>.
   * @alias module:model/SalesInvoiceRelationshipsActiveEDocumentData
   * @class
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceRelationshipsActiveEDocumentData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceRelationshipsActiveEDocumentData} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceRelationshipsActiveEDocumentData} The populated <code>SalesInvoiceRelationshipsActiveEDocumentData</code> instance.
   */
   ...
   * @member {module:model/SalesInvoiceRelationshipsActiveEDocumentData.TypeEnum} type
   */
