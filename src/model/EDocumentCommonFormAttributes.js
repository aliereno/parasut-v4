...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EDocumentCommonFormAttributesExciseDutyCodes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EDocumentCommonFormAttributesExciseDutyCodes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EDocumentCommonFormAttributes = factory(root.parasut.ApiClient, root.parasut.EDocumentCommonFormAttributesExciseDutyCodes);
  }
}(this, function(ApiClient, EDocumentCommonFormAttributesExciseDutyCodes) {
  'use strict';

  /**
   * The EDocumentCommonFormAttributes model module.
   * @module model/EDocumentCommonFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EDocumentCommonFormAttributes</code>.
   * @alias module:model/EDocumentCommonFormAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>EDocumentCommonFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EDocumentCommonFormAttributes} obj Optional instance to populate.
   * @return {module:model/EDocumentCommonFormAttributes} The populated <code>EDocumentCommonFormAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('vat_withholding_code'))
        obj.vatWithholdingCode = ApiClient.convertToType(data['vat_withholding_code'], 'String');
      if (data.hasOwnProperty('vat_exemption_reason_code'))
        obj.vatExemptionReasonCode = ApiClient.convertToType(data['vat_exemption_reason_code'], 'String');
      if (data.hasOwnProperty('vat_exemption_reason'))
        obj.vatExemptionReason = ApiClient.convertToType(data['vat_exemption_reason'], 'String');
      if (data.hasOwnProperty('note'))
        obj.note = ApiClient.convertToType(data['note'], 'String');
      if (data.hasOwnProperty('excise_duty_codes'))
        obj.exciseDutyCodes = ApiClient.convertToType(data['excise_duty_codes'], [EDocumentCommonFormAttributesExciseDutyCodes]);
    }
    return obj;
  }
   ...
   * @member {String} vatWithholdingCode
   */
  exports.prototype.vatWithholdingCode = undefined;
   ...
   * @member {String} vatExemptionReasonCode
   */
  exports.prototype.vatExemptionReasonCode = undefined;

  /**
   * Eğer KDV muafiyet sebebi kodu 250 veya 350 ise KDV muafiyet sebebi açıklaması.
   * @member {String} vatExemptionReason
   */
  exports.prototype.vatExemptionReason = undefined;
   ...
   * @member {Array.<module:model/EDocumentCommonFormAttributesExciseDutyCodes>} exciseDutyCodes
   */
  exports.prototype.exciseDutyCodes = undefined;
