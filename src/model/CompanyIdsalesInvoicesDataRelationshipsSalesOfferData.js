...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdsalesInvoicesDataRelationshipsSalesOfferData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdsalesInvoicesDataRelationshipsSalesOfferData model module.
   * @module model/CompanyIdsalesInvoicesDataRelationshipsSalesOfferData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalesInvoicesDataRelationshipsSalesOfferData</code>.
   * @alias module:model/CompanyIdsalesInvoicesDataRelationshipsSalesOfferData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalesInvoicesDataRelationshipsSalesOfferData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalesInvoicesDataRelationshipsSalesOfferData} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalesInvoicesDataRelationshipsSalesOfferData} The populated <code>CompanyIdsalesInvoicesDataRelationshipsSalesOfferData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdsalesInvoicesDataRelationshipsSalesOfferData.TypeEnum} type
   */
