...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactPersonAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContactPersonAttributes model module.
   * @module model/ContactPersonAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactPersonAttributes</code>.
   * @alias module:model/ContactPersonAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>ContactPersonAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactPersonAttributes} obj Optional instance to populate.
   * @return {module:model/ContactPersonAttributes} The populated <code>ContactPersonAttributes</code> instance.
   */
