...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData model module.
   * @module model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData</code>.
   * @alias module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData} The populated <code>CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplierData.TypeEnum} type
   */
