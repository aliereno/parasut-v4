...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TrackableJobAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TrackableJobAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.TrackableJob = factory(root.parasut.ApiClient, root.parasut.TrackableJobAttributes);
  }
}(this, function(ApiClient, TrackableJobAttributes) {
  'use strict';

  /**
   * The TrackableJob model module.
   * @module model/TrackableJob
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>TrackableJob</code>.
   * @alias module:model/TrackableJob
   * @class
   * @param attributes {module:model/TrackableJobAttributes} 
   */
  ...
  /**
   * Constructs a <code>TrackableJob</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TrackableJob} obj Optional instance to populate.
   * @return {module:model/TrackableJob} The populated <code>TrackableJob</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = TrackableJobAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/TrackableJob.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/TrackableJobAttributes} attributes
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "trackable_jobs"
     * @const
     */
    trackableJobs: "trackable_jobs"
  };
