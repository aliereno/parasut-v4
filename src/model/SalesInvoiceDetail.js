...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalesInvoiceDetail = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, root.parasut.SalesInvoiceDetailAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, SalesInvoiceDetailAttributes) {
  'use strict';

  /**
   * The SalesInvoiceDetail model module.
   * @module model/SalesInvoiceDetail
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceDetail</code>.
   * @alias module:model/SalesInvoiceDetail
   * @class
   * @param attributes {module:model/SalesInvoiceDetailAttributes} 
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceDetail} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceDetail} The populated <code>SalesInvoiceDetail</code> instance.
   */
   ...
   * @member {module:model/SalesInvoiceDetail.TypeEnum} type
   */
