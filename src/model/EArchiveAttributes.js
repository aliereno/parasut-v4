...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EArchiveAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EArchiveAttributes model module.
   * @module model/EArchiveAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EArchiveAttributes</code>.
   * @alias module:model/EArchiveAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>EArchiveAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EArchiveAttributes} obj Optional instance to populate.
   * @return {module:model/EArchiveAttributes} The populated <code>EArchiveAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('is_printed'))
        obj.isPrinted = ApiClient.convertToType(data['is_printed'], 'Boolean');
      if (data.hasOwnProperty('status'))
        obj.status = ApiClient.convertToType(data['status'], 'String');
      if (data.hasOwnProperty('printed_at'))
        obj.printedAt = ApiClient.convertToType(data['printed_at'], 'Date');
      if (data.hasOwnProperty('cancellable_until'))
        obj.cancellableUntil = ApiClient.convertToType(data['cancellable_until'], 'Date');
  ...
  /**
   * @member {Boolean} isPrinted
   */
  exports.prototype.isPrinted = undefined;

  /**
   * @member {module:model/EArchiveAttributes.StatusEnum} status
   */
  ...
  /**
   * @member {Date} cancellableUntil
   */
  exports.prototype.cancellableUntil = undefined;
