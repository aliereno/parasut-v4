...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillRelationshipsDetailsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillRelationshipsDetailsData model module.
   * @module model/PurchaseBillRelationshipsDetailsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationshipsDetailsData</code>.
   * @alias module:model/PurchaseBillRelationshipsDetailsData
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationshipsDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationshipsDetailsData} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationshipsDetailsData} The populated <code>PurchaseBillRelationshipsDetailsData</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillRelationshipsDetailsData.TypeEnum} type
   */
