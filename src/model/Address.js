...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressAttributes', 'model/AddressRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AddressAttributes'), require('./AddressRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Address = factory(root.parasut.ApiClient, root.parasut.AddressAttributes, root.parasut.AddressRelationships);
  }
}(this, function(ApiClient, AddressAttributes, AddressRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/AddressAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = AddressAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = AddressRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AddressAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/AddressRelationships} relationships
   */
