...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeSmmsDataRelationships', 'model/ESmmCommonFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeSmmsDataRelationships'), require('./ESmmCommonFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdeSmmsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdeSmmsDataRelationships, root.parasut.ESmmCommonFormAttributes);
  }
}(this, function(ApiClient, CompanyIdeSmmsDataRelationships, ESmmCommonFormAttributes) {
  'use strict';

  /**
   * The CompanyIdeSmmsData model module.
   * @module model/CompanyIdeSmmsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdeSmmsData</code>.
   * @alias module:model/CompanyIdeSmmsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdeSmmsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdeSmmsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdeSmmsData} The populated <code>CompanyIdeSmmsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ESmmCommonFormAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdeSmmsDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdeSmmsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ESmmCommonFormAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdeSmmsDataRelationships} relationships
   */
