...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ShipmentDocumentAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ShipmentDocumentAttributes model module.
   * @module model/ShipmentDocumentAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ShipmentDocumentAttributes</code>.
   * @alias module:model/ShipmentDocumentAttributes
   * @class
   * @param issueDate {Date} Düzenleme tarihi
   */
  var exports = function(issueDate) {
    this.issueDate = issueDate;
  };

  /**
   * Constructs a <code>ShipmentDocumentAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShipmentDocumentAttributes} obj Optional instance to populate.
   * @return {module:model/ShipmentDocumentAttributes} The populated <code>ShipmentDocumentAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('print_note'))
        obj.printNote = ApiClient.convertToType(data['print_note'], 'String');
      if (data.hasOwnProperty('printed_at'))
        obj.printedAt = ApiClient.convertToType(data['printed_at'], 'Date');
      ...
      if (data.hasOwnProperty('shipment_date'))
        obj.shipmentDate = ApiClient.convertToType(data['shipment_date'], 'Date');
      if (data.hasOwnProperty('procurement_number'))
        obj.procurementNumber = ApiClient.convertToType(data['procurement_number'], 'String');
    }
    return obj;
  }
  ...
  /**
   * Yazdırmaya özel not
   * @member {String} printNote
   */
  exports.prototype.printNote = undefined;

  /**
   * Yazdırılma tarihi
   * @member {Date} printedAt
   */
  exports.prototype.printedAt = undefined;
   ...
   */
  exports.prototype.inflow = undefined;
  ...
  /**
   * İrsaliye Numarası
   * @member {String} procurementNumber
   */
  exports.prototype.procurementNumber = undefined;
