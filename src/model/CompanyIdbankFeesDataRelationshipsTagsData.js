...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdbankFeesDataRelationshipsTagsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdbankFeesDataRelationshipsTagsData model module.
   * @module model/CompanyIdbankFeesDataRelationshipsTagsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdbankFeesDataRelationshipsTagsData</code>.
   * @alias module:model/CompanyIdbankFeesDataRelationshipsTagsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdbankFeesDataRelationshipsTagsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdbankFeesDataRelationshipsTagsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdbankFeesDataRelationshipsTagsData} The populated <code>CompanyIdbankFeesDataRelationshipsTagsData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdbankFeesDataRelationshipsTagsData.TypeEnum} type
   */
