...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData model module.
   * @module model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData</code>.
   * @alias module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData} obj Optional instance to populate.
   * @return {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData} The populated <code>CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployeeData.TypeEnum} type
   */
