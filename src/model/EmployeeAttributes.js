...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EmployeeAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EmployeeAttributes model module.
   * @module model/EmployeeAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EmployeeAttributes</code>.
   * @alias module:model/EmployeeAttributes
   * @class
   * @param name {String} Çalışan adı soyadı
   */
  ...
  /**
   * Constructs a <code>EmployeeAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmployeeAttributes} obj Optional instance to populate.
   * @return {module:model/EmployeeAttributes} The populated <code>EmployeeAttributes</code> instance.
   */
