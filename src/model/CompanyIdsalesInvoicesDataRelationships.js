...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdbankFeesDataRelationshipsCategory', 'model/CompanyIdbankFeesDataRelationshipsTags', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier', 'model/CompanyIdsalesInvoicesDataRelationshipsDetails', 'model/CompanyIdsalesInvoicesDataRelationshipsSalesOffer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdbankFeesDataRelationshipsCategory'), require('./CompanyIdbankFeesDataRelationshipsTags'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsSupplier'), require('./CompanyIdsalesInvoicesDataRelationshipsDetails'), require('./CompanyIdsalesInvoicesDataRelationshipsSalesOffer'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdsalesInvoicesDataRelationships = factory(root.parasut.ApiClient, root.parasut.CompanyIdbankFeesDataRelationshipsCategory, root.parasut.CompanyIdbankFeesDataRelationshipsTags, root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, root.parasut.CompanyIdsalesInvoicesDataRelationshipsDetails, root.parasut.CompanyIdsalesInvoicesDataRelationshipsSalesOffer);
  }
}(this, function(ApiClient, CompanyIdbankFeesDataRelationshipsCategory, CompanyIdbankFeesDataRelationshipsTags, CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, CompanyIdsalesInvoicesDataRelationshipsDetails, CompanyIdsalesInvoicesDataRelationshipsSalesOffer) {
  'use strict';

  /**
   * The CompanyIdsalesInvoicesDataRelationships model module.
   * @module model/CompanyIdsalesInvoicesDataRelationships
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalesInvoicesDataRelationships</code>.
   * @alias module:model/CompanyIdsalesInvoicesDataRelationships
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalesInvoicesDataRelationships</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalesInvoicesDataRelationships} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalesInvoicesDataRelationships} The populated <code>CompanyIdsalesInvoicesDataRelationships</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('details'))
        obj.details = CompanyIdsalesInvoicesDataRelationshipsDetails.constructFromObject(data['details']);
  ...
  /**
   * @member {module:model/CompanyIdsalesInvoicesDataRelationshipsDetails} details
   */
