...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PurchaseBillRelationshipsPayToData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PurchaseBillRelationshipsPayToData model module.
   * @module model/PurchaseBillRelationshipsPayToData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationshipsPayToData</code>.
   * @alias module:model/PurchaseBillRelationshipsPayToData
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationshipsPayToData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationshipsPayToData} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationshipsPayToData} The populated <code>PurchaseBillRelationshipsPayToData</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillRelationshipsPayToData.TypeEnum} type
   */
