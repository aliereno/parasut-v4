...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ESmmCommonFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ESmmCommonFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ESmmCommonForm = factory(root.parasut.ApiClient, root.parasut.ESmmCommonFormAttributes);
  }
}(this, function(ApiClient, ESmmCommonFormAttributes) {
  'use strict';

  /**
   * The ESmmCommonForm model module.
   * @module model/ESmmCommonForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ESmmCommonForm</code>.
   * @alias module:model/ESmmCommonForm
   * @class
   * @param attributes {module:model/ESmmCommonFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>ESmmCommonForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ESmmCommonForm} obj Optional instance to populate.
   * @return {module:model/ESmmCommonForm} The populated <code>ESmmCommonForm</code> instance.
   */
   ...
   * @member {module:model/ESmmCommonForm.TypeEnum} type
   */
