...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProfileAttributes', 'model/ProfileRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProfileAttributes'), require('./ProfileRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Profile = factory(root.parasut.ApiClient, root.parasut.ProfileAttributes, root.parasut.ProfileRelationships);
  }
}(this, function(ApiClient, ProfileAttributes, ProfileRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/ProfileAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ProfileAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = ProfileRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/Profile.TypeEnum} type
   */
