...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships', 'model/SalesInvoiceDetailAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships'), require('./SalesInvoiceDetailAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdsalesInvoicesDataRelationshipsDetailsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, root.parasut.SalesInvoiceDetailAttributes);
  }
}(this, function(ApiClient, CompanyIdpurchaseBillsdetailedDataRelationshipsDetailsRelationships, SalesInvoiceDetailAttributes) {
  'use strict';

  /**
   * The CompanyIdsalesInvoicesDataRelationshipsDetailsData model module.
   * @module model/CompanyIdsalesInvoicesDataRelationshipsDetailsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalesInvoicesDataRelationshipsDetailsData</code>.
   * @alias module:model/CompanyIdsalesInvoicesDataRelationshipsDetailsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalesInvoicesDataRelationshipsDetailsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalesInvoicesDataRelationshipsDetailsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalesInvoicesDataRelationshipsDetailsData} The populated <code>CompanyIdsalesInvoicesDataRelationshipsDetailsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SalesInvoiceDetailAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/CompanyIdsalesInvoicesDataRelationshipsDetailsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/SalesInvoiceDetailAttributes} attributes
   */
