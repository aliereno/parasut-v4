...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.InlineResponse2004Included = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse2004Included model module.
   * @module model/InlineResponse2004Included
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>InlineResponse2004Included</code>.
   * @alias module:model/InlineResponse2004Included
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2004Included</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2004Included} obj Optional instance to populate.
   * @return {module:model/InlineResponse2004Included} The populated <code>InlineResponse2004Included</code> instance.
   */
   ...
   * @member {module:model/InlineResponse2004Included.TypeEnum} type
   */
