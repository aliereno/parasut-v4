...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactPersonAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContactPersonAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdcontactsDataRelationshipsContactPeopleData = factory(root.parasut.ApiClient, root.parasut.ContactPersonAttributes);
  }
}(this, function(ApiClient, ContactPersonAttributes) {
  'use strict';

  /**
   * The CompanyIdcontactsDataRelationshipsContactPeopleData model module.
   * @module model/CompanyIdcontactsDataRelationshipsContactPeopleData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdcontactsDataRelationshipsContactPeopleData</code>.
   * @alias module:model/CompanyIdcontactsDataRelationshipsContactPeopleData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdcontactsDataRelationshipsContactPeopleData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdcontactsDataRelationshipsContactPeopleData} obj Optional instance to populate.
   * @return {module:model/CompanyIdcontactsDataRelationshipsContactPeopleData} The populated <code>CompanyIdcontactsDataRelationshipsContactPeopleData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ContactPersonAttributes.constructFromObject(data['attributes']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdcontactsDataRelationshipsContactPeopleData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ContactPersonAttributes} attributes
   */
