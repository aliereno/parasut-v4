...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyRelationshipsAddressData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CompanyRelationshipsAddressData model module.
   * @module model/CompanyRelationshipsAddressData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyRelationshipsAddressData</code>.
   * @alias module:model/CompanyRelationshipsAddressData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyRelationshipsAddressData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyRelationshipsAddressData} obj Optional instance to populate.
   * @return {module:model/CompanyRelationshipsAddressData} The populated <code>CompanyRelationshipsAddressData</code> instance.
   */
   ...
   * @member {module:model/CompanyRelationshipsAddressData.TypeEnum} type
   */
