...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.UserRoleAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UserRoleAttributes model module.
   * @module model/UserRoleAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>UserRoleAttributes</code>.
   * @alias module:model/UserRoleAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>UserRoleAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserRoleAttributes} obj Optional instance to populate.
   * @return {module:model/UserRoleAttributes} The populated <code>UserRoleAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('sales_invoices'))
        obj.salesInvoices = ApiClient.convertToType(data['sales_invoices'], 'String');
      if (data.hasOwnProperty('expenditures'))
        obj.expenditures = ApiClient.convertToType(data['expenditures'], 'String');
      if (data.hasOwnProperty('own_expenditures'))
        obj.ownExpenditures = ApiClient.convertToType(data['own_expenditures'], 'String');
  ...
  /**
   * @member {module:model/UserRoleAttributes.SalesInvoicesEnum} salesInvoices
   */
  exports.prototype.salesInvoices = undefined;

  /**
   * @member {module:model/UserRoleAttributes.ExpendituresEnum} expenditures
   */
  exports.prototype.expenditures = undefined;

  /**
   * @member {module:model/UserRoleAttributes.OwnExpendituresEnum} ownExpenditures
   */
  exports.prototype.ownExpenditures = undefined;

  /**
   * @member {module:model/UserRoleAttributes.EmployeesEnum} employees
   */
  exports.prototype.employees = undefined;

  /**
   * @member {module:model/UserRoleAttributes.AccountsEnum} accounts
   */
  exports.prototype.accounts = undefined;

  /**
   * @member {module:model/UserRoleAttributes.SettingsEnum} settings
   */
  ...
  /**
   * Allowed values for the <code>salesInvoices</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SalesInvoicesEnum = {
    /**
     * value: "rw"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>expenditures</code> property.
   * @enum {String}
   * @readonly
   */
  exports.ExpendituresEnum = {
    /**
     * value: "rw"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>ownExpenditures</code> property.
   * @enum {String}
   * @readonly
   */
  exports.OwnExpendituresEnum = {
    /**
     * value: "rw"
     * @const
     */
  ...
  /**
   * Allowed values for the <code>employees</code> property.
   * @enum {String}
   * @readonly
   */
  exports.EmployeesEnum = {
    /**
     * value: "rw"
     * @const
     */
