...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MeAttributes', 'model/MeRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MeAttributes'), require('./MeRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.Me = factory(root.parasut.ApiClient, root.parasut.MeAttributes, root.parasut.MeRelationships);
  }
}(this, function(ApiClient, MeAttributes, MeRelationships) {
  'use strict';
   ...
   * @class
   * @param attributes {module:model/MeAttributes} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = MeAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = MeRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/Me.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/MeAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/MeRelationships} relationships
   */
