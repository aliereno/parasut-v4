...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ShipmentDocumentRelationshipsStockMovementsData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ShipmentDocumentRelationshipsStockMovementsData model module.
   * @module model/ShipmentDocumentRelationshipsStockMovementsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ShipmentDocumentRelationshipsStockMovementsData</code>.
   * @alias module:model/ShipmentDocumentRelationshipsStockMovementsData
   * @class
   */
  ...
  /**
   * Constructs a <code>ShipmentDocumentRelationshipsStockMovementsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShipmentDocumentRelationshipsStockMovementsData} obj Optional instance to populate.
   * @return {module:model/ShipmentDocumentRelationshipsStockMovementsData} The populated <code>ShipmentDocumentRelationshipsStockMovementsData</code> instance.
   */
   ...
   * @member {module:model/ShipmentDocumentRelationshipsStockMovementsData.TypeEnum} type
   */
