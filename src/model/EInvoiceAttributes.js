...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EInvoiceAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EInvoiceAttributes model module.
   * @module model/EInvoiceAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EInvoiceAttributes</code>.
   * @alias module:model/EInvoiceAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>EInvoiceAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EInvoiceAttributes} obj Optional instance to populate.
   * @return {module:model/EInvoiceAttributes} The populated <code>EInvoiceAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('env_uuid'))
        obj.envUuid = ApiClient.convertToType(data['env_uuid'], 'String');
      if (data.hasOwnProperty('from_address'))
        obj.fromAddress = ApiClient.convertToType(data['from_address'], 'String');
      if (data.hasOwnProperty('from_vkn'))
        obj.fromVkn = ApiClient.convertToType(data['from_vkn'], 'String');
      if (data.hasOwnProperty('to_address'))
        obj.toAddress = ApiClient.convertToType(data['to_address'], 'String');
      if (data.hasOwnProperty('to_vkn'))
        obj.toVkn = ApiClient.convertToType(data['to_vkn'], 'String');
      ...
      if (data.hasOwnProperty('contact_name'))
        obj.contactName = ApiClient.convertToType(data['contact_name'], 'String');
      if (data.hasOwnProperty('scenario'))
        obj.scenario = ApiClient.convertToType(data['scenario'], 'String');
      if (data.hasOwnProperty('status'))
        obj.status = ApiClient.convertToType(data['status'], 'String');
      if (data.hasOwnProperty('gtb_ref_no'))
        obj.gtbRefNo = ApiClient.convertToType(data['gtb_ref_no'], 'String');
      if (data.hasOwnProperty('gtb_registration_no'))
        obj.gtbRegistrationNo = ApiClient.convertToType(data['gtb_registration_no'], 'String');
      if (data.hasOwnProperty('gtb_export_date'))
        obj.gtbExportDate = ApiClient.convertToType(data['gtb_export_date'], 'Date');
      if (data.hasOwnProperty('response_note'))
        obj.responseNote = ApiClient.convertToType(data['response_note'], 'String');
      ...
      if (data.hasOwnProperty('is_expired'))
        obj.isExpired = ApiClient.convertToType(data['is_expired'], 'Boolean');
      if (data.hasOwnProperty('is_answerable'))
        obj.isAnswerable = ApiClient.convertToType(data['is_answerable'], 'Boolean');
  ...
  /**
   * @member {String} envUuid
   */
  exports.prototype.envUuid = undefined;
  ...
  /**
   * @member {String} fromVkn
   */
  exports.prototype.fromVkn = undefined;
   ...
   * @member {String} toVkn
   */
  exports.prototype.toVkn = undefined;

  /**
   * @member {module:model/EInvoiceAttributes.DirectionEnum} direction
   */
  ...
  /**
   * @member {module:model/EInvoiceAttributes.ResponseTypeEnum} responseType
   */
  ...
  /**
   * @member {module:model/EInvoiceAttributes.ScenarioEnum} scenario
   */
  exports.prototype.scenario = undefined;

  /**
   * @member {module:model/EInvoiceAttributes.StatusEnum} status
   */
  exports.prototype.status = undefined;

  /**
   * GTB Referans Numarası
   * @member {String} gtbRefNo
   */
  exports.prototype.gtbRefNo = undefined;
  ...
  /**
   * @member {Boolean} isAnswerable
   */
  exports.prototype.isAnswerable = undefined;
  ...
  /**
   * @member {module:model/EInvoiceAttributes.CurrencyEnum} currency
   */
  exports.prototype.currency = undefined;

  /**
   * @member {module:model/EInvoiceAttributes.ItemTypeEnum} itemType
   */
