...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EArchiveFormAttributesShipment = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EArchiveFormAttributesShipment model module.
   * @module model/EArchiveFormAttributesShipment
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EArchiveFormAttributesShipment</code>.
   * Gönderi bilgileri. Gönderim yapılıyorsa doldurmak zorunlu. Örneğin bir hizmet satışı için kargolanan veya gönderilen birşey yoktur, bu durumda doldurulması zorunlu değil ancak bir e-ticaret sitesi olarak yapılan satışta müşteriye kargo / kurye ile bir ürün gönderimi vardır, bu durumda doldurmak zorunlu.
   * @alias module:model/EArchiveFormAttributesShipment
   * @class
   */
  ...
  /**
   * Constructs a <code>EArchiveFormAttributesShipment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EArchiveFormAttributesShipment} obj Optional instance to populate.
   * @return {module:model/EArchiveFormAttributesShipment} The populated <code>EArchiveFormAttributesShipment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tckn'))
        obj.tckn = ApiClient.convertToType(data['tckn'], 'String');
   ...
   * @member {String} tckn
   */
  exports.prototype.tckn = undefined;
