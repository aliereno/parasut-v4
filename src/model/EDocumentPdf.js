...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EDocumentPdfAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EDocumentPdfAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EDocumentPdf = factory(root.parasut.ApiClient, root.parasut.EDocumentPdfAttributes);
  }
}(this, function(ApiClient, EDocumentPdfAttributes) {
  'use strict';

  /**
   * The EDocumentPdf model module.
   * @module model/EDocumentPdf
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EDocumentPdf</code>.
   * @alias module:model/EDocumentPdf
   * @class
   * @param attributes {module:model/EDocumentPdfAttributes} 
   */
  ...
  /**
   * Constructs a <code>EDocumentPdf</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EDocumentPdf} obj Optional instance to populate.
   * @return {module:model/EDocumentPdf} The populated <code>EDocumentPdf</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EDocumentPdfAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/EDocumentPdf.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EDocumentPdfAttributes} attributes
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "e_document_pdfs"
     * @const
     */
    eDocumentPdfs: "e_document_pdfs"
  };
