...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdaccountsData = factory(root.parasut.ApiClient, root.parasut.AccountAttributes);
  }
}(this, function(ApiClient, AccountAttributes) {
  'use strict';

  /**
   * The CompanyIdaccountsData model module.
   * @module model/CompanyIdaccountsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdaccountsData</code>.
   * @alias module:model/CompanyIdaccountsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdaccountsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdaccountsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdaccountsData} The populated <code>CompanyIdaccountsData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdaccountsData.TypeEnum} type
   */
