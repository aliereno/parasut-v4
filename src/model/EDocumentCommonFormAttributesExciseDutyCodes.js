...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EDocumentCommonFormAttributesExciseDutyCodes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EDocumentCommonFormAttributesExciseDutyCodes model module.
   * @module model/EDocumentCommonFormAttributesExciseDutyCodes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EDocumentCommonFormAttributesExciseDutyCodes</code>.
   * @alias module:model/EDocumentCommonFormAttributesExciseDutyCodes
   * @class
   */
  ...
  /**
   * Constructs a <code>EDocumentCommonFormAttributesExciseDutyCodes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EDocumentCommonFormAttributesExciseDutyCodes} obj Optional instance to populate.
   * @return {module:model/EDocumentCommonFormAttributesExciseDutyCodes} The populated <code>EDocumentCommonFormAttributesExciseDutyCodes</code> instance.
   */
  ...
  /**
   * ÖTV kodu
   * @member {module:model/EDocumentCommonFormAttributesExciseDutyCodes.SalesExciseDutyCodeEnum} salesExciseDutyCode
   */
  ...
  /**
   * Allowed values for the <code>salesExciseDutyCode</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SalesExciseDutyCodeEnum = {
    /**
     * value: "57"
     * @const
     */
