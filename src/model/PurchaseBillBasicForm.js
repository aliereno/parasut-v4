...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PurchaseBillBasicFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PurchaseBillBasicFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.PurchaseBillBasicForm = factory(root.parasut.ApiClient, root.parasut.PurchaseBillBasicFormAttributes);
  }
}(this, function(ApiClient, PurchaseBillBasicFormAttributes) {
  'use strict';

  /**
   * The PurchaseBillBasicForm model module.
   * @module model/PurchaseBillBasicForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillBasicForm</code>.
   * @alias module:model/PurchaseBillBasicForm
   * @class
   * @param attributes {module:model/PurchaseBillBasicFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>PurchaseBillBasicForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillBasicForm} obj Optional instance to populate.
   * @return {module:model/PurchaseBillBasicForm} The populated <code>PurchaseBillBasicForm</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillBasicForm.TypeEnum} type
   */
