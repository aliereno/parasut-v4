...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountDebitCreditTransactionFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountDebitCreditTransactionFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.AccountDebitCreditTransactionForm = factory(root.parasut.ApiClient, root.parasut.AccountDebitCreditTransactionFormAttributes);
  }
}(this, function(ApiClient, AccountDebitCreditTransactionFormAttributes) {
  'use strict';

  /**
   * The AccountDebitCreditTransactionForm model module.
   * @module model/AccountDebitCreditTransactionForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>AccountDebitCreditTransactionForm</code>.
   * @alias module:model/AccountDebitCreditTransactionForm
   * @class
   * @param attributes {module:model/AccountDebitCreditTransactionFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>AccountDebitCreditTransactionForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountDebitCreditTransactionForm} obj Optional instance to populate.
   * @return {module:model/AccountDebitCreditTransactionForm} The populated <code>AccountDebitCreditTransactionForm</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = AccountDebitCreditTransactionFormAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/AccountDebitCreditTransactionForm.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/AccountDebitCreditTransactionFormAttributes} attributes
   */
