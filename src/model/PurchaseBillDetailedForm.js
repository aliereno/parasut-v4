...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PurchaseBillDetailedFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PurchaseBillDetailedFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.PurchaseBillDetailedForm = factory(root.parasut.ApiClient, root.parasut.PurchaseBillDetailedFormAttributes);
  }
}(this, function(ApiClient, PurchaseBillDetailedFormAttributes) {
  'use strict';

  /**
   * The PurchaseBillDetailedForm model module.
   * @module model/PurchaseBillDetailedForm
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillDetailedForm</code>.
   * @alias module:model/PurchaseBillDetailedForm
   * @class
   * @param attributes {module:model/PurchaseBillDetailedFormAttributes} 
   */
  ...
  /**
   * Constructs a <code>PurchaseBillDetailedForm</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillDetailedForm} obj Optional instance to populate.
   * @return {module:model/PurchaseBillDetailedForm} The populated <code>PurchaseBillDetailedForm</code> instance.
   */
   ...
   * @member {module:model/PurchaseBillDetailedForm.TypeEnum} type
   */
