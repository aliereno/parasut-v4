...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.EmployeeRelationshipsManagedByUserRoleData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The EmployeeRelationshipsManagedByUserRoleData model module.
   * @module model/EmployeeRelationshipsManagedByUserRoleData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EmployeeRelationshipsManagedByUserRoleData</code>.
   * @alias module:model/EmployeeRelationshipsManagedByUserRoleData
   * @class
   */
  ...
  /**
   * Constructs a <code>EmployeeRelationshipsManagedByUserRoleData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmployeeRelationshipsManagedByUserRoleData} obj Optional instance to populate.
   * @return {module:model/EmployeeRelationshipsManagedByUserRoleData} The populated <code>EmployeeRelationshipsManagedByUserRoleData</code> instance.
   */
   ...
   * @member {module:model/EmployeeRelationshipsManagedByUserRoleData.TypeEnum} type
   */
