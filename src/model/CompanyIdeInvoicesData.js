...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeInvoicesDataRelationships', 'model/EInvoiceFormAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeInvoicesDataRelationships'), require('./EInvoiceFormAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdeInvoicesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdeInvoicesDataRelationships, root.parasut.EInvoiceFormAttributes);
  }
}(this, function(ApiClient, CompanyIdeInvoicesDataRelationships, EInvoiceFormAttributes) {
  'use strict';

  /**
   * The CompanyIdeInvoicesData model module.
   * @module model/CompanyIdeInvoicesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdeInvoicesData</code>.
   * @alias module:model/CompanyIdeInvoicesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdeInvoicesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdeInvoicesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdeInvoicesData} The populated <code>CompanyIdeInvoicesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EInvoiceFormAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdeInvoicesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdeInvoicesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EInvoiceFormAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdeInvoicesDataRelationships} relationships
   */
