...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdeArchivesDataRelationships', 'model/EArchiveAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdeArchivesDataRelationships'), require('./EArchiveAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.EArchive = factory(root.parasut.ApiClient, root.parasut.CompanyIdeArchivesDataRelationships, root.parasut.EArchiveAttributes);
  }
}(this, function(ApiClient, CompanyIdeArchivesDataRelationships, EArchiveAttributes) {
  'use strict';

  /**
   * The EArchive model module.
   * @module model/EArchive
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>EArchive</code>.
   * @alias module:model/EArchive
   * @class
   * @param attributes {module:model/EArchiveAttributes} 
   */
  ...
  /**
   * Constructs a <code>EArchive</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EArchive} obj Optional instance to populate.
   * @return {module:model/EArchive} The populated <code>EArchive</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EArchiveAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/EArchive.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EArchiveAttributes} attributes
   */
