...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.PaymentFormAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PaymentFormAttributes model module.
   * @module model/PaymentFormAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PaymentFormAttributes</code>.
   * @alias module:model/PaymentFormAttributes
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentFormAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentFormAttributes} obj Optional instance to populate.
   * @return {module:model/PaymentFormAttributes} The populated <code>PaymentFormAttributes</code> instance.
   */
