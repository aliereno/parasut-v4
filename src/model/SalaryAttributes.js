...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.SalaryAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SalaryAttributes model module.
   * @module model/SalaryAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalaryAttributes</code>.
   * @alias module:model/SalaryAttributes
   * @class
   * @param description {String} 
   * @param currency {module:model/SalaryAttributes.CurrencyEnum} 
  ...
  /**
   * Constructs a <code>SalaryAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalaryAttributes} obj Optional instance to populate.
   * @return {module:model/SalaryAttributes} The populated <code>SalaryAttributes</code> instance.
   */
  ...
  /**
   * @member {module:model/SalaryAttributes.CurrencyEnum} currency
   */
