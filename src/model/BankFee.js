...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.BankFee = factory(root.parasut.ApiClient, root.parasut.BankFeeAttributes, root.parasut.CompanyIdbankFeesDataRelationships);
  }
}(this, function(ApiClient, BankFeeAttributes, CompanyIdbankFeesDataRelationships) {
  'use strict';

  /**
   * The BankFee model module.
   * @module model/BankFee
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>BankFee</code>.
   * @alias module:model/BankFee
   * @class
   * @param attributes {module:model/BankFeeAttributes} 
   */
  ...
  /**
   * Constructs a <code>BankFee</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BankFee} obj Optional instance to populate.
   * @return {module:model/BankFee} The populated <code>BankFee</code> instance.
   */
   ...
   * @member {module:model/BankFee.TypeEnum} type
   */
