...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.StockMovementRelationshipsSourceData = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The StockMovementRelationshipsSourceData model module.
   * @module model/StockMovementRelationshipsSourceData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>StockMovementRelationshipsSourceData</code>.
   * @alias module:model/StockMovementRelationshipsSourceData
   * @class
   */
  ...
  /**
   * Constructs a <code>StockMovementRelationshipsSourceData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StockMovementRelationshipsSourceData} obj Optional instance to populate.
   * @return {module:model/StockMovementRelationshipsSourceData} The populated <code>StockMovementRelationshipsSourceData</code> instance.
   */
   ...
   * @member {module:model/StockMovementRelationshipsSourceData.TypeEnum} type
   */
