...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdbankFeesDataRelationshipsCategory', 'model/CompanyIdbankFeesDataRelationshipsTags', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier', 'model/CompanyIdsalesInvoicesDataRelationshipsSalesOffer', 'model/PurchaseBillRelationshipsPayments', 'model/PurchaseBillRelationshipsRecurrencePlan', 'model/SalesInvoiceRelationshipsActiveEDocument', 'model/SalesInvoiceRelationshipsDetails', 'model/SalesInvoiceRelationshipsSharings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdbankFeesDataRelationshipsCategory'), require('./CompanyIdbankFeesDataRelationshipsTags'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsSupplier'), require('./CompanyIdsalesInvoicesDataRelationshipsSalesOffer'), require('./PurchaseBillRelationshipsPayments'), require('./PurchaseBillRelationshipsRecurrencePlan'), require('./SalesInvoiceRelationshipsActiveEDocument'), require('./SalesInvoiceRelationshipsDetails'), require('./SalesInvoiceRelationshipsSharings'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.SalesInvoiceRelationships = factory(root.parasut.ApiClient, root.parasut.CompanyIdbankFeesDataRelationshipsCategory, root.parasut.CompanyIdbankFeesDataRelationshipsTags, root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, root.parasut.CompanyIdsalesInvoicesDataRelationshipsSalesOffer, root.parasut.PurchaseBillRelationshipsPayments, root.parasut.PurchaseBillRelationshipsRecurrencePlan, root.parasut.SalesInvoiceRelationshipsActiveEDocument, root.parasut.SalesInvoiceRelationshipsDetails, root.parasut.SalesInvoiceRelationshipsSharings);
  }
}(this, function(ApiClient, CompanyIdbankFeesDataRelationshipsCategory, CompanyIdbankFeesDataRelationshipsTags, CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, CompanyIdsalesInvoicesDataRelationshipsSalesOffer, PurchaseBillRelationshipsPayments, PurchaseBillRelationshipsRecurrencePlan, SalesInvoiceRelationshipsActiveEDocument, SalesInvoiceRelationshipsDetails, SalesInvoiceRelationshipsSharings) {
  'use strict';

  /**
   * The SalesInvoiceRelationships model module.
   * @module model/SalesInvoiceRelationships
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceRelationships</code>.
   * @alias module:model/SalesInvoiceRelationships
   * @class
   */
  ...
  /**
   * Constructs a <code>SalesInvoiceRelationships</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceRelationships} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceRelationships} The populated <code>SalesInvoiceRelationships</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('category'))
        obj.category = CompanyIdbankFeesDataRelationshipsCategory.constructFromObject(data['category']);
      if (data.hasOwnProperty('contact'))
        obj.contact = CompanyIdpurchaseBillsbasicDataRelationshipsSupplier.constructFromObject(data['contact']);
      if (data.hasOwnProperty('details'))
        obj.details = SalesInvoiceRelationshipsDetails.constructFromObject(data['details']);
      if (data.hasOwnProperty('payments'))
        obj.payments = PurchaseBillRelationshipsPayments.constructFromObject(data['payments']);
      if (data.hasOwnProperty('tags'))
        obj.tags = CompanyIdbankFeesDataRelationshipsTags.constructFromObject(data['tags']);
      if (data.hasOwnProperty('sales_offer'))
        obj.salesOffer = CompanyIdsalesInvoicesDataRelationshipsSalesOffer.constructFromObject(data['sales_offer']);
      if (data.hasOwnProperty('sharings'))
        obj.sharings = SalesInvoiceRelationshipsSharings.constructFromObject(data['sharings']);
      if (data.hasOwnProperty('recurrence_plan'))
        obj.recurrencePlan = PurchaseBillRelationshipsRecurrencePlan.constructFromObject(data['recurrence_plan']);
      if (data.hasOwnProperty('active_e_document'))
        obj.activeEDocument = SalesInvoiceRelationshipsActiveEDocument.constructFromObject(data['active_e_document']);
    }
    return obj;
  }

  /**
   * @member {module:model/CompanyIdbankFeesDataRelationshipsCategory} category
   */
  exports.prototype.category = undefined;

  /**
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier} contact
   */
  exports.prototype.contact = undefined;

  /**
   * @member {module:model/SalesInvoiceRelationshipsDetails} details
   */
  exports.prototype.details = undefined;

  /**
   * @member {module:model/PurchaseBillRelationshipsPayments} payments
   */
  exports.prototype.payments = undefined;

  /**
   * @member {module:model/CompanyIdbankFeesDataRelationshipsTags} tags
   */
  exports.prototype.tags = undefined;

  /**
   * @member {module:model/CompanyIdsalesInvoicesDataRelationshipsSalesOffer} salesOffer
   */
  exports.prototype.salesOffer = undefined;

  /**
   * @member {module:model/SalesInvoiceRelationshipsSharings} sharings
   */
  exports.prototype.sharings = undefined;

  /**
   * @member {module:model/PurchaseBillRelationshipsRecurrencePlan} recurrencePlan
   */
  exports.prototype.recurrencePlan = undefined;

  /**
   * @member {module:model/SalesInvoiceRelationshipsActiveEDocument} activeEDocument
   */
  exports.prototype.activeEDocument = undefined;
