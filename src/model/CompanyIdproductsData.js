...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdemployeesDataRelationships', 'model/ProductAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdemployeesDataRelationships'), require('./ProductAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdproductsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdemployeesDataRelationships, root.parasut.ProductAttributes);
  }
}(this, function(ApiClient, CompanyIdemployeesDataRelationships, ProductAttributes) {
  'use strict';

  /**
   * The CompanyIdproductsData model module.
   * @module model/CompanyIdproductsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdproductsData</code>.
   * @alias module:model/CompanyIdproductsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdproductsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdproductsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdproductsData} The populated <code>CompanyIdproductsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ProductAttributes.constructFromObject(data['attributes']);
   ...
   * @member {module:model/CompanyIdproductsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ProductAttributes} attributes
   */
