...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContactAttributes model module.
   * @module model/ContactAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ContactAttributes</code>.
   * @alias module:model/ContactAttributes
   * @class
   * @param name {String} Müşteri/tedarikçi ismi
   * @param accountType {module:model/ContactAttributes.AccountTypeEnum} 
   */
  var exports = function(name, accountType) {
    this.name = name;
    this.accountType = accountType;
  };

  /**
   * Constructs a <code>ContactAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContactAttributes} obj Optional instance to populate.
   * @return {module:model/ContactAttributes} The populated <code>ContactAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('trl_balance'))
        obj.trlBalance = ApiClient.convertToType(data['trl_balance'], 'Number');
      if (data.hasOwnProperty('usd_balance'))
        obj.usdBalance = ApiClient.convertToType(data['usd_balance'], 'Number');
      if (data.hasOwnProperty('eur_balance'))
        obj.eurBalance = ApiClient.convertToType(data['eur_balance'], 'Number');
      if (data.hasOwnProperty('gbp_balance'))
        obj.gbpBalance = ApiClient.convertToType(data['gbp_balance'], 'Number');
      ...
      if (data.hasOwnProperty('untrackable'))
        obj.untrackable = ApiClient.convertToType(data['untrackable'], 'Boolean');
    }
    return obj;
  }
  ...
  /**
   * TL Bakiye
   * @member {Number} trlBalance
   */
  exports.prototype.trlBalance = undefined;
  ...
  /**
   * EUR Bakiye
   * @member {Number} eurBalance
   */
  exports.prototype.eurBalance = undefined;

  /**
   * GBP Bakiye
   * @member {Number} gbpBalance
   */
  exports.prototype.gbpBalance = undefined;
  ...
  /**
   * Tip
   * @member {module:model/ContactAttributes.ContactTypeEnum} contactType
   */
  ...
  /**
   * @member {module:model/ContactAttributes.AccountTypeEnum} accountType
   */
  exports.prototype.accountType = undefined;

  /**
   * Listelenmemiş müşteri sonradan listelenebilir hale getirilemez
   * @member {Boolean} untrackable
   */
  exports.prototype.untrackable = undefined;
