...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.StockMovementAttributes = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The StockMovementAttributes model module.
   * @module model/StockMovementAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>StockMovementAttributes</code>.
   * @alias module:model/StockMovementAttributes
   * @class
  ...
  /**
   * Constructs a <code>StockMovementAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/StockMovementAttributes} obj Optional instance to populate.
   * @return {module:model/StockMovementAttributes} The populated <code>StockMovementAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('detail_no'))
        obj.detailNo = ApiClient.convertToType(data['detail_no'], 'Number');
  ...
  /**
   * Detay sıra no
   * @member {Number} detailNo
   */
  exports.prototype.detailNo = undefined;
