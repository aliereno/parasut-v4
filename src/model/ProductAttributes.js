...
(function(root, factory) {
  ...
  /**
   * The ProductAttributes model module.
   * @module model/ProductAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ProductAttributes</code>.
   * @alias module:model/ProductAttributes
   * @class
   * @param name {String} Ürün/hizmet ismi
   */
  ...
  /**
   * Constructs a <code>ProductAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ProductAttributes} obj Optional instance to populate.
   * @return {module:model/ProductAttributes} The populated <code>ProductAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('sales_excise_duty_code'))
        obj.salesExciseDutyCode = ApiClient.convertToType(data['sales_excise_duty_code'], 'String');
      if (data.hasOwnProperty('sales_invoice_details_count'))
        obj.salesInvoiceDetailsCount = ApiClient.convertToType(data['sales_invoice_details_count'], 'Number');
      if (data.hasOwnProperty('purchase_invoice_details_count'))
        obj.purchaseInvoiceDetailsCount = ApiClient.convertToType(data['purchase_invoice_details_count'], 'Number');
      if (data.hasOwnProperty('list_price_in_trl'))
        obj.listPriceInTrl = ApiClient.convertToType(data['list_price_in_trl'], 'Number');
      if (data.hasOwnProperty('buying_price_in_trl'))
        obj.buyingPriceInTrl = ApiClient.convertToType(data['buying_price_in_trl'], 'Number');
      if (data.hasOwnProperty('stock_count'))
        obj.stockCount = ApiClient.convertToType(data['stock_count'], 'Number');
      ...
      if (data.hasOwnProperty('sales_excise_duty'))
        obj.salesExciseDuty = ApiClient.convertToType(data['sales_excise_duty'], 'Number');
      if (data.hasOwnProperty('sales_excise_duty_type'))
        obj.salesExciseDutyType = ApiClient.convertToType(data['sales_excise_duty_type'], 'String');
      if (data.hasOwnProperty('purchase_excise_duty'))
        obj.purchaseExciseDuty = ApiClient.convertToType(data['purchase_excise_duty'], 'Number');
      if (data.hasOwnProperty('purchase_excise_duty_type'))
        obj.purchaseExciseDutyType = ApiClient.convertToType(data['purchase_excise_duty_type'], 'String');
      if (data.hasOwnProperty('unit'))
        obj.unit = ApiClient.convertToType(data['unit'], 'String');
      if (data.hasOwnProperty('communications_tax_rate'))
        obj.communicationsTaxRate = ApiClient.convertToType(data['communications_tax_rate'], 'Number');
      if (data.hasOwnProperty('archived'))
        obj.archived = ApiClient.convertToType(data['archived'], 'Boolean');
      if (data.hasOwnProperty('list_price'))
        obj.listPrice = ApiClient.convertToType(data['list_price'], 'Number');
      if (data.hasOwnProperty('currency'))
        obj.currency = ApiClient.convertToType(data['currency'], 'String');
      if (data.hasOwnProperty('buying_price'))
        obj.buyingPrice = ApiClient.convertToType(data['buying_price'], 'Number');
      if (data.hasOwnProperty('buying_currency'))
        obj.buyingCurrency = ApiClient.convertToType(data['buying_currency'], 'String');
      if (data.hasOwnProperty('inventory_tracking'))
        obj.inventoryTracking = ApiClient.convertToType(data['inventory_tracking'], 'Boolean');
  ...
  /**
   * @member {String} salesExciseDutyCode
   */
  exports.prototype.salesExciseDutyCode = undefined;

  /**
   * @member {Number} salesInvoiceDetailsCount
   */
  exports.prototype.salesInvoiceDetailsCount = undefined;

  /**
   * @member {Number} purchaseInvoiceDetailsCount
   */
  exports.prototype.purchaseInvoiceDetailsCount = undefined;

  /**
   * @member {Number} listPriceInTrl
   */
  exports.prototype.listPriceInTrl = undefined;

  /**
   * @member {Number} buyingPriceInTrl
   */
  exports.prototype.buyingPriceInTrl = undefined;

  /**
   * Stok Miktarı
   * @member {Number} stockCount
   */
  exports.prototype.stockCount = undefined;
  ...
  /**
   * Satış ÖTV
   * @member {Number} salesExciseDuty
   */
  exports.prototype.salesExciseDuty = undefined;

  /**
   * Satış ÖTV tipi
   * @member {String} salesExciseDutyType
   */
  exports.prototype.salesExciseDutyType = undefined;

  /**
   * Alış ÖTV
   * @member {Number} purchaseExciseDuty
   */
  exports.prototype.purchaseExciseDuty = undefined;

  /**
   * Alış ÖTV tipi
   * @member {String} purchaseExciseDutyType
   */
  exports.prototype.purchaseExciseDutyType = undefined;
  ...
  /**
   * ÖİV oranı
   * @member {Number} communicationsTaxRate
   */
  exports.prototype.communicationsTaxRate = undefined;
   ...
   */
  exports.prototype.buyingPrice = undefined;

  /**
   * Alış döviz
   * @member {String} buyingCurrency
   */
  exports.prototype.buyingCurrency = undefined;

  /**
   * @member {Boolean} inventoryTracking
   */
  exports.prototype.inventoryTracking = undefined;

  /**
   * Başlangıç Stok Miktarı
   * @member {Number} initialStockCount
   */
  exports.prototype.initialStockCount = undefined;
