...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdshipmentDocumentsDataRelationships', 'model/ShipmentDocumentAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdshipmentDocumentsDataRelationships'), require('./ShipmentDocumentAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdshipmentDocumentsData = factory(root.parasut.ApiClient, root.parasut.CompanyIdshipmentDocumentsDataRelationships, root.parasut.ShipmentDocumentAttributes);
  }
}(this, function(ApiClient, CompanyIdshipmentDocumentsDataRelationships, ShipmentDocumentAttributes) {
  'use strict';

  /**
   * The CompanyIdshipmentDocumentsData model module.
   * @module model/CompanyIdshipmentDocumentsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdshipmentDocumentsData</code>.
   * @alias module:model/CompanyIdshipmentDocumentsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdshipmentDocumentsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdshipmentDocumentsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdshipmentDocumentsData} The populated <code>CompanyIdshipmentDocumentsData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = ShipmentDocumentAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdshipmentDocumentsDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdshipmentDocumentsData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/ShipmentDocumentAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdshipmentDocumentsDataRelationships} relationships
   */
