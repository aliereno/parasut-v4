...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdemployeesDataRelationships', 'model/EmployeeAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdemployeesDataRelationships'), require('./EmployeeAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdemployeesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdemployeesDataRelationships, root.parasut.EmployeeAttributes);
  }
}(this, function(ApiClient, CompanyIdemployeesDataRelationships, EmployeeAttributes) {
  'use strict';

  /**
   * The CompanyIdemployeesData model module.
   * @module model/CompanyIdemployeesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdemployeesData</code>.
   * @alias module:model/CompanyIdemployeesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdemployeesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdemployeesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdemployeesData} The populated <code>CompanyIdemployeesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = EmployeeAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdemployeesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdemployeesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/EmployeeAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdemployeesDataRelationships} relationships
   */
