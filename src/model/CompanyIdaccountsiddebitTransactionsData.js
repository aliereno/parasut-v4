...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.CompanyIdaccountsiddebitTransactionsData = factory(root.parasut.ApiClient, root.parasut.AccountDebitCreditTransactionFormAttributes);
  }
}(this, function(ApiClient, AccountDebitCreditTransactionFormAttributes) {
  'use strict';

  /**
   * The CompanyIdaccountsiddebitTransactionsData model module.
   * @module model/CompanyIdaccountsiddebitTransactionsData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdaccountsiddebitTransactionsData</code>.
   * @alias module:model/CompanyIdaccountsiddebitTransactionsData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdaccountsiddebitTransactionsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdaccountsiddebitTransactionsData} obj Optional instance to populate.
   * @return {module:model/CompanyIdaccountsiddebitTransactionsData} The populated <code>CompanyIdaccountsiddebitTransactionsData</code> instance.
   */
   ...
   * @member {module:model/CompanyIdaccountsiddebitTransactionsData.TypeEnum} type
   */
