...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ShipmentDocumentAttributes', 'model/ShipmentDocumentRelationships'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ShipmentDocumentAttributes'), require('./ShipmentDocumentRelationships'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.ShipmentDocument = factory(root.parasut.ApiClient, root.parasut.ShipmentDocumentAttributes, root.parasut.ShipmentDocumentRelationships);
  }
}(this, function(ApiClient, ShipmentDocumentAttributes, ShipmentDocumentRelationships) {
  'use strict';

  /**
   * The ShipmentDocument model module.
   * @module model/ShipmentDocument
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>ShipmentDocument</code>.
   * @alias module:model/ShipmentDocument
   * @class
   * @param attributes {module:model/ShipmentDocumentAttributes} 
   */
  ...
  /**
   * Constructs a <code>ShipmentDocument</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ShipmentDocument} obj Optional instance to populate.
   * @return {module:model/ShipmentDocument} The populated <code>ShipmentDocument</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('relationships'))
        obj.relationships = ShipmentDocumentRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/ShipmentDocument.TypeEnum} type
   */
  ...
  /**
   * @member {module:model/ShipmentDocumentRelationships} relationships
   */
