...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.InlineResponse20014Included = factory(root.parasut.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The InlineResponse20014Included model module.
   * @module model/InlineResponse20014Included
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>InlineResponse20014Included</code>.
   * @alias module:model/InlineResponse20014Included
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20014Included</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20014Included} obj Optional instance to populate.
   * @return {module:model/InlineResponse20014Included} The populated <code>InlineResponse20014Included</code> instance.
   */
   ...
   * @member {module:model/InlineResponse20014Included.TypeEnum} type
   */
