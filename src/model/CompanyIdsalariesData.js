...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdsalariesDataRelationships', 'model/SalaryAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdsalariesDataRelationships'), require('./SalaryAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.CompanyIdsalariesData = factory(root.parasut.ApiClient, root.parasut.CompanyIdsalariesDataRelationships, root.parasut.SalaryAttributes);
  }
}(this, function(ApiClient, CompanyIdsalariesDataRelationships, SalaryAttributes) {
  'use strict';

  /**
   * The CompanyIdsalariesData model module.
   * @module model/CompanyIdsalariesData
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>CompanyIdsalariesData</code>.
   * @alias module:model/CompanyIdsalariesData
   * @class
   */
  ...
  /**
   * Constructs a <code>CompanyIdsalariesData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompanyIdsalariesData} obj Optional instance to populate.
   * @return {module:model/CompanyIdsalariesData} The populated <code>CompanyIdsalariesData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('attributes'))
        obj.attributes = SalaryAttributes.constructFromObject(data['attributes']);
      if (data.hasOwnProperty('relationships'))
        obj.relationships = CompanyIdsalariesDataRelationships.constructFromObject(data['relationships']);
    }
    return obj;
  }
   ...
   * @member {module:model/CompanyIdsalariesData.TypeEnum} type
   */
  exports.prototype.type = undefined;

  /**
   * @member {module:model/SalaryAttributes} attributes
   */
  exports.prototype.attributes = undefined;

  /**
   * @member {module:model/CompanyIdsalariesDataRelationships} relationships
   */
