...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompanyIdbankFeesDataRelationshipsCategory', 'model/CompanyIdbankFeesDataRelationshipsTags', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee', 'model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier', 'model/PurchaseBillRelationshipsActiveEDocument', 'model/PurchaseBillRelationshipsDetails', 'model/PurchaseBillRelationshipsPayTo', 'model/PurchaseBillRelationshipsPayments', 'model/PurchaseBillRelationshipsRecurrencePlan'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompanyIdbankFeesDataRelationshipsCategory'), require('./CompanyIdbankFeesDataRelationshipsTags'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee'), require('./CompanyIdpurchaseBillsbasicDataRelationshipsSupplier'), require('./PurchaseBillRelationshipsActiveEDocument'), require('./PurchaseBillRelationshipsDetails'), require('./PurchaseBillRelationshipsPayTo'), require('./PurchaseBillRelationshipsPayments'), require('./PurchaseBillRelationshipsRecurrencePlan'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.PurchaseBillRelationships = factory(root.parasut.ApiClient, root.parasut.CompanyIdbankFeesDataRelationshipsCategory, root.parasut.CompanyIdbankFeesDataRelationshipsTags, root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee, root.parasut.CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, root.parasut.PurchaseBillRelationshipsActiveEDocument, root.parasut.PurchaseBillRelationshipsDetails, root.parasut.PurchaseBillRelationshipsPayTo, root.parasut.PurchaseBillRelationshipsPayments, root.parasut.PurchaseBillRelationshipsRecurrencePlan);
  }
}(this, function(ApiClient, CompanyIdbankFeesDataRelationshipsCategory, CompanyIdbankFeesDataRelationshipsTags, CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee, CompanyIdpurchaseBillsbasicDataRelationshipsSupplier, PurchaseBillRelationshipsActiveEDocument, PurchaseBillRelationshipsDetails, PurchaseBillRelationshipsPayTo, PurchaseBillRelationshipsPayments, PurchaseBillRelationshipsRecurrencePlan) {
  'use strict';

  /**
   * The PurchaseBillRelationships model module.
   * @module model/PurchaseBillRelationships
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>PurchaseBillRelationships</code>.
   * @alias module:model/PurchaseBillRelationships
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseBillRelationships</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseBillRelationships} obj Optional instance to populate.
   * @return {module:model/PurchaseBillRelationships} The populated <code>PurchaseBillRelationships</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('spender'))
        obj.spender = CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee.constructFromObject(data['spender']);
      if (data.hasOwnProperty('supplier'))
        obj.supplier = CompanyIdpurchaseBillsbasicDataRelationshipsSupplier.constructFromObject(data['supplier']);
      if (data.hasOwnProperty('details'))
        obj.details = PurchaseBillRelationshipsDetails.constructFromObject(data['details']);
      ...
      if (data.hasOwnProperty('active_e_document'))
        obj.activeEDocument = PurchaseBillRelationshipsActiveEDocument.constructFromObject(data['active_e_document']);
      if (data.hasOwnProperty('pay_to'))
        obj.payTo = PurchaseBillRelationshipsPayTo.constructFromObject(data['pay_to']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsPaidByEmployee} spender
   */
  exports.prototype.spender = undefined;

  /**
   * @member {module:model/CompanyIdpurchaseBillsbasicDataRelationshipsSupplier} supplier
   */
  exports.prototype.supplier = undefined;

  /**
   * @member {module:model/PurchaseBillRelationshipsDetails} details
   */
  ...
  /**
   * @member {module:model/PurchaseBillRelationshipsActiveEDocument} activeEDocument
   */
  exports.prototype.activeEDocument = undefined;

  /**
   * @member {module:model/PurchaseBillRelationshipsPayTo} payTo
   */
  exports.prototype.payTo = undefined;
