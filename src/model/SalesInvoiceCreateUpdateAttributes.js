...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SalesInvoiceAttributes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SalesInvoiceAttributes'));
  } else {
    // Browser globals (root is window)
    if (!root.parasut) {
      root.parasut = {};
    }
    root.parasut.SalesInvoiceCreateUpdateAttributes = factory(root.parasut.ApiClient, root.parasut.SalesInvoiceAttributes);
  }
}(this, function(ApiClient, SalesInvoiceAttributes) {
  'use strict';

  /**
   * The SalesInvoiceCreateUpdateAttributes model module.
   * @module model/SalesInvoiceCreateUpdateAttributes
   * @version 4.0.0
   */

  /**
   * Constructs a new <code>SalesInvoiceCreateUpdateAttributes</code>.
   * @alias module:model/SalesInvoiceCreateUpdateAttributes
   * @class
   * @extends module:model/SalesInvoiceAttributes
  ...
  var exports = function(itemType, issueDate) {
    SalesInvoiceAttributes.call(this, itemType, issueDate);
  };

  /**
   * Constructs a <code>SalesInvoiceCreateUpdateAttributes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SalesInvoiceCreateUpdateAttributes} obj Optional instance to populate.
   * @return {module:model/SalesInvoiceCreateUpdateAttributes} The populated <code>SalesInvoiceCreateUpdateAttributes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      SalesInvoiceAttributes.constructFromObject(data, obj);
      if (data.hasOwnProperty('payment_account_id'))
        obj.paymentAccountId = ApiClient.convertToType(data['payment_account_id'], 'Number');
      if (data.hasOwnProperty('payment_date'))
        obj.paymentDate = ApiClient.convertToType(data['payment_date'], 'String');
      if (data.hasOwnProperty('payment_description'))
        obj.paymentDescription = ApiClient.convertToType(data['payment_description'], 'String');
    }
    return obj;
  }

  exports.prototype = Object.create(SalesInvoiceAttributes.prototype);
   ...
   */
  exports.prototype.paymentDescription = undefined;
