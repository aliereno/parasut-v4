...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.parasut.ContactPerson = factory(root.parasut.ApiClient, root.parasut.ContactPersonAttributes);
  }
   ...
   * @class
   * @param attributes {module:model/ContactPersonAttributes} 
   */
   ...
   * @member {module:model/ContactPerson.TypeEnum} type
   */
